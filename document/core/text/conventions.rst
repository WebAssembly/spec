...
The textual format for WebAssembly :ref:`modules <module>` is a rendering of their :ref:`abstract syntax <syntax-module>` into `S-expressions <https://en.wikipedia.org/wiki/S-expression>`_.
