...
.. note::
   ...
   Thus, the binary format for types corresponds to the :ref:`encoding <binary-sint>` of small negative :math:`\sN` values, so that they can coexist with (positive) type indices in the future.
