...
INSTRUCTIONS = [
    ...
    Instruction(r'\V128.\LOAD~\memarg', r'\hex{FD}~~0', r'[\I32] \to [\V128]', r'validation <valid-load>', r'execution <exec-load>'),
    Instruction(r'\I16X8.\LOAD\K{8x8\_s}~\memarg', r'\hex{FD}~~1', r'[\I32] \to [\V128]', r'validation <valid-load-extend>', r'execution <exec-load-extend>'),
    Instruction(r'\I16X8.\LOAD\K{8x8\_u}~\memarg', r'\hex{FD}~~2', r'[\I32] \to [\V128]', r'validation <valid-load-extend>', r'execution <exec-load-extend>'),
    Instruction(r'\I32X4.\LOAD\K{16x4\_s}~\memarg', r'\hex{FD}~~3', r'[\I32] \to [\V128]', r'validation <valid-load-extend>', r'execution <exec-load-extend>'),
    Instruction(r'\I32X4.\LOAD\K{16x4\_u}~\memarg', r'\hex{FD}~~4', r'[\I32] \to [\V128]', r'validation <valid-load-extend>', r'execution <exec-load-extend>'),
    Instruction(r'\I64X2.\LOAD\K{32x2\_s}~\memarg', r'\hex{FD}~~5', r'[\I32] \to [\V128]', r'validation <valid-load-extend>', r'execution <exec-load-extend>'),
    Instruction(r'\I64X2.\LOAD\K{32x2\_u}~\memarg', r'\hex{FD}~~6', r'[\I32] \to [\V128]', r'validation <valid-load-extend>', r'execution <exec-load-extend>'),
    Instruction(r'\I8X16.\LOAD\K{\_splat}~\memarg', r'\hex{FD}~~7', r'[\I32] \to [\V128]', r'validation <valid-load-splat>', r'execution <exec-load-splat>'),
    Instruction(r'\I16X8.\LOAD\K{\_splat}~\memarg', r'\hex{FD}~~8', r'[\I32] \to [\V128]', r'validation <valid-load-splat>', r'execution <exec-load-splat>'),
    Instruction(r'\I32X4.\LOAD\K{\_splat}~\memarg', r'\hex{FD}~~9', r'[\I32] \to [\V128]', r'validation <valid-load-splat>', r'execution <exec-load-splat>'),
    Instruction(r'\I64X2.\LOAD\K{\_splat}~\memarg', r'\hex{FD}~~10', r'[\I32] \to [\V128]', r'validation <valid-load-splat>', r'execution <exec-load-splat>'),
    Instruction(r'\V128.\STORE~\memarg', r'\hex{FD}~~11', r'[\I32] \to [\V128]', r'validation <valid-store>', r'execution <exec-store>'),
    Instruction(r'\V128.\VCONST~\i128', r'\hex{FD}~~12', r'[] \to [\V128]', r'validation <valid-vconst>', r'execution <exec-vconst>'),
    Instruction(r'\I8X16.\SHUFFLE~\laneidx^{16}', r'\hex{FD}~~13', r'[\V128~\V128~\V128] \to [\V128]', r'validation <valid-simd-shuffle>', r'execution <exec-simd-shuffle>'),
    Instruction(r'\I8X16.\SWIZZLE', r'\hex{FD}~~14', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-simd-swizzle>'),
    Instruction(r'\I8X16.\SPLAT', r'\hex{FD}~~15', r'[\I32] \to [\V128]', r'validation <valid-simd-splat>', r'execution <exec-simd-splat>'),
    Instruction(r'\I16X8.\SPLAT', r'\hex{FD}~~16', r'[\I32] \to [\V128]', r'validation <valid-simd-splat>', r'execution <exec-simd-splat>'),
    Instruction(r'\I32X4.\SPLAT', r'\hex{FD}~~17', r'[\I32] \to [\V128]', r'validation <valid-simd-splat>', r'execution <exec-simd-splat>'),
    Instruction(r'\I64X2.\SPLAT', r'\hex{FD}~~18', r'[\I64] \to [\V128]', r'validation <valid-simd-splat>', r'execution <exec-simd-splat>'),
    Instruction(r'\F32X4.\SPLAT', r'\hex{FD}~~19', r'[\F32] \to [\V128]', r'validation <valid-simd-splat>', r'execution <exec-simd-splat>'),
    Instruction(r'\F64X2.\SPLAT', r'\hex{FD}~~20', r'[\F64] \to [\V128]', r'validation <valid-simd-splat>', r'execution <exec-simd-splat>'),
    Instruction(r'\I8X16.\EXTRACTLANE\K{\_s}~\laneidx', r'\hex{FD}~~21', r'[\V128] \to [\I32]', r'validation <valid-simd-extract-lane-sx>', r'execution <exec-simd-extract-lane-sx>'),
    Instruction(r'\I8X16.\EXTRACTLANE\K{\_u}~\laneidx', r'\hex{FD}~~22', r'[\V128] \to [\I32]', r'validation <valid-simd-extract-lane-sx>', r'execution <exec-simd-extract-lane-sx>'),
    Instruction(r'\I8X16.\REPLACELANE~\laneidx', r'\hex{FD}~~23', r'[\V128~\I32] \to [\V128]', r'validation <valid-simd-replace-lane>', r'execution <exec-simd-replace-lane>'),
    Instruction(r'\I16X8.\EXTRACTLANE\K{\_s}~\laneidx', r'\hex{FD}~~24', r'[\V128] \to [\I32]', r'validation <valid-simd-extract-lane-sx>', r'execution <exec-simd-extract-lane-sx>'),
    Instruction(r'\I16X8.\EXTRACTLANE\K{\_u}~\laneidx', r'\hex{FD}~~25', r'[\V128] \to [\I32]', r'validation <valid-simd-extract-lane-sx>', r'execution <exec-simd-extract-lane-sx>'),
    Instruction(r'\I16X8.\REPLACELANE~\laneidx', r'\hex{FD}~~26', r'[\V128 \I32] \to [\V128]', r'validation <valid-simd-replace-lane>', r'execution <exec-simd-replace-lane>'),
    Instruction(r'\I32X4.\EXTRACTLANE~\laneidx', r'\hex{FD}~~27', r'[\V128] \to [\I32]', r'validation <valid-simd-extract-lane>', r'execution <exec-simd-extract-lane>'),
    Instruction(r'\I32X4.\REPLACELANE~\laneidx', r'\hex{FD}~~28', r'[\V128~\I32] \to [\V128]', r'validation <valid-simd-replace-lane>', r'execution <exec-simd-replace-lane>'),
    Instruction(r'\I64X2.\EXTRACTLANE~\laneidx', r'\hex{FD}~~29', r'[\V128] \to [\I64]', r'validation <valid-simd-extract-lane>', r'execution <exec-simd-extract-lane>'),
    Instruction(r'\I64X2.\REPLACELANE~\laneidx', r'\hex{FD}~~30', r'[\V128~\I64] \to [\V128]', r'validation <valid-simd-replace-lane>', r'execution <exec-simd-replace-lane>'),
    Instruction(r'\F32X4.\EXTRACTLANE~\laneidx', r'\hex{FD}~~31', r'[\V128] \to [\F32]', r'validation <valid-simd-extract-lane>', r'execution <exec-simd-extract-lane>'),
    Instruction(r'\F32X4.\REPLACELANE~\laneidx', r'\hex{FD}~~32', r'[\V128~\F32] \to [\V128]', r'validation <valid-simd-replace-lane>', r'execution <exec-simd-replace-lane>'),
    Instruction(r'\F64X2.\EXTRACTLANE~\laneidx', r'\hex{FD}~~33', r'[\V128] \to [\F64]', r'validation <valid-simd-extract-lane>', r'execution <exec-simd-extract-lane>'),
    Instruction(r'\F64X2.\REPLACELANE~\laneidx', r'\hex{FD}~~34', r'[\V128~\F64] \to [\V128]', r'validation <valid-simd-replace-lane>', r'execution <exec-simd-replace-lane>'),
    Instruction(r'\I8X16.\VEQ', r'\hex{FD}~~35', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-ieq>'),
    Instruction(r'\I8X16.\VNE', r'\hex{FD}~~36', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-ine>'),
    Instruction(r'\I8X16.\VLT\K{\_s}', r'\hex{FD}~~37', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-ilt_s>'),
    Instruction(r'\I8X16.\VLT\K{\_u}', r'\hex{FD}~~38', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-ilt_u>'),
    Instruction(r'\I8X16.\VGT\K{\_s}', r'\hex{FD}~~39', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-igt_s>'),
    Instruction(r'\I8X16.\VGT\K{\_u}', r'\hex{FD}~~40', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-igt_u>'),
    Instruction(r'\I8X16.\VLE\K{\_s}', r'\hex{FD}~~41', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-ile_s>'),
    Instruction(r'\I8X16.\VLE\K{\_u}', r'\hex{FD}~~42', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-ile_u>'),
    Instruction(r'\I8X16.\VGE\K{\_s}', r'\hex{FD}~~43', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-ige_s>'),
    Instruction(r'\I8X16.\VGE\K{\_u}', r'\hex{FD}~~44', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-ige_u>'),
    Instruction(r'\I16X8.\VEQ', r'\hex{FD}~~45', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-ieq>'),
    Instruction(r'\I16X8.\VNE', r'\hex{FD}~~46', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-ine>'),
    Instruction(r'\I16X8.\VLT\K{\_s}', r'\hex{FD}~~47', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-ilt_s>'),
    Instruction(r'\I16X8.\VLT\K{\_u}', r'\hex{FD}~~48', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-ilt_u>'),
    Instruction(r'\I16X8.\VGT\K{\_s}', r'\hex{FD}~~49', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-igt_s>'),
    Instruction(r'\I16X8.\VGT\K{\_u}', r'\hex{FD}~~50', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-igt_u>'),
    Instruction(r'\I16X8.\VLE\K{\_s}', r'\hex{FD}~~51', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-ile_s>'),
    Instruction(r'\I16X8.\VLE\K{\_u}', r'\hex{FD}~~52', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-ile_u>'),
    Instruction(r'\I16X8.\VGE\K{\_s}', r'\hex{FD}~~53', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-ige_s>'),
    Instruction(r'\I16X8.\VGE\K{\_u}', r'\hex{FD}~~54', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-ige_u>'),
    Instruction(r'\I32X4.\VEQ', r'\hex{FD}~~55', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-ieq>'),
    Instruction(r'\I32X4.\VNE', r'\hex{FD}~~56', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-ine>'),
    Instruction(r'\I32X4.\VLT\K{\_s}', r'\hex{FD}~~57', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-ilt_s>'),
    Instruction(r'\I32X4.\VLT\K{\_u}', r'\hex{FD}~~58', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-ilt_u>'),
    Instruction(r'\I32X4.\VGT\K{\_s}', r'\hex{FD}~~59', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-igt_s>'),
    Instruction(r'\I32X4.\VGT\K{\_u}', r'\hex{FD}~~60', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-igt_u>'),
    Instruction(r'\I32X4.\VLE\K{\_s}', r'\hex{FD}~~61', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-ile_s>'),
    Instruction(r'\I32X4.\VLE\K{\_u}', r'\hex{FD}~~62', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-ile_u>'),
    Instruction(r'\I32X4.\VGE\K{\_s}', r'\hex{FD}~~63', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-ige_s>'),
    Instruction(r'\I32X4.\VGE\K{\_u}', r'\hex{FD}~~64', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-ige_u>'),
    Instruction(r'\F32X4.\VEQ', r'\hex{FD}~~65', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-feq>'),
    Instruction(r'\F32X4.\VNE', r'\hex{FD}~~66', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-fne>'),
    Instruction(r'\F32X4.\VLT', r'\hex{FD}~~67', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-flt>'),
    Instruction(r'\F32X4.\VGT', r'\hex{FD}~~68', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-fgt>'),
    Instruction(r'\F32X4.\VLE', r'\hex{FD}~~69', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-fle>'),
    Instruction(r'\F32X4.\VGE', r'\hex{FD}~~70', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-fge>'),
    Instruction(r'\F64X2.\VEQ', r'\hex{FD}~~71', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-feq>'),
    Instruction(r'\F64X2.\VNE', r'\hex{FD}~~72', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-fne>'),
    Instruction(r'\F64X2.\VLT', r'\hex{FD}~~73', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-flt>'),
    Instruction(r'\F64X2.\VGT', r'\hex{FD}~~74', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-fgt>'),
    Instruction(r'\F64X2.\VLE', r'\hex{FD}~~75', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-fle>'),
    Instruction(r'\F64X2.\VGE', r'\hex{FD}~~76', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-fge>'),
    Instruction(r'\V128.\VNOT', r'\hex{FD}~~77', r'[\V128] \to [\V128]', r'validation <valid-vsunop>', r'execution <exec-vsunop>', r'operator <op-inot>'),
    Instruction(r'\V128.\VAND', r'\hex{FD}~~78', r'[\V128~\V128] \to [\V128]', r'validation <valid-vsbinop>', r'execution <exec-vsbinop>', r'operator <op-iand>'),
    Instruction(r'\V128.\VANDNOT', r'\hex{FD}~~79', r'[\V128~\V128] \to [\V128]', r'validation <valid-vsbinop>', r'execution <exec-vsbinop>', r'operator <op-iandnot>'),
    ...
    Instruction(r'\I8X16.\NARROW\K{\_i16x8\_u}', r'\hex{FD}~~102', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-simd-narrow>'),
    Instruction(r'\I8X16.\VSHL', r'\hex{FD}~~107', r'[\V128~\I32] \to [\V128]', r'validation <valid-vshiftop>', r'execution <exec-vshiftop>', r'operator <op-ishl>'),
    Instruction(r'\I8X16.\VSHR\K{\_s}', r'\hex{FD}~~108', r'[\V128~\I32] \to [\V128]', r'validation <valid-vshiftop>', r'execution <exec-vshiftop>', r'operator <op-ishr_s>'),
    Instruction(r'\I8X16.\VSHR\K{\_u}', r'\hex{FD}~~109', r'[\V128~\I32] \to [\V128]', r'validation <valid-vshiftop>', r'execution <exec-vshiftop>', r'operator <op-ishr_u>'),
    Instruction(r'\I8X16.\VADD', r'\hex{FD}~~110', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-iadd>'),
    Instruction(r'\I8X16.\VADD\K{\_sat\_s}', r'\hex{FD}~~111', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-iadd_sat_s>'),
    Instruction(r'\I8X16.\VADD\K{\_sat\_u}', r'\hex{FD}~~112', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-iadd_sat_u>'),
    Instruction(r'\I8X16.\VSUB', r'\hex{FD}~~113', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-isub>'),
    Instruction(r'\I8X16.\VSUB\K{\_sat\_s}', r'\hex{FD}~~114', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-isub_sat_s>'),
    Instruction(r'\I8X16.\VSUB\K{\_sat\_u}', r'\hex{FD}~~115', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-isub_sat_u>'),
    Instruction(r'\I8X16.\VMIN\K{\_s}', r'\hex{FD}~~118', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-imin_s>'),
    Instruction(r'\I8X16.\VMIN\K{\_u}', r'\hex{FD}~~119', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-imin_u>'),
    Instruction(r'\I8X16.\VMAX\K{\_s}', r'\hex{FD}~~120', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-imax_s>'),
    Instruction(r'\I8X16.\VMAX\K{\_u}', r'\hex{FD}~~121', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-imax_u>'),
    ...
    Instruction(r'\I16X8.\NARROW\K{\_i16x8\_u}', r'\hex{FD}~~134', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-simd-narrow>'),
    Instruction(r'\I16X8.\WIDEN\K{\_low\_i8x16\_s}', r'\hex{FD}~~135', r'[\V128] \to [\V128]', r'validation <valid-vunop>', r'execution <exec-simd-widen>'),
    Instruction(r'\I16X8.\WIDEN\K{\_high\_i8x16\_s}', r'\hex{FD}~~136', r'[\V128] \to [\V128]', r'validation <valid-vunop>', r'execution <exec-simd-widen>'),
    Instruction(r'\I16X8.\WIDEN\K{\_low\_i8x16\_u}', r'\hex{FD}~~137', r'[\V128] \to [\V128]', r'validation <valid-vunop>', r'execution <exec-simd-widen>'),
    Instruction(r'\I16X8.\WIDEN\K{\_high\_i8x16\_u}', r'\hex{FD}~~138', r'[\V128] \to [\V128]', r'validation <valid-vunop>', r'execution <exec-simd-widen>'),
    Instruction(r'\I16X8.\VSHL', r'\hex{FD}~~139', r'[\V128~\I32] \to [\V128]', r'validation <valid-vshiftop>', r'execution <exec-vshiftop>', r'operator <op-ishl>'),
    Instruction(r'\I16X8.\VSHR\K{\_s}', r'\hex{FD}~~140', r'[\V128~\I32] \to [\V128]', r'validation <valid-vshiftop>', r'execution <exec-vshiftop>', r'operator <op-ishr_s>'),
    Instruction(r'\I16X8.\VSHR\K{\_u}', r'\hex{FD}~~141', r'[\V128~\I32] \to [\V128]', r'validation <valid-vshiftop>', r'execution <exec-vshiftop>', r'operator <op-ishr_u>'),
    Instruction(r'\I16X8.\VADD', r'\hex{FD}~~142', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-iadd>'),
    Instruction(r'\I16X8.\VADD\K{\_sat\_s}', r'\hex{FD}~~143', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-iadd_sat_s>'),
    Instruction(r'\I16X8.\VADD\K{\_sat\_u}', r'\hex{FD}~~144', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-iadd_sat_u>'),
    Instruction(r'\I16X8.\VSUB', r'\hex{FD}~~145', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-isub>'),
    Instruction(r'\I16X8.\VSUB\K{\_sat\_s}', r'\hex{FD}~~146', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-isub_sat_s>'),
    Instruction(r'\I16X8.\VSUB\K{\_sat\_u}', r'\hex{FD}~~147', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-isub_sat_u>'),
    Instruction(r'\I16X8.\VMUL', r'\hex{FD}~~149', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-imul>'),
    Instruction(r'\I16X8.\VMIN\K{\_s}', r'\hex{FD}~~150', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-imin_s>'),
    Instruction(r'\I16X8.\VMIN\K{\_u}', r'\hex{FD}~~151', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-imin_u>'),
    Instruction(r'\I16X8.\VMAX\K{\_s}', r'\hex{FD}~~152', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-imax_s>'),
    Instruction(r'\I16X8.\VMAX\K{\_u}', r'\hex{FD}~~153', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-imax_u>'),
    ...
    Instruction(r'\I32X4.\WIDEN\K{\_high\_i16x8\_s}', r'\hex{FD}~~168', r'[\V128] \to [\V128]', r'validation <valid-vunop>', r'execution <exec-simd-widen>'),
    Instruction(r'\I32X4.\WIDEN\K{\_low\_i16x8\_u}', r'\hex{FD}~~169', r'[\V128] \to [\V128]', r'validation <valid-vunop>', r'execution <exec-simd-widen>'),
    Instruction(r'\I32X4.\WIDEN\K{\_high\_i16x8\_u}', r'\hex{FD}~~170', r'[\V128] \to [\V128]', r'validation <valid-vunop>', r'execution <exec-simd-widen>'),
    Instruction(r'\I32X4.\VSHL', r'\hex{FD}~~171', r'[\V128~\I32] \to [\V128]', r'validation <valid-vshiftop>', r'execution <exec-vshiftop>', r'operator <op-ishl>'),
    Instruction(r'\I32X4.\VSHR\K{\_s}', r'\hex{FD}~~172', r'[\V128~\I32] \to [\V128]', r'validation <valid-vshiftop>', r'execution <exec-vshiftop>', r'operator <op-ishr_s>'),
    Instruction(r'\I32X4.\VSHR\K{\_u}', r'\hex{FD}~~173', r'[\V128~\I32] \to [\V128]', r'validation <valid-vshiftop>', r'execution <exec-vshiftop>', r'operator <op-ishr_u>'),
    Instruction(r'\I32X4.\VADD', r'\hex{FD}~~174', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-iadd>'),
    Instruction(r'\I32X4.\VSUB', r'\hex{FD}~~177', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-isub>'),
    Instruction(r'\I32X4.\VMUL', r'\hex{FD}~~181', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-imul>'),
    Instruction(r'\I32X4.\VMIN\K{\_s}', r'\hex{FD}~~182', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-imin_s>'),
    Instruction(r'\I32X4.\VMIN\K{\_u}', r'\hex{FD}~~183', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-imin_u>'),
    ...
    Instruction(r'\I64X2.\VADD', r'\hex{FD}~~206', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-iadd>'),
    Instruction(r'\I64X2.\VSUB', r'\hex{FD}~~209', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-isub>'),
    Instruction(r'\I64X2.\VMUL', r'\hex{FD}~~213', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-imul>'),
    Instruction(r'\F32X4.\VABS', r'\hex{FD}~~224', r'[\V128] \to [\V128]', r'validation <valid-vunop>', r'execution <exec-vunop>', r'operator <op-fabs>'),
    Instruction(r'\F32X4.\VNEG', r'\hex{FD}~~225', r'[\V128] \to [\V128]', r'validation <valid-vunop>', r'execution <exec-vunop>', r'operator <op-fneg>'),
    Instruction(r'\F32X4.\VSQRT', r'\hex{FD}~~227', r'[\V128] \to [\I32]', r'validation <valid-vunop>', r'execution <exec-vunop>', r'operator <op-fsqrt>'),
    Instruction(r'\F32X4.\VADD', r'\hex{FD}~~228', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-fadd>'),
    Instruction(r'\F32X4.\VSUB', r'\hex{FD}~~229', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-fsub>'),
    Instruction(r'\F32X4.\VMUL', r'\hex{FD}~~230', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-fmul>'),
    Instruction(r'\F32X4.\VDIV', r'\hex{FD}~~231', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-fdiv>'),
    Instruction(r'\F32X4.\VMIN', r'\hex{FD}~~232', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-fmin>'),
    Instruction(r'\F32X4.\VMAX', r'\hex{FD}~~233', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-fmax>'),
    Instruction(r'\F64X2.\VABS', r'\hex{FD}~~236', r'[\V128] \to [\V128]', r'validation <valid-vunop>', r'execution <exec-vunop>', r'operator <op-fabs>'),
    Instruction(r'\F64X2.\VNEG', r'\hex{FD}~~237', r'[\V128] \to [\V128]', r'validation <valid-vunop>', r'execution <exec-vunop>', r'operator <op-fneg>'),
    Instruction(r'\F64X2.\VSQRT', r'\hex{FD}~~239', r'[\V128] \to [\I32]', r'validation <valid-vunop>', r'execution <exec-vunop>', r'operator <op-fsqrt>'),
    Instruction(r'\F64X2.\VADD', r'\hex{FD}~~240', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-fadd>'),
    Instruction(r'\F64X2.\VSUB', r'\hex{FD}~~241', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-fsub>'),
    Instruction(r'\F64X2.\VMUL', r'\hex{FD}~~242', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-fmul>'),
    Instruction(r'\F64X2.\VDIV', r'\hex{FD}~~243', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-fdiv>'),
    Instruction(r'\F64X2.\VMIN', r'\hex{FD}~~244', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-fmin>'),
    Instruction(r'\F64X2.\VMAX', r'\hex{FD}~~245', r'[\V128~\V128] \to [\V128]', r'validation <valid-vbinop>', r'execution <exec-vbinop>', r'operator <op-fmax>'),
    Instruction(r'\I32X4.\TRUNC\K{\_sat\_f32x4\_s}', r'\hex{FD}~~248', r'[\V128] \to [\V128]', r'validation <valid-vunop>', r'execution <exec-vunop>', r'operator <op-trunc_sat_s>'),
    Instruction(r'\I32X4.\TRUNC\K{\_sat\_f32x4\_u}', r'\hex{FD}~~249', r'[\V128] \to [\V128]', r'validation <valid-vunop>', r'execution <exec-vunop>', r'operator <op-trunc_sat_u>'),
    Instruction(r'\F32X4.\CONVERT\K{\_i32x4\_s}', r'\hex{FD}~~250', r'[\V128] \to [\V128]', r'validation <valid-vunop>', r'execution <exec-vunop>', r'operator <op-convert_s>'),
    Instruction(r'\F32X4.\CONVERT\K{\_i32x4\_u}', r'\hex{FD}~~251', r'[\V128] \to [\V128]', r'validation <valid-vunop>', r'execution <exec-vunop>', r'operator <op-convert_u>'),
]
