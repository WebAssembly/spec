...
INSTRUCTIONS = [
    ...
    Instruction(r'\V128.\ANYTRUE', r'\hex{FD}~~83', r'[\V128] \to [\I32]', r'valid-vitestop', r'exec-vitestop'),
    Instruction(r'\V128.\LOAD\K{8\_lane}~\memarg~\laneidx', r'\hex{FD}~~84', r'[\I32~\V128] \to [\V128]', r'valid-load-lane', r'exec-load-lane'),
    Instruction(r'\V128.\LOAD\K{16\_lane}~\memarg~\laneidx', r'\hex{FD}~~85', r'[\I32~\V128] \to [\V128]', r'valid-load-lane', r'exec-load-lane'),
    Instruction(r'\V128.\LOAD\K{32\_lane}~\memarg~\laneidx', r'\hex{FD}~~86', r'[\I32~\V128] \to [\V128]', r'valid-load-lane', r'exec-load-lane'),
    Instruction(r'\V128.\LOAD\K{64\_lane}~\memarg~\laneidx', r'\hex{FD}~~87', r'[\I32~\V128] \to [\V128]', r'valid-load-lane', r'exec-load-lane'),
    Instruction(r'\V128.\STORE\K{8\_lane}~\memarg~\laneidx', r'\hex{FD}~~88', r'[\I32~\V128] \to [\V128]', r'valid-store-lane', r'exec-store-lane'),
    Instruction(r'\V128.\STORE\K{16\_lane}~\memarg~\laneidx', r'\hex{FD}~~89', r'[\I32~\V128] \to [\V128]', r'valid-store-lane', r'exec-store-lane'),
    Instruction(r'\V128.\STORE\K{32\_lane}~\memarg~\laneidx', r'\hex{FD}~~90', r'[\I32~\V128] \to [\V128]', r'valid-store-lane', r'exec-store-lane'),
    Instruction(r'\V128.\STORE\K{64\_lane}~\memarg~\laneidx', r'\hex{FD}~~91', r'[\I32~\V128] \to [\V128]', r'valid-store-lane', r'exec-store-lane'),
    Instruction(r'\V128.\LOAD\K{32\_zero}~\memarg~\laneidx', r'\hex{FD}~~92', r'[\I32] \to [\V128]', r'valid-load-zero', r'exec-load-zero'),
    Instruction(r'\V128.\LOAD\K{64\_zero}~\memarg~\laneidx', r'\hex{FD}~~93', r'[\I32] \to [\V128]', r'valid-load-zero', r'exec-load-zero'),
    Instruction(r'\F32X4.\VDEMOTE\K{\_f64x2\_zero}', r'\hex{FD}~~94', r'[\V128] \to [\V128]', r'valid-vcvtop', r'exec-vcvtop', r'op-demote'),
    Instruction(r'\F64X2.\VPROMOTE\K{\_low\_f32x4}', r'\hex{FD}~~95', r'[\V128] \to [\V128]', r'valid-vcvtop', r'exec-vcvtop', r'op-promote'),
    ...
    Instruction(r'\I8X16.\VPOPCNT', r'\hex{FD}~~98', r'[\V128] \to [\V128]', r'valid-vunop', r'exec-vunop', r'op-ipopcnt'),
    ...
    Instruction(r'\F32X4.\VCEIL', r'\hex{FD}~~103', r'[\V128] \to [\V128]', r'valid-vunop', r'exec-vunop', r'op-fceil'),
    Instruction(r'\F32X4.\VFLOOR', r'\hex{FD}~~104', r'[\V128] \to [\V128]', r'valid-vunop', r'exec-vunop', r'op-ffloor'),
    Instruction(r'\F32X4.\VTRUNC', r'\hex{FD}~~105', r'[\V128] \to [\V128]', r'valid-vunop', r'exec-vunop', r'op-ftrunc'),
    Instruction(r'\F32X4.\VNEAREST', r'\hex{FD}~~106', r'[\V128] \to [\V128]', r'valid-vunop', r'exec-vunop', r'op-fnearest'),
    ...
    Instruction(r'\F64X2.\VCEIL', r'\hex{FD}~~116', r'[\V128] \to [\V128]', r'valid-vunop', r'exec-vunop', r'op-fceil'),
    Instruction(r'\F64X2.\VFLOOR', r'\hex{FD}~~117', r'[\V128] \to [\V128]', r'valid-vunop', r'exec-vunop', r'op-ffloor'),
    ...
    Instruction(r'\F64X2.\VTRUNC', r'\hex{FD}~~122', r'[\V128] \to [\V128]', r'valid-vunop', r'exec-vunop', r'op-ftrunc'),
    Instruction(r'\I8X16.\AVGR\K{\_u}', r'\hex{FD}~~123', r'[\V128~\V128] \to [\V128]', r'valid-vbinop', r'exec-vbinop', r'op-iavgr_u'),
    Instruction(r'\I16X8.\EXTADDPAIRWISE\K{\_i8x16\_s}', r'\hex{FD}~~124', r'[\V128] \to [\V128]', r'valid-simd-extaddpairwise', r'exec-simd-extaddpairwise'),
    Instruction(r'\I16X8.\EXTADDPAIRWISE\K{\_i8x16\_u}', r'\hex{FD}~~125', r'[\V128] \to [\V128]', r'valid-simd-extaddpairwise', r'exec-simd-extaddpairwise'),
    Instruction(r'\I32X4.\EXTADDPAIRWISE\K{\_i16x8\_s}', r'\hex{FD}~~126', r'[\V128] \to [\V128]', r'valid-simd-extaddpairwise', r'exec-simd-extaddpairwise'),
    Instruction(r'\I32X4.\EXTADDPAIRWISE\K{\_i16x8\_u}', r'\hex{FD}~~127', r'[\V128] \to [\V128]', r'valid-simd-extaddpairwise', r'exec-simd-extaddpairwise'),
    ...
    Instruction(r'\I16X8.\Q15MULRSAT\K{\_s}', r'\hex{FD}~~130', r'[\V128~\V128] \to [\V128]', r'valid-vbinop', r'exec-vbinop', r'op-iq15mulrsat_s'),
    ...
    Instruction(r'\F64X2.\VNEAREST', r'\hex{FD}~~148', r'[\V128] \to [\V128]', r'valid-vunop', r'exec-vunop', r'op-fnearest'),
    ...
    Instruction(r'\I16X8.\EXTMUL\K{\_low\_i8x16\_s}', r'\hex{FD}~~156', r'[\V128~\V128] \to [\V128]', r'valid-simd-vextmul', r'exec-simd-vextmul'),
    ...
    Instruction(r'\I32X4.\EXTMUL\K{\_low\_i16x8\_s}', r'\hex{FD}~~188', r'[\V128~\V128] \to [\V128]', r'valid-simd-vextmul', r'exec-simd-vextmul'),
    ...
    Instruction(r'\I64X2.\VABS', r'\hex{FD}~~192', r'[\V128] \to [\V128]', r'valid-vunop', r'exec-vunop', r'op-iabs'),
    Instruction(r'\I64X2.\VNEG', r'\hex{FD}~~193', r'[\V128] \to [\V128]', r'valid-vunop', r'exec-vunop', r'op-ineg'),
    Instruction(r'\I64X2.\ALLTRUE', r'\hex{FD}~~195', r'[\V128] \to [\I32]', r'valid-vitestop', r'exec-vitestop'),
    ...
    Instruction(r'\I64X2.\VEQ', r'\hex{FD}~~214', r'[\V128~\V128] \to [\V128]', r'valid-vbinop', r'exec-vbinop', r'op-ieq'),
    Instruction(r'\I64X2.\VNE', r'\hex{FD}~~215', r'[\V128~\V128] \to [\V128]', r'valid-vbinop', r'exec-vbinop', r'op-ine'),
    Instruction(r'\I64X2.\VLT\K{\_s}', r'\hex{FD}~~216', r'[\V128~\V128] \to [\V128]', r'valid-vbinop', r'exec-vbinop', r'op-ilt_s'),
    Instruction(r'\I64X2.\VGT\K{\_s}', r'\hex{FD}~~217', r'[\V128~\V128] \to [\V128]', r'valid-vbinop', r'exec-vbinop', r'op-igt_s'),
    Instruction(r'\I64X2.\VLE\K{\_s}', r'\hex{FD}~~218', r'[\V128~\V128] \to [\V128]', r'valid-vbinop', r'exec-vbinop', r'op-ile_s'),
    Instruction(r'\I64X2.\VGE\K{\_s}', r'\hex{FD}~~219', r'[\V128~\V128] \to [\V128]', r'valid-vbinop', r'exec-vbinop', r'op-ige_s'),
    Instruction(r'\I64X2.\EXTMUL\K{\_low\_i32x4\_s}', r'\hex{FD}~~220', r'[\V128~\V128] \to [\V128]', r'valid-simd-vextmul', r'exec-simd-vextmul'),
    Instruction(r'\I64X2.\EXTMUL\K{\_high\_i32x4\_s}', r'\hex{FD}~~221', r'[\V128~\V128] \to [\V128]', r'valid-simd-vextmul', r'exec-simd-vextmul'),
    Instruction(r'\I64X2.\EXTMUL\K{\_low\_i32x4\_u}', r'\hex{FD}~~222', r'[\V128~\V128] \to [\V128]', r'valid-simd-vextmul', r'exec-simd-vextmul'),
    Instruction(r'\I64X2.\EXTMUL\K{\_high\_i32x4\_u}', r'\hex{FD}~~223', r'[\V128~\V128] \to [\V128]', r'valid-simd-vextmul', r'exec-simd-vextmul'),
    ...
    Instruction(r'\F64X2.\VPMIN', r'\hex{FD}~~246', r'[\V128~\V128] \to [\V128]', r'valid-vbinop', r'exec-vbinop', r'op-fpmin'),
    Instruction(r'\F64X2.\VPMAX', r'\hex{FD}~~247', r'[\V128~\V128] \to [\V128]', r'valid-vbinop', r'exec-vbinop', r'op-fpmax'),
    ...
    Instruction(r'\I32X4.\VTRUNC\K{\_sat\_f64x2\_s\_zero}', r'\hex{FD}~~252', r'[\V128] \to [\V128]', r'valid-vcvtop', r'exec-vcvtop', r'op-trunc_sat_s'),
    Instruction(r'\I32X4.\VTRUNC\K{\_sat\_f64x2\_u\_zero}', r'\hex{FD}~~253', r'[\V128] \to [\V128]', r'valid-vcvtop', r'exec-vcvtop', r'op-trunc_sat_u'),
    Instruction(r'\F64X2.\VCONVERT\K{\_low\_i32x4\_s}', r'\hex{FD}~~254', r'[\V128] \to [\V128]', r'valid-vcvtop', r'exec-vcvtop', r'op-convert_s'),
    Instruction(r'\F64X2.\VCONVERT\K{\_low\_i32x4\_u}', r'\hex{FD}~~255', r'[\V128] \to [\V128]', r'valid-vcvtop', r'exec-vcvtop', r'op-convert_u'),
]
