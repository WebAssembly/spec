...
INSTRUCTIONS = [
    ...
    Instruction(r'\I31GETS', r'\hex{FB}~\hex{21}', r'[\I31REF] \to [\I32]', r'valid-i31.get_s', r'exec-i31.get_s'),
    Instruction(r'\I31GETU', r'\hex{FB}~\hex{22}', r'[\I31REF] \to [\I32]', r'valid-i31.get_s', r'exec-i31.get_s'),
    ...
    Instruction(r'\BRONCAST~t_1~t_2', r'\hex{FB}~\hex{4E}', r'[t_1] \to [t_1\typediff t_2]', r'valid-br_on_cast', r'exec-br_on_cast'),
