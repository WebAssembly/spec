...
# today is a configuration variable, don't overwrite it.
date_today = date.today()
previous_version_date = date(2019, 12, 5)
...
previous_version_url = f'https://www.w3.org/TR/{previous_version_date.year}/PR-wasm-core-{previous_version_date.strftime("%Y%m%d")}/'
this_version_url = f'https://www.w3.org/TR/{date_today.year}/REC-wasm-core-{date_today.strftime("%Y%m%d")}/'
...
html_context = {
  ...
  'date_iso': date_today.strftime("%Y-%m-%d"),
  'date_human': date_today.strftime("%d %B %Y"),
  ...
  'this_version_url': this_version_url,
  'version': version,
}
