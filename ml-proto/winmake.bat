...
ocamlc.opt -c -bin-annot -I host -I spec -I given -I host/import -o host/script.cmo host/script.ml
...
ocamlc.opt -c -bin-annot -I host -I spec -I given -I host/import -o host/js.cmi host/js.mli
...
ocamlc.opt -c -g -bin-annot -I host -I spec -I given -I host/import -o host/js.d.cmo host/js.ml
