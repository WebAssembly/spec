...
(module
  (export "f32.add" (func (param $x f32) (param $y f32) (result f32) (f32.add (get_local $x) (get_local $y))))
  (export "f32.sub" (func (param $x f32) (param $y f32) (result f32) (f32.sub (get_local $x) (get_local $y))))
  (export "f32.mul" (func (param $x f32) (param $y f32) (result f32) (f32.mul (get_local $x) (get_local $y))))
  (export "f32.div" (func (param $x f32) (param $y f32) (result f32) (f32.div (get_local $x) (get_local $y))))
  (export "f32.sqrt" (func (param $x f32) (result f32) (f32.sqrt (get_local $x))))
  (export "f32.abs" (func (param $x f32) (result f32) (f32.abs (get_local $x))))
  (export "f32.neg" (func (param $x f32) (result f32) (f32.neg (get_local $x))))
  (export "f32.copysign" (func (param $x f32) (param $y f32) (result f32) (f32.copysign (get_local $x) (get_local $y))))
  (export "f32.ceil" (func (param $x f32) (result f32) (f32.ceil (get_local $x))))
  (export "f32.floor" (func (param $x f32) (result f32) (f32.floor (get_local $x))))
  (export "f32.trunc" (func (param $x f32) (result f32) (f32.trunc (get_local $x))))
  (export "f32.nearest" (func (param $x f32) (result f32) (f32.nearest (get_local $x))))
  (export "f32.min" (func (param $x f32) (param $y f32) (result f32) (f32.min (get_local $x) (get_local $y))))
  (export "f32.max" (func (param $x f32) (param $y f32) (result f32) (f32.max (get_local $x) (get_local $y))))

  (export "f64.add" (func (param $x f64) (param $y f64) (result f64) (f64.add (get_local $x) (get_local $y))))
  (export "f64.sub" (func (param $x f64) (param $y f64) (result f64) (f64.sub (get_local $x) (get_local $y))))
  (export "f64.mul" (func (param $x f64) (param $y f64) (result f64) (f64.mul (get_local $x) (get_local $y))))
  (export "f64.div" (func (param $x f64) (param $y f64) (result f64) (f64.div (get_local $x) (get_local $y))))
  (export "f64.sqrt" (func (param $x f64) (result f64) (f64.sqrt (get_local $x))))
  (export "f64.abs" (func (param $x f64) (result f64) (f64.abs (get_local $x))))
  (export "f64.neg" (func (param $x f64) (result f64) (f64.neg (get_local $x))))
  (export "f64.copysign" (func (param $x f64) (param $y f64) (result f64) (f64.copysign (get_local $x) (get_local $y))))
  (export "f64.ceil" (func (param $x f64) (result f64) (f64.ceil (get_local $x))))
  (export "f64.floor" (func (param $x f64) (result f64) (f64.floor (get_local $x))))
  (export "f64.trunc" (func (param $x f64) (result f64) (f64.trunc (get_local $x))))
  (export "f64.nearest" (func (param $x f64) (result f64) (f64.nearest (get_local $x))))
  (export "f64.min" (func (param $x f64) (param $y f64) (result f64) (f64.min (get_local $x) (get_local $y))))
  (export "f64.max" (func (param $x f64) (param $y f64) (result f64) (f64.max (get_local $x) (get_local $y))))
)
