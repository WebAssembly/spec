...
(assert_invalid
  ...
  "type mismatch: expression has type () but the context requires i32"
)
(assert_invalid
  (module (func (param i64) (result i64) (set_local 0 (i64.const 1))))
  "type mismatch: expression has type () but the context requires i64"
)
(assert_invalid
  (module (func (param f32) (result f32) (set_local 0 (f32.const 1))))
  "type mismatch: expression has type () but the context requires f32"
)
(assert_invalid
  (module (func (param f64) (result f64) (set_local 0 (f64.const 1))))
  "type mismatch: expression has type () but the context requires f64"
)
