...
(module
  ...
  (func $rol (param $x i64) (param $y i64) (result i64) (i64.rol (get_local $x) (get_local $y)))
  (func $ror (param $x i64) (param $y i64) (result i64) (i64.ror (get_local $x) (get_local $y)))
  (func $bswap (param $x i64) (result i64) (i64.bswap (get_local $x)))
...
(assert_return (invoke "rol" (i64.const 1) (i64.const 1)) (i64.const 2))
(assert_return (invoke "rol" (i64.const 1) (i64.const 0)) (i64.const 1))
(assert_return (invoke "rol" (i64.const -1) (i64.const 1)) (i64.const -1))
(assert_return (invoke "rol" (i64.const 0xabd1234ef567809c) (i64.const 63)) (i64.const 0x55e891a77ab3c04e))
(assert_return (invoke "rol" (i64.const 0xabd1234ef567809c) (i64.const 0x800000000000003f)) (i64.const 0x55e891a77ab3c04e))

(assert_return (invoke "ror" (i64.const 1) (i64.const 1)) (i64.const 0x8000000000000000))
(assert_return (invoke "ror" (i64.const 1) (i64.const 0)) (i64.const 1))
(assert_return (invoke "ror" (i64.const -1) (i64.const 1)) (i64.const -1))
(assert_return (invoke "ror" (i64.const 0xabcd1234ef567809) (i64.const 53)) (i64.const 0x6891a77ab3c04d5e))
(assert_return (invoke "ror" (i64.const 0xabcd1234ef567809) (i64.const 0x35)) (i64.const 0x6891a77ab3c04d5e))
(assert_return (invoke "ror" (i64.const 0xabcd1234ef567809) (i64.const 0xf5)) (i64.const 0x6891a77ab3c04d5e))

(assert_return (invoke "bswap" (i64.const 1)) (i64.const 0x0100000000000000))
(assert_return (invoke "bswap" (i64.const -1)) (i64.const -1))
(assert_return (invoke "bswap" (i64.const 0x0100000000000000)) (i64.const 0x1))
(assert_return (invoke "bswap" (i64.const 0x9765abcd8234123f)) (i64.const 0x3f123482cdab6597))
(assert_return (invoke "bswap" (i64.const 0x97f5abcd82b492ff)) (i64.const 0xff92b482cdabf597))
