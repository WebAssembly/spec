...
(assert_trap   (invoke "callt" (i32.const 7)) "runtime: table index out of bounds")
(assert_trap   (invoke "callt" (i32.const 100)) "runtime: table index out of bounds")
(assert_trap   (invoke "callt" (i32.const -1)) "runtime: table index out of bounds")
...
(assert_trap   (invoke "callu" (i32.const 7)) "runtime: table index out of bounds")
(assert_trap   (invoke "callu" (i32.const -1)) "runtime: table index out of bounds")
