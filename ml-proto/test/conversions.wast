(module
  (export "i64.extend_s_i32" (func (param $x i32) (result i64) (i64.extend_s/i32 (get_local $x))))
  (export "i64.extend_u_i32" (func (param $x i32) (result i64) (i64.extend_u/i32 (get_local $x))))
  (export "i32.wrap_i64" (func (param $x i64) (result i32) (i32.wrap/i64 (get_local $x))))
  (export "i32.trunc_s_f32" (func (param $x f32) (result i32) (i32.trunc_s/f32 (get_local $x))))
  (export "i32.trunc_u_f32" (func (param $x f32) (result i32) (i32.trunc_u/f32 (get_local $x))))
  (export "i32.trunc_s_f64" (func (param $x f64) (result i32) (i32.trunc_s/f64 (get_local $x))))
  (export "i32.trunc_u_f64" (func (param $x f64) (result i32) (i32.trunc_u/f64 (get_local $x))))
  (export "i64.trunc_s_f32" (func (param $x f32) (result i64) (i64.trunc_s/f32 (get_local $x))))
  (export "i64.trunc_u_f32" (func (param $x f32) (result i64) (i64.trunc_u/f32 (get_local $x))))
  (export "i64.trunc_s_f64" (func (param $x f64) (result i64) (i64.trunc_s/f64 (get_local $x))))
  (export "i64.trunc_u_f64" (func (param $x f64) (result i64) (i64.trunc_u/f64 (get_local $x))))
  (export "f32.convert_s_i32" (func (param $x i32) (result f32) (f32.convert_s/i32 (get_local $x))))
  (export "f32.convert_s_i64" (func (param $x i64) (result f32) (f32.convert_s/i64 (get_local $x))))
  (export "f64.convert_s_i32" (func (param $x i32) (result f64) (f64.convert_s/i32 (get_local $x))))
  (export "f64.convert_s_i64" (func (param $x i64) (result f64) (f64.convert_s/i64 (get_local $x))))
  (export "f32.convert_u_i32" (func (param $x i32) (result f32) (f32.convert_u/i32 (get_local $x))))
  (export "f32.convert_u_i64" (func (param $x i64) (result f32) (f32.convert_u/i64 (get_local $x))))
  (export "f64.convert_u_i32" (func (param $x i32) (result f64) (f64.convert_u/i32 (get_local $x))))
  (export "f64.convert_u_i64" (func (param $x i64) (result f64) (f64.convert_u/i64 (get_local $x))))
  ...
  (export "i32.reinterpret_f32" (func (param $x f32) (result i32) (i32.reinterpret/f32 (get_local $x))))
  (export "i64.reinterpret_f64" (func (param $x f64) (result i64) (i64.reinterpret/f64 (get_local $x))))
)
