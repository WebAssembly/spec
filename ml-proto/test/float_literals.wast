...
(assert_same (invoke "f32.positive_nan") (i32.const 0x7fc00000))
(assert_same (invoke "f32.negative_nan") (i32.const 0xffc00000))
(assert_same (invoke "f32.plain_nan") (i32.const 0x7fc00000))
(assert_same (invoke "f32.informally_known_as_plain_snan") (i32.const 0x7fa00000))
(assert_same (invoke "f32.allones_nan") (i32.const 0xffffffff))
(assert_same (invoke "f32.misc_nan") (i32.const 0x7f812345))
(assert_same (invoke "f32.misc_positive_nan") (i32.const 0x7fb04050))
(assert_same (invoke "f32.misc_negative_nan") (i32.const 0xffaabcde))
(assert_same (invoke "f32.infinity") (i32.const 0x7f800000))
(assert_same (invoke "f32.positive_infinity") (i32.const 0x7f800000))
(assert_same (invoke "f32.negative_infinity") (i32.const 0xff800000))
(assert_same (invoke "f32.zero") (i32.const 0))
(assert_same (invoke "f32.positive_zero") (i32.const 0))
(assert_same (invoke "f32.negative_zero") (i32.const 0x80000000))
(assert_same (invoke "f32.decimal") (i32.const 0x40c90fdb))
...
(assert_same (invoke "f64.negative_nan") (i64.const 0xfff8000000000000))
(assert_same (invoke "f64.plain_nan") (i64.const 0x7ff8000000000000))
(assert_same (invoke "f64.informally_known_as_plain_snan") (i64.const 0x7ff4000000000000))
(assert_same (invoke "f64.allones_nan") (i64.const 0xffffffffffffffff))
(assert_same (invoke "f64.misc_nan") (i64.const 0x7ff0123456789abc))
(assert_same (invoke "f64.misc_positive_nan") (i64.const 0x7ff3040506070809))
(assert_same (invoke "f64.misc_negative_nan") (i64.const 0xfff2abcdef012345))
(assert_same (invoke "f64.infinity") (i64.const 0x7ff0000000000000))
(assert_same (invoke "f64.positive_infinity") (i64.const 0x7ff0000000000000))
(assert_same (invoke "f64.negative_infinity") (i64.const 0xfff0000000000000))
(assert_same (invoke "f64.zero") (i64.const 0))
(assert_same (invoke "f64.positive_zero") (i64.const 0))
(assert_same (invoke "f64.negative_zero") (i64.const 0x8000000000000000))
(assert_same (invoke "f64.decimal") (i64.const 0x401921fb54442d18))
