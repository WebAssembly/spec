...
(assert_invalid
  (module (func $type-unary-operand-missing i32.eqz drop))
  "type mismatch"
)
(assert_invalid
  (module (func $type-unary-operand-missing-in-block (i32.const 0) block i32.eqz drop end))
  "type mismatch"
)
(assert_invalid
  (module (func $type-unary-operand-missing-in-loop (i32.const 0) loop i32.eqz drop end))
  "type mismatch"
)
(assert_invalid
  (module (func $type-unary-operand-missing-in-if (i32.const 0) (i32.const 0) if i32.eqz drop end))
  "type mismatch"
)
(assert_invalid
  (module (func $type-unary-operand-missing-in-else (i32.const 0) (i32.const 0) if (i32.const 0) else i32.eqz end drop))
  "type mismatch"
)

(assert_invalid
  (module (func $type-binary-1st-operand-missing i32.add drop))
  "type mismatch"
)
(assert_invalid
  (module (func $type-binary-2nd-operand-missing (i32.const 0) i32.add drop))
  "type mismatch"
)
(assert_invalid
  (module (func $type-binary-1st-operand-missing-in-block (i32.const 0) (i32.const 0) block i32.add drop end))
  "type mismatch"
)
(assert_invalid
  (module (func $type-binary-2nd-operand-missing-in-block (i32.const 0) block (i32.const 0) i32.add drop end))
  "type mismatch"
)
(assert_invalid
  (module (func $type-binary-1st-operand-missing-in-loop (i32.const 0) (i32.const 0) loop i32.add drop end))
  "type mismatch"
)
(assert_invalid
  (module (func $type-binary-2nd-operand-missing-in-loop (i32.const 0) loop (i32.const 0) i32.add drop end))
  "type mismatch"
)
(assert_invalid
  (module (func $type-binary-1st-operand-missing-in-if (i32.const 0) (i32.const 0) (i32.const 0) if i32.add drop end))
  "type mismatch"
)
(assert_invalid
  (module (func $type-binary-2nd-operand-missing-in-if (i32.const 0) (i32.const 0) if (i32.const 0) i32.add drop end))
  "type mismatch"
)
(assert_invalid
  (module (func $type-binary-1st-operand-missing-in-else (i32.const 0) (i32.const 0) (i32.const 0) if (i32.const 0) (i32.const 0) else i32.add (i32.const 0) end drop drop))
  "type mismatch"
)
(assert_invalid
  (module (func $type-binary-2nd-operand-missing-in-else (i32.const 0) (i32.const 0) if (i32.const 0) (i32.const 0) else i32.add end drop))
  "type mismatch"
)
...
(assert_invalid
  (module (func $type-if-operand-missing-in-block (i32.const 0) block if end end))
  "type mismatch"
)
(assert_invalid
  (module (func $type-if-operand-missing-in-loop (i32.const 0) loop if end end))
  "type mismatch"
)
(assert_invalid
  (module (func $type-if-operand-missing-in-if (i32.const 0) (i32.const 0) if if end end))
  "type mismatch"
)
(assert_invalid
  (module (func $type-if-operand-missing-in-else (i32.const 0) (i32.const 0) if (i32.const 0) else if end (i32.const 0) end drop))
  "type mismatch"
)

(assert_invalid
  (module (func $type-br-operand-missing block br 1 0 end i32.eqz drop))
  "type mismatch"
)
(assert_invalid
  (module (func $type-br-operand-missing-in-block (i32.const 0) block br 1 0 end i32.eqz drop))
  "type mismatch"
)
(assert_invalid
  (module (func $type-br-operand-missing-in-loop (i32.const 0) loop br 1 0 end i32.eqz drop))
  "type mismatch"
)
(assert_invalid
  (module (func $type-br-operand-missing-in-if block (i32.const 0) (i32.const 0) if br 1 0 end end i32.eqz drop))
  "type mismatch"
)
(assert_invalid
  (module (func $type-br-operand-missing-in-else block (i32.const 0) (i32.const 0) if (i32.const 0) else br 1 0 end end i32.eqz drop))
  "type mismatch"
)
