...
(module
  ...
  (func (export "type-i32-value") (result i32) (block (i32.ctz (br 0 (i32.const 1)))))
  (func (export "type-i64-value") (result i64) (block (i64.ctz (br 0 (i64.const 2)))))
  (func (export "type-f32-value") (result f32) (block (f32.neg (br 0 (f32.const 3)))))
  (func (export "type-f64-value") (result f64) (block (f64.neg (br 0 (f64.const 4)))))
