...
(module
  ...
  (func $rol (param $x i32) (param $y i32) (result i32) (i32.rol (get_local $x) (get_local $y)))
  (func $ror (param $x i32) (param $y i32) (result i32) (i32.ror (get_local $x) (get_local $y)))
  (func $bswap (param $x i32) (result i32) (i32.bswap (get_local $x)))
...
(assert_return (invoke "rol" (i32.const 0xfe00dc00) (i32.const 4)) (i32.const 0xe00dc00f))
(assert_return (invoke "rol" (i32.const 0xabcd9876) (i32.const 1)) (i32.const 0x579b30ed))
(assert_return (invoke "rol" (i32.const 0x00008000) (i32.const 37)) (i32.const 0x00100000))
(assert_return (invoke "rol" (i32.const 0x769abcdf) (i32.const 0x8000000d)) (i32.const 0x579beed3))

(assert_return (invoke "ror" (i32.const 0xb0c1d2e3) (i32.const 0x0005)) (i32.const 0x1d860e97))
(assert_return (invoke "ror" (i32.const 0xb0c1d2e3) (i32.const 0xff05)) (i32.const 0x1d860e97))
(assert_return (invoke "ror" (i32.const 0xff00cc00) (i32.const 1)) (i32.const 0x7f806600))
(assert_return (invoke "ror" (i32.const 0x00080000) (i32.const 4)) (i32.const 0x00008000))
(assert_return (invoke "ror" (i32.const 0x769abcdf) (i32.const 0xffffffed)) (i32.const 0xe6fbb4d5))

(assert_return (invoke "bswap" (i32.const 0)) (i32.const 0))
(assert_return (invoke "bswap" (i32.const -1)) (i32.const -1))
(assert_return (invoke "bswap" (i32.const 1)) (i32.const 0x01000000))
(assert_return (invoke "bswap" (i32.const 0x1a2b3c4d)) (i32.const 0x4d3c2b1a))
(assert_return (invoke "bswap" (i32.const 0xd5c6b7a8)) (i32.const 0xa8b7c6d5))
