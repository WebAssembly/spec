...
(assert_return (invoke "add" (f32.const infinity) (f32.const -infinity)) (f32.const nan))
...
(assert_return (invoke "sub" (f32.const infinity) (f32.const infinity)) (f32.const nan))
...
(assert_return (invoke "mul" (f32.const infinity) (f32.const 0)) (f32.const nan))
...
(assert_return (invoke "div" (f32.const 0) (f32.const 0)) (f32.const nan))
...
(assert_return (invoke "sqrt" (f32.const -0x1p0)) (f32.const nan))
...
(assert_return (invoke "add" (f64.const infinity) (f64.const -infinity)) (f64.const nan))
...
(assert_return (invoke "sub" (f64.const infinity) (f64.const infinity)) (f64.const nan))
...
(assert_return (invoke "mul" (f64.const infinity) (f64.const 0)) (f64.const nan))
...
(assert_return (invoke "div" (f64.const 0) (f64.const 0)) (f64.const nan))
...
(assert_return (invoke "sqrt" (f64.const -0x1p0)) (f64.const nan))
