...
(module
  (export "add" (func (param $x f64) (param $y f64) (result f64) (f64.add (get_local $x) (get_local $y))))
  (export "sub" (func (param $x f64) (param $y f64) (result f64) (f64.sub (get_local $x) (get_local $y))))
  (export "mul" (func (param $x f64) (param $y f64) (result f64) (f64.mul (get_local $x) (get_local $y))))
  (export "div" (func (param $x f64) (param $y f64) (result f64) (f64.div (get_local $x) (get_local $y))))
  (export "sqrt" (func (param $x f64) (result f64) (f64.sqrt (get_local $x))))
  (export "min" (func (param $x f64) (param $y f64) (result f64) (f64.min (get_local $x) (get_local $y))))
  (export "max" (func (param $x f64) (param $y f64) (result f64) (f64.max (get_local $x) (get_local $y))))
  (export "ceil" (func (param $x f64) (result f64) (f64.ceil (get_local $x))))
  (export "floor" (func (param $x f64) (result f64) (f64.floor (get_local $x))))
  (export "trunc" (func (param $x f64) (result f64) (f64.trunc (get_local $x))))
  (export "nearest" (func (param $x f64) (result f64) (f64.nearest (get_local $x))))
  (export "abs" (func (param $x f64) (result f64) (f64.abs (get_local $x))))
  (export "neg" (func (param $x f64) (result f64) (f64.neg (get_local $x))))
  (export "copysign" (func (param $x f64) (param $y f64) (result f64) (f64.copysign (get_local $x) (get_local $y))))
)
...
(module
  (export "f64.promote_f32" (func (param $x f32) (result f64) (f64.promote/f32 (get_local $x))))
  (export "f32.demote_f64" (func (param $x f64) (result f32) (f32.demote/f64 (get_local $x))))
  (export "f32.reinterpret_i32" (func (param $x i32) (result f32) (f32.reinterpret/i32 (get_local $x))))
  (export "f64.reinterpret_i64" (func (param $x i64) (result f64) (f64.reinterpret/i64 (get_local $x))))
)
