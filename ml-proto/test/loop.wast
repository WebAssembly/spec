...
(module
  ...
  (export "cont-inner" (func (result i32)
    (local i32)
    (set_local 0 (i32.const 0))
  ...
  (export "effects" (func $fx (result i32)
    (local i32)
    (loop
  ...
  (export "while" (func (param i64) (result i64)
    (local i64)
  ...
  (export "for" (func (param i64) (result i64)
    (local i64 i64)
    (set_local 1 (i64.const 1))
  ...
  (export "nesting" (func (param f32 f32) (result f32)
    (local f32 f32)
    (loop
