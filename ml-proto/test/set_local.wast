...
(module
  ...
  (export "type-local-i32" (func (local i32) (set_local 0 (i32.const 0))))
  (export "type-local-i64" (func (local i64) (set_local 0 (i64.const 0))))
  (export "type-local-f32" (func (local f32) (set_local 0 (f32.const 0))))
  (export "type-local-f64" (func (local f64) (set_local 0 (f64.const 0))))

  (export "type-param-i32" (func (param i32) (set_local 0 (i32.const 10))))
  (export "type-param-i64" (func (param i64) (set_local 0 (i64.const 11))))
  (export "type-param-f32" (func (param f32) (set_local 0 (f32.const 11.1))))
  (export "type-param-f64" (func (param f64) (set_local 0 (f64.const 12.2))))
  ...
  (export "write" (func (param i64 f32 f64 i32 i32) (result i64)
