...
(assert_same (invoke "test32") (i32.const 195940365))
(assert_same (invoke "max32") (i32.const -1))
(assert_same (invoke "neg32") (i32.const -2147483647))
(assert_same (invoke "test64") (i64.const 913028331277281902))
(assert_same (invoke "max64") (i64.const -1))
(assert_same (invoke "neg64") (i64.const -9223372036854775807))
