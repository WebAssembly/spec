...
(assert_same (invoke "data") (i32.const 1))
(assert_same (invoke "aligned") (i32.const 1))
(assert_same (invoke "unaligned") (i32.const 1))
(assert_same (invoke "cast") (f64.const 42.0))

(assert_same (invoke "i32_load8_s" (i32.const -1)) (i32.const -1))
(assert_same (invoke "i32_load8_u" (i32.const -1)) (i32.const 255))
(assert_same (invoke "i32_load16_s" (i32.const -1)) (i32.const -1))
(assert_same (invoke "i32_load16_u" (i32.const -1)) (i32.const 65535))

(assert_same (invoke "i32_load8_s" (i32.const 100)) (i32.const 100))
(assert_same (invoke "i32_load8_u" (i32.const 200)) (i32.const 200))
(assert_same (invoke "i32_load16_s" (i32.const 20000)) (i32.const 20000))
(assert_same (invoke "i32_load16_u" (i32.const 40000)) (i32.const 40000))

(assert_same (invoke "i64_load8_s" (i64.const -1)) (i64.const -1))
(assert_same (invoke "i64_load8_u" (i64.const -1)) (i64.const 255))
(assert_same (invoke "i64_load16_s" (i64.const -1)) (i64.const -1))
(assert_same (invoke "i64_load16_u" (i64.const -1)) (i64.const 65535))
(assert_same (invoke "i64_load32_s" (i64.const -1)) (i64.const -1))
(assert_same (invoke "i64_load32_u" (i64.const -1)) (i64.const 4294967295))

(assert_same (invoke "i64_load8_s" (i64.const 100)) (i64.const 100))
(assert_same (invoke "i64_load8_u" (i64.const 200)) (i64.const 200))
(assert_same (invoke "i64_load16_s" (i64.const 20000)) (i64.const 20000))
(assert_same (invoke "i64_load16_u" (i64.const 40000)) (i64.const 40000))
(assert_same (invoke "i64_load32_s" (i64.const 20000)) (i64.const 20000))
(assert_same (invoke "i64_load32_u" (i64.const 40000)) (i64.const 40000))
