...
(module
  (export "f64.no_contraction" (func (param $x f64) (param $y f64) (param $z f64) (result f64)
...
(module
  (export "f32.no_fma" (func (param $x f32) (param $y f32) (param $z f32) (result f32)
    (f32.add (f32.mul (get_local $x) (get_local $y)) (get_local $z))))
  (export "f64.no_fma" (func (param $x f64) (param $y f64) (param $z f64) (result f64)
    (f64.add (f64.mul (get_local $x) (get_local $y)) (get_local $z))))
)
...
(module
  (export "f32.no_fold_add_zero" (func (param $x f32) (result f32)
    (f32.add (get_local $x) (f32.const 0.0))))
  (export "f64.no_fold_add_zero" (func (param $x f64) (result f64)
...
(module
  (export "f32.no_fold_zero_sub" (func (param $x f32) (result f32)
    (f32.sub (f32.const 0.0) (get_local $x))))
  (export "f64.no_fold_zero_sub" (func (param $x f64) (result f64)
...
(module
  (export "f32.no_fold_sub_zero" (func (param $x f32) (result f32)
    (f32.sub (get_local $x) (f32.const 0.0))))
  (export "f64.no_fold_sub_zero" (func (param $x f64) (result f64)
...
(module
  (export "f32.no_fold_mul_zero" (func (param $x f32) (result f32)
    (f32.mul (get_local $x) (f32.const 0.0))))
  (export "f64.no_fold_mul_zero" (func (param $x f64) (result f64)
...
(module
  (export "f32.no_fold_mul_one" (func (param $x f32) (result f32)
    (f32.mul (get_local $x) (f32.const 1.0))))
  (export "f64.no_fold_mul_one" (func (param $x f64) (result f64)
...
(module
  (export "f32.no_fold_zero_div" (func (param $x f32) (result f32)
    (f32.div (f32.const 0.0) (get_local $x))))
  (export "f64.no_fold_zero_div" (func (param $x f64) (result f64)
...
(module
  (export "f32.no_fold_div_one" (func (param $x f32) (result f32)
    (f32.div (get_local $x) (f32.const 1.0))))
  (export "f64.no_fold_div_one" (func (param $x f64) (result f64)
...
(module
  (export "f32.no_fold_div_neg1" (func (param $x f32) (result f32)
    (f32.div (get_local $x) (f32.const -1.0))))
  (export "f64.no_fold_div_neg1" (func (param $x f64) (result f64)
    (f64.div (get_local $x) (f64.const -1.0))))
)
...
(module
  (export "f32.no_fold_neg0_sub" (func (param $x f32) (result f32)
    (f32.sub (f32.const -0.0) (get_local $x))))
  (export "f64.no_fold_neg0_sub" (func (param $x f64) (result f64)
    (f64.sub (f64.const -0.0) (get_local $x))))
)
...
(module
  (export "f32.no_fold_neg1_mul" (func (param $x f32) (result f32)
    (f32.mul (f32.const -1.0) (get_local $x))))
  (export "f64.no_fold_neg1_mul" (func (param $x f64) (result f64)
...
(module
  (export "f32.no_fold_eq_self" (func (param $x f32) (result i32)
    (f32.eq (get_local $x) (get_local $x))))
  (export "f64.no_fold_eq_self" (func (param $x f64) (result i32)
...
(module
  (export "f32.no_fold_ne_self" (func (param $x f32) (result i32)
    (f32.ne (get_local $x) (get_local $x))))
  (export "f64.no_fold_ne_self" (func (param $x f64) (result i32)
...
(module
  (export "f32.no_fold_sub_self" (func (param $x f32) (result f32)
    (f32.sub (get_local $x) (get_local $x))))
  (export "f64.no_fold_sub_self" (func (param $x f64) (result f64)
...
(module
  (export "f32.no_fold_div_3" (func (param $x f32) (result f32)
    (f32.div (get_local $x) (f32.const 3.0))))
  (export "f64.no_fold_div_3" (func (param $x f64) (result f64)
...
(module
  (export "f32.no_factor" (func (param $x f32) (param $y f32) (param $z f32) (result f32)
    (f32.add (f32.mul (get_local $x) (get_local $z)) (f32.mul (get_local $y) (get_local $z)))))
  (export "f64.no_factor" (func (param $x f64) (param $y f64) (param $z f64) (result f64)
...
(module
  (export "f32.no_distribute" (func (param $x f32) (param $y f32) (param $z f32) (result f32)
    (f32.mul (f32.add (get_local $x) (get_local $y)) (get_local $z))))
  (export "f64.no_distribute" (func (param $x f64) (param $y f64) (param $z f64) (result f64)
...
(module
  (export "f32.no_regroup_div_mul" (func (param $x f32) (param $y f32) (param $z f32) (result f32)
    (f32.mul (get_local $x) (f32.div (get_local $y) (get_local $z)))))
  (export "f64.no_regroup_div_mul" (func (param $x f64) (param $y f64) (param $z f64) (result f64)
...
(module
  (export "f32.no_regroup_mul_div" (func (param $x f32) (param $y f32) (param $z f32) (result f32)
    (f32.div (f32.mul (get_local $x) (get_local $y)) (get_local $z))))
  (export "f64.no_regroup_mul_div" (func (param $x f64) (param $y f64) (param $z f64) (result f64)
...
(module
  (export "f32.no_reassociate_add" (func (param $x f32) (param $y f32) (param $z f32) (param $w f32) (result f32)
    (f32.add (f32.add (f32.add (get_local $x) (get_local $y)) (get_local $z)) (get_local $w))))
  (export "f64.no_reassociate_add" (func (param $x f64) (param $y f64) (param $z f64) (param $w f64) (result f64)
...
(module
  (export "f32.no_reassociate_mul" (func (param $x f32) (param $y f32) (param $z f32) (param $w f32) (result f32)
    (f32.mul (f32.mul (f32.mul (get_local $x) (get_local $y)) (get_local $z)) (get_local $w))))
  (export "f64.no_reassociate_mul" (func (param $x f64) (param $y f64) (param $z f64) (param $w f64) (result f64)
...
(module
  (export "f32.no_fold_div_0" (func (param $x f32) (result f32)
    (f32.div (get_local $x) (f32.const 0.0))))
  (export "f64.no_fold_div_0" (func (param $x f64) (result f64)
...
(module
  (export "f32.no_fold_div_neg0" (func (param $x f32) (result f32)
    (f32.div (get_local $x) (f32.const -0.0))))
  (export "f64.no_fold_div_neg0" (func (param $x f64) (result f64)
    (f64.div (get_local $x) (f64.const -0.0))))
)
...
(module
  (export "f32.no_fold_to_hypot" (func (param $x f32) (param $y f32) (result f32)
    (f32.sqrt (f32.add (f32.mul (get_local $x) (get_local $x))
                       (f32.mul (get_local $y) (get_local $y))))))
  (export "f64.no_fold_to_hypot" (func (param $x f64) (param $y f64) (result f64)
...
(module
  (export "f32.no_approximate_reciprocal" (func (param $x f32) (result f32)
...
(module
  (export "f32.no_approximate_reciprocal_sqrt" (func (param $x f32) (result f32)
    (f32.div (f32.const 1.0) (f32.sqrt (get_local $x)))))
  (export "f64.no_fuse_reciprocal_sqrt" (func (param $x f64) (result f64)
...
(module
  (export "f32.no_approximate_sqrt_reciprocal" (func (param $x f32) (result f32)
...
(module
  (export "i32.no_fold_f32_s" (func (param i32) (result i32)
    (i32.trunc_s/f32 (f32.convert_s/i32 (get_local 0)))))
  (export "i32.no_fold_f32_u" (func (param i32) (result i32)
    (i32.trunc_u/f32 (f32.convert_u/i32 (get_local 0)))))
  (export "i64.no_fold_f64_s" (func (param i64) (result i64)
    (i64.trunc_s/f64 (f64.convert_s/i64 (get_local 0)))))
  (export "i64.no_fold_f64_u" (func (param i64) (result i64)
...
(module
  (export "f32.no_fold_add_sub" (func (param $x f32) (param $y f32) (result f32)
    (f32.sub (f32.add (get_local $x) (get_local $y)) (get_local $y))))
  (export "f64.no_fold_add_sub" (func (param $x f64) (param $y f64) (result f64)
...
(module
  (export "f32.no_fold_sub_add" (func (param $x f32) (param $y f32) (result f32)
    (f32.add (f32.sub (get_local $x) (get_local $y)) (get_local $y))))
  (export "f64.no_fold_sub_add" (func (param $x f64) (param $y f64) (result f64)
...
(module
  (export "f32.no_fold_mul_div" (func (param $x f32) (param $y f32) (result f32)
    (f32.div (f32.mul (get_local $x) (get_local $y)) (get_local $y))))
  (export "f64.no_fold_mul_div" (func (param $x f64) (param $y f64) (result f64)
...
(module
  (export "f32.no_fold_div_mul" (func (param $x f32) (param $y f32) (result f32)
    (f32.mul (f32.div (get_local $x) (get_local $y)) (get_local $y))))
  (export "f64.no_fold_div_mul" (func (param $x f64) (param $y f64) (result f64)
...
(module
  (export "no_fold_demote_promote" (func (param $x f64) (result f64)
...
(module
  (export "no_fold_promote_demote" (func (param $x f32) (result f32)
...
(module
  (export "no_demote_mixed_add" (func (param $x f64) (param $y f32) (result f32)
    (f32.demote/f64 (f64.add (get_local $x) (f64.promote/f32 (get_local $y))))))
  (export "no_demote_mixed_add_commuted" (func (param $y f32) (param $x f64) (result f32)
...
(module
  (export "no_demote_mixed_sub" (func (param $x f64) (param $y f32) (result f32)
...
(module
  (export "f32.i32.no_fold_trunc_s_convert_s" (func (param $x f32) (result f32)
    (f32.convert_s/i32 (i32.trunc_s/f32 (get_local $x)))))
  (export "f32.i32.no_fold_trunc_u_convert_s" (func (param $x f32) (result f32)
    (f32.convert_s/i32 (i32.trunc_u/f32 (get_local $x)))))
  (export "f32.i32.no_fold_trunc_s_convert_u" (func (param $x f32) (result f32)
    (f32.convert_u/i32 (i32.trunc_s/f32 (get_local $x)))))
  (export "f32.i32.no_fold_trunc_u_convert_u" (func (param $x f32) (result f32)
    (f32.convert_u/i32 (i32.trunc_u/f32 (get_local $x)))))
  (export "f64.i32.no_fold_trunc_s_convert_s" (func (param $x f64) (result f64)
    (f64.convert_s/i32 (i32.trunc_s/f64 (get_local $x)))))
  (export "f64.i32.no_fold_trunc_u_convert_s" (func (param $x f64) (result f64)
    (f64.convert_s/i32 (i32.trunc_u/f64 (get_local $x)))))
  (export "f64.i32.no_fold_trunc_s_convert_u" (func (param $x f64) (result f64)
    (f64.convert_u/i32 (i32.trunc_s/f64 (get_local $x)))))
  (export "f64.i32.no_fold_trunc_u_convert_u" (func (param $x f64) (result f64)
    (f64.convert_u/i32 (i32.trunc_u/f64 (get_local $x)))))
  (export "f32.i64.no_fold_trunc_s_convert_s" (func (param $x f32) (result f32)
    (f32.convert_s/i64 (i64.trunc_s/f32 (get_local $x)))))
  (export "f32.i64.no_fold_trunc_u_convert_s" (func (param $x f32) (result f32)
    (f32.convert_s/i64 (i64.trunc_u/f32 (get_local $x)))))
  (export "f32.i64.no_fold_trunc_s_convert_u" (func (param $x f32) (result f32)
    (f32.convert_u/i64 (i64.trunc_s/f32 (get_local $x)))))
  (export "f32.i64.no_fold_trunc_u_convert_u" (func (param $x f32) (result f32)
    (f32.convert_u/i64 (i64.trunc_u/f32 (get_local $x)))))
  (export "f64.i64.no_fold_trunc_s_convert_s" (func (param $x f64) (result f64)
    (f64.convert_s/i64 (i64.trunc_s/f64 (get_local $x)))))
  (export "f64.i64.no_fold_trunc_u_convert_s" (func (param $x f64) (result f64)
    (f64.convert_s/i64 (i64.trunc_u/f64 (get_local $x)))))
  (export "f64.i64.no_fold_trunc_s_convert_u" (func (param $x f64) (result f64)
    (f64.convert_u/i64 (i64.trunc_s/f64 (get_local $x)))))
  (export "f64.i64.no_fold_trunc_u_convert_u" (func (param $x f64) (result f64)
...
(module
  (memory 1 1)
  (export "init" (func (param $i i32) (param $x f32) (f32.store (get_local $i) (get_local $x))))

  (export "run" (func (param $n i32) (param $z f32)
    (local $i i32)
    (loop $exit $cont
  ...
  (export "check" (func (param $i i32) (result f32) (f32.load (get_local $i))))
)
...
(module
  (memory 1 1)
  (export "init" (func (param $i i32) (param $x f64) (f64.store (get_local $i) (get_local $x))))

  (export "run" (func (param $n i32) (param $z f64)
    (local $i i32)
    (loop $exit $cont
  ...
  (export "check" (func (param $i i32) (result f64) (f64.load (get_local $i))))
)
...
(module
  (export "f32.ult" (func (param $x f32) (param $y f32) (result i32) (i32.eqz (f32.ge (get_local $x) (get_local $y)))))
  (export "f32.ule" (func (param $x f32) (param $y f32) (result i32) (i32.eqz (f32.gt (get_local $x) (get_local $y)))))
  (export "f32.ugt" (func (param $x f32) (param $y f32) (result i32) (i32.eqz (f32.le (get_local $x) (get_local $y)))))
  (export "f32.uge" (func (param $x f32) (param $y f32) (result i32) (i32.eqz (f32.lt (get_local $x) (get_local $y)))))

  (export "f64.ult" (func (param $x f64) (param $y f64) (result i32) (i32.eqz (f64.ge (get_local $x) (get_local $y)))))
  (export "f64.ule" (func (param $x f64) (param $y f64) (result i32) (i32.eqz (f64.gt (get_local $x) (get_local $y)))))
  (export "f64.ugt" (func (param $x f64) (param $y f64) (result i32) (i32.eqz (f64.le (get_local $x) (get_local $y)))))
  (export "f64.uge" (func (param $x f64) (param $y f64) (result i32) (i32.eqz (f64.lt (get_local $x) (get_local $y)))))
)
...
(module
  (export "f32.no_fold_lt_select" (func (param $x f32) (param $y f32) (result f32) (select (get_local $x) (get_local $y) (f32.lt (get_local $x) (get_local $y)))))
  (export "f32.no_fold_le_select" (func (param $x f32) (param $y f32) (result f32) (select (get_local $x) (get_local $y) (f32.le (get_local $x) (get_local $y)))))
  (export "f32.no_fold_gt_select" (func (param $x f32) (param $y f32) (result f32) (select (get_local $x) (get_local $y) (f32.gt (get_local $x) (get_local $y)))))
  (export "f32.no_fold_ge_select" (func (param $x f32) (param $y f32) (result f32) (select (get_local $x) (get_local $y) (f32.ge (get_local $x) (get_local $y)))))

  (export "f64.no_fold_lt_select" (func (param $x f64) (param $y f64) (result f64) (select (get_local $x) (get_local $y) (f64.lt (get_local $x) (get_local $y)))))
  (export "f64.no_fold_le_select" (func (param $x f64) (param $y f64) (result f64) (select (get_local $x) (get_local $y) (f64.le (get_local $x) (get_local $y)))))
  (export "f64.no_fold_gt_select" (func (param $x f64) (param $y f64) (result f64) (select (get_local $x) (get_local $y) (f64.gt (get_local $x) (get_local $y)))))
  (export "f64.no_fold_ge_select" (func (param $x f64) (param $y f64) (result f64) (select (get_local $x) (get_local $y) (f64.ge (get_local $x) (get_local $y)))))
)
...
(module
  (export "f32.no_fold_lt_if" (func (param $x f32) (param $y f32) (result f32) (if (f32.lt (get_local $x) (get_local $y)) (get_local $x) (get_local $y))))
  (export "f32.no_fold_le_if" (func (param $x f32) (param $y f32) (result f32) (if (f32.le (get_local $x) (get_local $y)) (get_local $x) (get_local $y))))
  (export "f32.no_fold_gt_if" (func (param $x f32) (param $y f32) (result f32) (if (f32.gt (get_local $x) (get_local $y)) (get_local $x) (get_local $y))))
  (export "f32.no_fold_ge_if" (func (param $x f32) (param $y f32) (result f32) (if (f32.ge (get_local $x) (get_local $y)) (get_local $x) (get_local $y))))

  (export "f64.no_fold_lt_if" (func (param $x f64) (param $y f64) (result f64) (if (f64.lt (get_local $x) (get_local $y)) (get_local $x) (get_local $y))))
  (export "f64.no_fold_le_if" (func (param $x f64) (param $y f64) (result f64) (if (f64.le (get_local $x) (get_local $y)) (get_local $x) (get_local $y))))
  (export "f64.no_fold_gt_if" (func (param $x f64) (param $y f64) (result f64) (if (f64.gt (get_local $x) (get_local $y)) (get_local $x) (get_local $y))))
  (export "f64.no_fold_ge_if" (func (param $x f64) (param $y f64) (result f64) (if (f64.ge (get_local $x) (get_local $y)) (get_local $x) (get_local $y))))
)
...
(module
  (export "f32.no_fold_lt_select_to_abs" (func (param $x f32) (result f32) (select (f32.neg (get_local $x)) (get_local $x) (f32.lt (get_local $x) (f32.const 0.0)))))
  (export "f32.no_fold_le_select_to_abs" (func (param $x f32) (result f32) (select (f32.neg (get_local $x)) (get_local $x) (f32.le (get_local $x) (f32.const -0.0)))))
  (export "f32.no_fold_gt_select_to_abs" (func (param $x f32) (result f32) (select (get_local $x) (f32.neg (get_local $x)) (f32.gt (get_local $x) (f32.const -0.0)))))
  (export "f32.no_fold_ge_select_to_abs" (func (param $x f32) (result f32) (select (get_local $x) (f32.neg (get_local $x)) (f32.ge (get_local $x) (f32.const 0.0)))))

  (export "f64.no_fold_lt_select_to_abs" (func (param $x f64) (result f64) (select (f64.neg (get_local $x)) (get_local $x) (f64.lt (get_local $x) (f64.const 0.0)))))
  (export "f64.no_fold_le_select_to_abs" (func (param $x f64) (result f64) (select (f64.neg (get_local $x)) (get_local $x) (f64.le (get_local $x) (f64.const -0.0)))))
  (export "f64.no_fold_gt_select_to_abs" (func (param $x f64) (result f64) (select (get_local $x) (f64.neg (get_local $x)) (f64.gt (get_local $x) (f64.const -0.0)))))
  (export "f64.no_fold_ge_select_to_abs" (func (param $x f64) (result f64) (select (get_local $x) (f64.neg (get_local $x)) (f64.ge (get_local $x) (f64.const 0.0)))))
)
...
(module
  (export "f32.no_fold_lt_if_to_abs" (func (param $x f32) (result f32) (if (f32.lt (get_local $x) (f32.const 0.0)) (f32.neg (get_local $x)) (get_local $x))))
  (export "f32.no_fold_le_if_to_abs" (func (param $x f32) (result f32) (if (f32.le (get_local $x) (f32.const -0.0)) (f32.neg (get_local $x)) (get_local $x))))
  (export "f32.no_fold_gt_if_to_abs" (func (param $x f32) (result f32) (if (f32.gt (get_local $x) (f32.const -0.0)) (get_local $x) (f32.neg (get_local $x)))))
  (export "f32.no_fold_ge_if_to_abs" (func (param $x f32) (result f32) (if (f32.ge (get_local $x) (f32.const 0.0)) (get_local $x) (f32.neg (get_local $x)))))

  (export "f64.no_fold_lt_if_to_abs" (func (param $x f64) (result f64) (if (f64.lt (get_local $x) (f64.const 0.0)) (f64.neg (get_local $x)) (get_local $x))))
  (export "f64.no_fold_le_if_to_abs" (func (param $x f64) (result f64) (if (f64.le (get_local $x) (f64.const -0.0)) (f64.neg (get_local $x)) (get_local $x))))
  (export "f64.no_fold_gt_if_to_abs" (func (param $x f64) (result f64) (if (f64.gt (get_local $x) (f64.const -0.0)) (get_local $x) (f64.neg (get_local $x)))))
  (export "f64.no_fold_ge_if_to_abs" (func (param $x f64) (result f64) (if (f64.ge (get_local $x) (f64.const 0.0)) (get_local $x) (f64.neg (get_local $x)))))
)
...
(module
  (export "incorrect_correction" (func (result f32)
...
(module
  (export "incorrect_correction" (func (result f64)
...
(module
  (export "calculate" (func (result f32)
    (local $x f32)
    (local $r f32)
    (local $q f32)
    (local $z0 f32)
...
(module
  (export "calculate" (func (result f64)
    (local $x f64)
    (local $r f64)
    (local $q f64)
    (local $z0 f64)
...
(module
  (export "llvm_pr26746" (func (param $x f32) (result f32)
...
(module
  (export "llvm_pr27153" (func (param $x i32) (result f32)
...
(module
  (export "llvm_pr27036" (func (param $x i32) (param $y i32) (result f32)
...
;; covered elsewhere.
(module
  (export "thepast0" (func (param $a f64) (param $b f64) (param $c f64) (param $d f64) (result f64)
    (f64.div (f64.mul (get_local $a) (get_local $b)) (f64.mul (get_local $c) (get_local $d)))
  ))

  (export "thepast1" (func (param $a f64) (param $b f64) (param $c f64) (result f64)
    (f64.sub (f64.mul (get_local $a) (get_local $b)) (get_local $c))
  ))

  (export "thepast2" (func (param $a f32) (param $b f32) (param $c f32) (result f32)
...
(module
  (export "inverse" (func (param $x f32) (result f32)
    (f32.div (f32.const 1.0) (get_local $x))
  ))
)
...
(module
  (export "f32_sqrt_minus_2" (func (param $x f32) (result f32)
    (f32.sub (f32.sqrt (get_local $x)) (f32.const 2.0))
  ))

  (export "f64_sqrt_minus_2" (func (param $x f64) (result f64)
...
(module
  (export "f32.no_fold_recip_recip" (func (param $x f32) (result f32)
    (f32.div (f32.const 1.0) (f32.div (f32.const 1.0) (get_local $x)))))

  (export "f64.no_fold_recip_recip" (func (param $x f64) (result f64)
...
(module
  (export "f32.no_algebraic_factoring" (func (param $x f32) (param $y f32) (result f32)
    (f32.mul (f32.add (get_local $x) (get_local $y))
             (f32.sub (get_local $x) (get_local $y)))))

  (export "f64.no_algebraic_factoring" (func (param $x f64) (param $y f64) (result f64)
...
(module
  ...
  (export "f32.kahan_sum" (func (param $p i32) (param $n i32) (result f32)
    (local $sum f32)
    (local $c f32)
    (local $t f32)
    (loop $exit $top
  ...
  (export "f32.plain_sum" (func (param $p i32) (param $n i32) (result f32)
    (local $sum f32)
    (loop $exit $top
...
(module
  ...
  (export "f64.kahan_sum" (func (param $p i32) (param $n i32) (result f64)
    (local $sum f64)
    (local $c f64)
    (local $t f64)
    (loop $exit $top
  ...
  (export "f64.plain_sum" (func (param $p i32) (param $n i32) (result f64)
    (local $sum f64)
    (loop $exit $top
...
(module
  (export "f32.no_fold_neg_sub" (func (param $x f32) (param $y f32) (result f32)
    (f32.neg (f32.sub (get_local $x) (get_local $y)))))

  (export "f64.no_fold_neg_sub" (func (param $x f64) (param $y f64) (result f64)
...
(module
  (export "f32.no_fold_add_neg" (func (param $x f32) (result f32)
    (f32.add (f32.neg (get_local $x)) (get_local $x))))

  (export "f64.no_fold_add_neg" (func (param $x f64) (result f64)
...
(module
  (export "f32.no_fold_6x_via_add" (func (param $x f32) (result f32)
    (f32.add (f32.add (f32.add (f32.add (f32.add
    (get_local $x)
    (get_local $x)) (get_local $x)) (get_local $x))
    (get_local $x)) (get_local $x))))

  (export "f64.no_fold_6x_via_add" (func (param $x f64) (result f64)
...
(module
  (export "f32.no_fold_div_div" (func (param $x f32) (param $y f32) (param $z f32) (result f32)
    (f32.div (f32.div (get_local $x) (get_local $y)) (get_local $z))))

  (export "f64.no_fold_div_div" (func (param $x f64) (param $y f64) (param $z f64) (result f64)
...
(module
  (export "f32.no_fold_mul_divs" (func (param $x f32) (param $y f32) (param $z f32) (param $w f32) (result f32)
    (f32.mul (f32.div (get_local $x) (get_local $y)) (f32.div (get_local $z) (get_local $w)))))

  (export "f64.no_fold_mul_divs" (func (param $x f64) (param $y f64) (param $z f64) (param $w f64) (result f64)
...
(module
  (export "f32.no_fold_add_divs" (func (param $x f32) (param $y f32) (param $z f32) (result f32)
    (f32.add (f32.div (get_local $x) (get_local $z)) (f32.div (get_local $y) (get_local $z)))))

  (export "f64.no_fold_add_divs" (func (param $x f64) (param $y f64) (param $z f64) (result f64)
...
(module
  (export "f32.no_fold_sqrt_square" (func (param $x f32) (result f32)
    (f32.sqrt (f32.mul (get_local $x) (get_local $x)))))

  (export "f64.no_fold_sqrt_square" (func (param $x f64) (result f64)
...
(module
  (export "f32.no_fold_mul_sqrts" (func (param $x f32) (param $y f32) (result f32)
    (f32.mul (f32.sqrt (get_local $x)) (f32.sqrt (get_local $y)))))

  (export "f64.no_fold_mul_sqrts" (func (param $x f64) (param $y f64) (result f64)
...
(module
  (export "f32.no_fold_div_sqrts" (func (param $x f32) (param $y f32) (result f32)
    (f32.div (f32.sqrt (get_local $x)) (f32.sqrt (get_local $y)))))

  (export "f64.no_fold_div_sqrts" (func (param $x f64) (param $y f64) (result f64)
...
(module
  (export "f32.no_fold_mul_sqrt_div" (func (param $x f32) (param $y f32) (result f32)
    (f32.div (f32.mul (get_local $x) (f32.sqrt (get_local $y))) (get_local $y))))

  (export "f64.no_fold_mul_sqrt_div" (func (param $x f64) (param $y f64) (result f64)
...
(module
  (export "f32.no_flush_intermediate_subnormal" (func (param $x f32) (param $y f32) (param $z f32) (result f32)
    (f32.mul (f32.mul (get_local $x) (get_local $y)) (get_local $z))))

  (export "f64.no_flush_intermediate_subnormal" (func (param $x f64) (param $y f64) (param $z f64) (result f64)
...
(module
  (export "f32.recoding_eq" (func (param $x f32) (param $y f32) (result i32)
    (f32.eq (f32.mul (get_local $x) (get_local $y)) (get_local $x))))

  (export "f32.recoding_le" (func (param $x f32) (param $y f32) (result i32)
    (f32.le (f32.mul (get_local $x) (get_local $y)) (get_local $x))))

  (export "f32.recoding_lt" (func (param $x f32) (param $y f32) (result i32)
    (f32.lt (f32.mul (get_local $x) (get_local $y)) (get_local $x))))

  (export "f64.recoding_eq" (func (param $x f64) (param $y f64) (result i32)
    (f64.eq (f64.mul (get_local $x) (get_local $y)) (get_local $x))))

  (export "f64.recoding_le" (func (param $x f64) (param $y f64) (result i32)
    (f64.le (f64.mul (get_local $x) (get_local $y)) (get_local $x))))

  (export "f64.recoding_lt" (func (param $x f64) (param $y f64) (result i32)
    (f64.lt (f64.mul (get_local $x) (get_local $y)) (get_local $x))))

  (export "recoding_demote" (func (param $x f64) (param $y f32) (result f32)
...
(module
  (export "f32.no_extended_precision_div" (func (param $x f32) (param $y f32) (param $z f32) (result i32)
    (f32.eq (f32.div (get_local $x) (get_local $y)) (get_local $z))))

  (export "f64.no_extended_precision_div" (func (param $x f64) (param $y f64) (param $z f64) (result i32)
...
(module
  (export "f32.no_distribute_exact" (func (param $x f32) (result f32)
    (f32.add (f32.mul (f32.const -8.0) (get_local $x)) (f32.mul (f32.const 8.0) (get_local $x)))))

  (export "f64.no_distribute_exact" (func (param $x f64) (result f64)
...
;; https://xkcd.com/1047/
(module
  (export "f32.sqrt" (func (param f32) (result f32)
    (f32.sqrt (get_local 0))))

  (export "f32.xkcd_sqrt_2" (func (param f32) (param f32) (param f32) (param f32) (result f32)
    (f32.add (f32.div (get_local 0) (get_local 1)) (f32.div (get_local 2) (f32.sub (get_local 3) (get_local 2))))))

  (export "f32.xkcd_sqrt_3" (func (param f32) (param f32) (param f32) (result f32)
    (f32.div (f32.mul (get_local 0) (get_local 1)) (get_local 2))))

  (export "f32.xkcd_sqrt_5" (func (param f32) (param f32) (param f32) (result f32)
    (f32.add (f32.div (get_local 0) (get_local 1)) (f32.div (get_local 2) (get_local 0)))))

  (export "f32.xkcd_better_sqrt_5" (func (param f32) (param f32) (param f32) (param f32) (result f32)
    (f32.div (f32.add (get_local 0) (f32.mul (get_local 1) (get_local 2))) (f32.sub (get_local 3) (f32.mul (get_local 1) (get_local 2))))))

  (export "f64.sqrt" (func (param f64) (result f64)
    (f64.sqrt (get_local 0))))

  (export "f64.xkcd_sqrt_2" (func (param f64) (param f64) (param f64) (param f64) (result f64)
    (f64.add (f64.div (get_local 0) (get_local 1)) (f64.div (get_local 2) (f64.sub (get_local 3) (get_local 2))))))

  (export "f64.xkcd_sqrt_3" (func (param f64) (param f64) (param f64) (result f64)
    (f64.div (f64.mul (get_local 0) (get_local 1)) (get_local 2))))

  (export "f64.xkcd_sqrt_5" (func (param f64) (param f64) (param f64) (result f64)
    (f64.add (f64.div (get_local 0) (get_local 1)) (f64.div (get_local 2) (get_local 0)))))

  (export "f64.xkcd_better_sqrt_5" (func (param f64) (param f64) (param f64) (param f64) (result f64)
...
(module
  (export "f32.compute_radix" (func (param $0 f32) (param $1 f32) (result f32)
    (loop $label$0
      (br_if $label$0
        (f32.eq
          (f32.add
  ...
  (export "f64.compute_radix" (func (param $0 f64) (param $1 f64) (result f64)
    (loop $label$0
      (br_if $label$0
        (f64.eq
          (f64.add
...
(module
  (export "f32.no_fold_sub1_mul_add" (func (param $x f32) (param $y f32) (result f32)
    (f32.add (f32.mul (f32.sub (get_local $x) (f32.const 1.0)) (get_local $y)) (get_local $y))))

  (export "f64.no_fold_sub1_mul_add" (func (param $x f64) (param $y f64) (result f64)
...
(module
  (export "f32.no_fold_add_le_monotonicity" (func (param $x f32) (param $y f32) (param $z f32) (result i32)
    (f32.le (f32.add (get_local $x) (get_local $z)) (f32.add (get_local $y) (get_local $z)))))

  (export "f32.no_fold_add_ge_monotonicity" (func (param $x f32) (param $y f32) (param $z f32) (result i32)
    (f32.ge (f32.add (get_local $x) (get_local $z)) (f32.add (get_local $y) (get_local $z)))))

  (export "f64.no_fold_add_le_monotonicity" (func (param $x f64) (param $y f64) (param $z f64) (result i32)
    (f64.le (f64.add (get_local $x) (get_local $z)) (f64.add (get_local $y) (get_local $z)))))

  (export "f64.no_fold_add_ge_monotonicity" (func (param $x f64) (param $y f64) (param $z f64) (result i32)
...
(module
  (export "f32.not_lt" (func (param $x f32) (param $y f32) (result i32)
    (i32.eqz (f32.lt (get_local $x) (get_local $y)))))

  (export "f32.not_le" (func (param $x f32) (param $y f32) (result i32)
    (i32.eqz (f32.le (get_local $x) (get_local $y)))))

  (export "f32.not_gt" (func (param $x f32) (param $y f32) (result i32)
    (i32.eqz (f32.gt (get_local $x) (get_local $y)))))

  (export "f32.not_ge" (func (param $x f32) (param $y f32) (result i32)
    (i32.eqz (f32.ge (get_local $x) (get_local $y)))))

  (export "f64.not_lt" (func (param $x f64) (param $y f64) (result i32)
    (i32.eqz (f64.lt (get_local $x) (get_local $y)))))

  (export "f64.not_le" (func (param $x f64) (param $y f64) (result i32)
    (i32.eqz (f64.le (get_local $x) (get_local $y)))))

  (export "f64.not_gt" (func (param $x f64) (param $y f64) (result i32)
    (i32.eqz (f64.gt (get_local $x) (get_local $y)))))

  (export "f64.not_ge" (func (param $x f64) (param $y f64) (result i32)
...
(module
  (export "f32.no_trichotomy_lt" (func (param $x f32) (param $y f32) (result i32)
    (i32.or (f32.lt (get_local $x) (get_local $y)) (f32.ge (get_local $x) (get_local $y)))))
  (export "f32.no_trichotomy_le" (func (param $x f32) (param $y f32) (result i32)
    (i32.or (f32.le (get_local $x) (get_local $y)) (f32.gt (get_local $x) (get_local $y)))))
  (export "f32.no_trichotomy_gt" (func (param $x f32) (param $y f32) (result i32)
    (i32.or (f32.gt (get_local $x) (get_local $y)) (f32.le (get_local $x) (get_local $y)))))
  (export "f32.no_trichotomy_ge" (func (param $x f32) (param $y f32) (result i32)
    (i32.or (f32.ge (get_local $x) (get_local $y)) (f32.lt (get_local $x) (get_local $y)))))

  (export "f64.no_trichotomy_lt" (func (param $x f64) (param $y f64) (result i32)
    (i32.or (f64.lt (get_local $x) (get_local $y)) (f64.ge (get_local $x) (get_local $y)))))
  (export "f64.no_trichotomy_le" (func (param $x f64) (param $y f64) (result i32)
    (i32.or (f64.le (get_local $x) (get_local $y)) (f64.gt (get_local $x) (get_local $y)))))
  (export "f64.no_trichotomy_gt" (func (param $x f64) (param $y f64) (result i32)
    (i32.or (f64.gt (get_local $x) (get_local $y)) (f64.le (get_local $x) (get_local $y)))))
  (export "f64.no_trichotomy_ge" (func (param $x f64) (param $y f64) (result i32)
