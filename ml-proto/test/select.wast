(module
  (export "select_i32" (func (param $lhs i32) (param $rhs i32) (param $cond i32) (result i32)
   (select (get_local $lhs) (get_local $rhs) (get_local $cond))))

  (export "select_i64" (func (param $lhs i64) (param $rhs i64) (param $cond i32) (result i64)
   (select (get_local $lhs) (get_local $rhs) (get_local $cond))))

  (export "select_f32" (func (param $lhs f32) (param $rhs f32) (param $cond i32) (result f32)
   (select (get_local $lhs) (get_local $rhs) (get_local $cond))))

  (export "select_f64" (func (param $lhs f64) (param $rhs f64) (param $cond i32) (result f64)
   (select (get_local $lhs) (get_local $rhs) (get_local $cond))))

  ;; Check that both sides of the select are evaluated
  (export "select_trap_l" (func (param $cond i32) (result i32)
   (select (unreachable) (i32.const 0) (get_local $cond))))
  (export "select_trap_r" (func (param $cond i32) (result i32)
