...
(assert_return (invoke "select_f32" (i32.const 1) (f32.const nan:0x20304) (f32.const 1)) (f32.const nan:0x20304))
(assert_return (invoke "select_f32" (i32.const 0) (f32.const nan) (f32.const 1)) (f32.const 1))
(assert_return (invoke "select_f32" (i32.const 0) (f32.const nan:0x20304) (f32.const 1)) (f32.const 1))
(assert_return (invoke "select_f32" (i32.const 1) (f32.const 2) (f32.const nan)) (f32.const 2))
(assert_return (invoke "select_f32" (i32.const 1) (f32.const 2) (f32.const nan:0x20304)) (f32.const 2))
(assert_return (invoke "select_f32" (i32.const 0) (f32.const 2) (f32.const nan)) (f32.const nan))
(assert_return (invoke "select_f32" (i32.const 0) (f32.const 2) (f32.const nan:0x20304)) (f32.const nan:0x20304))

(assert_return (invoke "select_f64" (i32.const 1) (f64.const nan) (f64.const 1)) (f64.const nan))
(assert_return (invoke "select_f64" (i32.const 1) (f64.const nan:0x20304) (f64.const 1)) (f64.const nan:0x20304))
(assert_return (invoke "select_f64" (i32.const 0) (f64.const nan) (f64.const 1)) (f64.const 1))
(assert_return (invoke "select_f64" (i32.const 0) (f64.const nan:0x20304) (f64.const 1)) (f64.const 1))
(assert_return (invoke "select_f64" (i32.const 1) (f64.const 2) (f64.const nan)) (f64.const 2))
(assert_return (invoke "select_f64" (i32.const 1) (f64.const 2) (f64.const nan:0x20304)) (f64.const 2))
(assert_return (invoke "select_f64" (i32.const 0) (f64.const 2) (f64.const nan)) (f64.const nan))
(assert_return (invoke "select_f64" (i32.const 0) (f64.const 2) (f64.const nan:0x20304)) (f64.const nan:0x20304))
