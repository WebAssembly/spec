(module
  ...
  (func $br-drop (block (br 0 (drop (i32.const 1)))))
  (export "br-drop" $br-drop)

  (func $br-block-nop (block (br 0 (block (drop (i32.const 1)) (nop)))))
  (export "br-block-nop" $br-block-nop)

  (func $br-block-drop (block (br 0 (block (nop) (drop (i32.const 1))))))
  ...
  (func $br_if-drop (block (br_if 0 (drop (i32.const 1)) (i32.const 1))))
  (export "br_if-drop" $br_if-drop)

  (func $br_if-block-nop (block (br_if 0 (block (drop (i32.const 1)) (nop)) (i32.const 1))))
  (export "br_if-block-nop" $br_if-block-nop)

  (func $br_if-block-drop (block (br_if 0 (block (nop) (drop (i32.const 1))) (i32.const 1))))
  ...
  (func $br_table-drop (block (br_table 0 (drop (i32.const 1)) (i32.const 0))))
  (export "br_table-drop" $br_table-drop)

  (func $br_table-block-nop (block (br_table 0 (block (drop (i32.const 1)) (nop)) (i32.const 0))))
  (export "br_table-block-nop" $br_table-block-nop)

  (func $br_table-block-drop (block (br_table 0 (block (nop) (drop (i32.const 1))) (i32.const 0))))
