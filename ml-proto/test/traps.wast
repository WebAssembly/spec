...
(module
  (func "no_dce.i32.div_s" (param $x i32) (param $y i32) (result i32)
    (i32.div_s (get_local $x) (get_local $y)))
  (func "no_dce.i32.div_u" (param $x i32) (param $y i32) (result i32)
    (i32.div_u (get_local $x) (get_local $y)))
  (func "no_dce.i64.div_s" (param $x i64) (param $y i64) (result i64)
    (i64.div_s (get_local $x) (get_local $y)))
  (func "no_dce.i64.div_u" (param $x i64) (param $y i64) (result i64)
...
(module
  (func "no_dce.i32.rem_s" (param $x i32) (param $y i32) (result i32)
    (i32.rem_s (get_local $x) (get_local $y)))
  (func "no_dce.i32.rem_u" (param $x i32) (param $y i32) (result i32)
    (i32.rem_u (get_local $x) (get_local $y)))
  (func "no_dce.i64.rem_s" (param $x i64) (param $y i64) (result i64)
    (i64.rem_s (get_local $x) (get_local $y)))
  (func "no_dce.i64.rem_u" (param $x i64) (param $y i64) (result i64)
...
(module
  (func "no_dce.i32.trunc_s_f32" (param $x f32) (result i32) (i32.trunc_s/f32 (get_local $x)))
  (func "no_dce.i32.trunc_u_f32" (param $x f32) (result i32) (i32.trunc_u/f32 (get_local $x)))
  (func "no_dce.i32.trunc_s_f64" (param $x f64) (result i32) (i32.trunc_s/f64 (get_local $x)))
  (func "no_dce.i32.trunc_u_f64" (param $x f64) (result i32) (i32.trunc_u/f64 (get_local $x)))
  (func "no_dce.i64.trunc_s_f32" (param $x f32) (result i64) (i64.trunc_s/f32 (get_local $x)))
  (func "no_dce.i64.trunc_u_f32" (param $x f32) (result i64) (i64.trunc_u/f32 (get_local $x)))
  (func "no_dce.i64.trunc_s_f64" (param $x f64) (result i64) (i64.trunc_s/f64 (get_local $x)))
  (func "no_dce.i64.trunc_u_f64" (param $x f64) (result i64) (i64.trunc_u/f64 (get_local $x)))
)
...
(module
    ...
    (func "no_dce.i32.load" (param $i i32) (result i32) (i32.load (get_local $i)))
    (func "no_dce.i64.load" (param $i i32) (result i64) (i64.load (get_local $i)))
    (func "no_dce.f32.load" (param $i i32) (result f32) (f32.load (get_local $i)))
    (func "no_dce.f64.load" (param $i i32) (result f64) (f64.load (get_local $i)))
)
