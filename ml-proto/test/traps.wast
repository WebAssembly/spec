...
(module
  (export "no_dce.i32.div_s" (func (param $x i32) (param $y i32) (result i32)
    (i32.div_s (get_local $x) (get_local $y))))
  (export "no_dce.i32.div_u" (func (param $x i32) (param $y i32) (result i32)
    (i32.div_u (get_local $x) (get_local $y))))
  (export "no_dce.i64.div_s" (func (param $x i64) (param $y i64) (result i64)
    (i64.div_s (get_local $x) (get_local $y))))
  (export "no_dce.i64.div_u" (func (param $x i64) (param $y i64) (result i64)
...
(module
  (export "no_dce.i32.rem_s" (func (param $x i32) (param $y i32) (result i32)
    (i32.rem_s (get_local $x) (get_local $y))))
  (export "no_dce.i32.rem_u" (func (param $x i32) (param $y i32) (result i32)
    (i32.rem_u (get_local $x) (get_local $y))))
  (export "no_dce.i64.rem_s" (func (param $x i64) (param $y i64) (result i64)
    (i64.rem_s (get_local $x) (get_local $y))))
  (export "no_dce.i64.rem_u" (func (param $x i64) (param $y i64) (result i64)
...
(module
  (export "no_dce.i32.trunc_s_f32" (func (param $x f32) (result i32) (i32.trunc_s/f32 (get_local $x))))
  (export "no_dce.i32.trunc_u_f32" (func (param $x f32) (result i32) (i32.trunc_u/f32 (get_local $x))))
  (export "no_dce.i32.trunc_s_f64" (func (param $x f64) (result i32) (i32.trunc_s/f64 (get_local $x))))
  (export "no_dce.i32.trunc_u_f64" (func (param $x f64) (result i32) (i32.trunc_u/f64 (get_local $x))))
  (export "no_dce.i64.trunc_s_f32" (func (param $x f32) (result i64) (i64.trunc_s/f32 (get_local $x))))
  (export "no_dce.i64.trunc_u_f32" (func (param $x f32) (result i64) (i64.trunc_u/f32 (get_local $x))))
  (export "no_dce.i64.trunc_s_f64" (func (param $x f64) (result i64) (i64.trunc_s/f64 (get_local $x))))
  (export "no_dce.i64.trunc_u_f64" (func (param $x f64) (result i64) (i64.trunc_u/f64 (get_local $x))))
)
...
(module
    ...
    (export "no_dce.i32.load" (func (param $i i32) (result i32) (i32.load (get_local $i))))
    (export "no_dce.i64.load" (func (param $i i32) (result i64) (i64.load (get_local $i))))
    (export "no_dce.f32.load" (func (param $i i32) (result f32) (f32.load (get_local $i))))
    (export "no_dce.f64.load" (func (param $i i32) (result f64) (f64.load (get_local $i))))
)
