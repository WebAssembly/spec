...
(assert_same (invoke "size") (i32.const 4096))
(invoke "store" (i32.const 0) (i32.const 42))
(assert_same (invoke "load" (i32.const 0)) (i32.const 42))
...
(assert_same (invoke "size") (i32.const 8192))
(assert_same (invoke "load" (i32.const 0)) (i32.const 42))
(assert_same (invoke "load" (i32.const 4096)) (i32.const 0))
(invoke "store" (i32.const 4096) (i32.const 43))
(assert_same (invoke "load" (i32.const 4096)) (i32.const 43))
