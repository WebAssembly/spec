...
let i8x16_eq = VecBinary (V128 (I8x16 V128Op.Eq))
let i8x16_ne = VecBinary (V128 (I8x16 V128Op.Ne))
let i8x16_lt_s = VecBinary (V128 (I8x16 V128Op.LtS))
let i8x16_lt_u = VecBinary (V128 (I8x16 V128Op.LtU))
let i8x16_le_s = VecBinary (V128 (I8x16 V128Op.LeS))
let i8x16_le_u = VecBinary (V128 (I8x16 V128Op.LeU))
let i8x16_gt_s = VecBinary (V128 (I8x16 V128Op.GtS))
let i8x16_gt_u = VecBinary (V128 (I8x16 V128Op.GtU))
let i8x16_ge_s = VecBinary (V128 (I8x16 V128Op.GeS))
let i8x16_ge_u = VecBinary (V128 (I8x16 V128Op.GeU))
...
let i16x8_extend_low_i8x16_s = VecUnary (V128 (I16x8 V128Op.ExtendLowS))
let i16x8_extend_high_i8x16_s = VecUnary (V128 (I16x8 V128Op.ExtendHighS))
let i16x8_extend_low_i8x16_u = VecUnary (V128 (I16x8 V128Op.ExtendLowU))
let i16x8_extend_high_i8x16_u = VecUnary (V128 (I16x8 V128Op.ExtendHighU))
...
let i16x8_eq = VecBinary (V128 (I16x8 V128Op.Eq))
let i16x8_ne = VecBinary (V128 (I16x8 V128Op.Ne))
let i16x8_lt_s = VecBinary (V128 (I16x8 V128Op.LtS))
let i16x8_lt_u = VecBinary (V128 (I16x8 V128Op.LtU))
let i16x8_le_s = VecBinary (V128 (I16x8 V128Op.LeS))
let i16x8_le_u = VecBinary (V128 (I16x8 V128Op.LeU))
let i16x8_gt_s = VecBinary (V128 (I16x8 V128Op.GtS))
let i16x8_gt_u = VecBinary (V128 (I16x8 V128Op.GtU))
let i16x8_ge_s = VecBinary (V128 (I16x8 V128Op.GeS))
let i16x8_ge_u = VecBinary (V128 (I16x8 V128Op.GeU))
...
let i16x8_extadd_pairwise_i8x16_s = VecUnary (V128 (I16x8 V128Op.ExtAddPairwiseS))
let i16x8_extadd_pairwise_i8x16_u = VecUnary (V128 (I16x8 V128Op.ExtAddPairwiseU))
...
let i32x4_eq = VecBinary (V128 (I32x4 V128Op.Eq))
let i32x4_ne = VecBinary (V128 (I32x4 V128Op.Ne))
let i32x4_lt_s = VecBinary (V128 (I32x4 V128Op.LtS))
let i32x4_lt_u = VecBinary (V128 (I32x4 V128Op.LtU))
let i32x4_le_s = VecBinary (V128 (I32x4 V128Op.LeS))
let i32x4_le_u = VecBinary (V128 (I32x4 V128Op.LeU))
let i32x4_gt_s = VecBinary (V128 (I32x4 V128Op.GtS))
let i32x4_gt_u = VecBinary (V128 (I32x4 V128Op.GtU))
let i32x4_ge_s = VecBinary (V128 (I32x4 V128Op.GeS))
let i32x4_ge_u = VecBinary (V128 (I32x4 V128Op.GeU))
...
let i32x4_extend_low_i16x8_s = VecUnary (V128 (I32x4 V128Op.ExtendLowS))
let i32x4_extend_high_i16x8_s = VecUnary (V128 (I32x4 V128Op.ExtendHighS))
let i32x4_extend_low_i16x8_u = VecUnary (V128 (I32x4 V128Op.ExtendLowU))
let i32x4_extend_high_i16x8_u = VecUnary (V128 (I32x4 V128Op.ExtendHighU))
...
let i32x4_trunc_sat_f32x4_s = VecUnary (V128 (I32x4 V128Op.TruncSatSF32x4))
let i32x4_trunc_sat_f32x4_u = VecUnary (V128 (I32x4 V128Op.TruncSatUF32x4))
let i32x4_trunc_sat_f64x2_s_zero = VecUnary (V128 (I32x4 V128Op.TruncSatSZeroF64x2))
let i32x4_trunc_sat_f64x2_u_zero = VecUnary (V128 (I32x4 V128Op.TruncSatUZeroF64x2))
...
let i32x4_extadd_pairwise_i16x8_u = VecUnary (V128 (I32x4 V128Op.ExtAddPairwiseU))
...
let i64x2_extend_low_i32x4_s = VecUnary (V128 (I64x2 V128Op.ExtendLowS))
let i64x2_extend_high_i32x4_s = VecUnary (V128 (I64x2 V128Op.ExtendHighS))
let i64x2_extend_low_i32x4_u = VecUnary (V128 (I64x2 V128Op.ExtendLowU))
let i64x2_extend_high_i32x4_u = VecUnary (V128 (I64x2 V128Op.ExtendHighU))
let i64x2_eq = VecBinary (V128 (I64x2 V128Op.Eq))
let i64x2_ne = VecBinary (V128 (I64x2 V128Op.Ne))
let i64x2_lt_s = VecBinary (V128 (I64x2 V128Op.LtS))
let i64x2_le_s = VecBinary (V128 (I64x2 V128Op.LeS))
let i64x2_gt_s = VecBinary (V128 (I64x2 V128Op.GtS))
let i64x2_ge_s = VecBinary (V128 (I64x2 V128Op.GeS))
...
let f32x4_eq = VecBinary (V128 (F32x4 V128Op.Eq))
let f32x4_ne = VecBinary (V128 (F32x4 V128Op.Ne))
let f32x4_lt = VecBinary (V128 (F32x4 V128Op.Lt))
let f32x4_le = VecBinary (V128 (F32x4 V128Op.Le))
let f32x4_gt = VecBinary (V128 (F32x4 V128Op.Gt))
let f32x4_ge = VecBinary (V128 (F32x4 V128Op.Ge))
...
let f32x4_demote_f64x2_zero = VecUnary (V128 (F32x4 V128Op.DemoteZeroF64x2))
let f32x4_convert_i32x4_s = VecUnary (V128 (F32x4 V128Op.ConvertSI32x4))
let f32x4_convert_i32x4_u = VecUnary (V128 (F32x4 V128Op.ConvertUI32x4))
...
let f64x2_eq = VecBinary (V128 (F64x2 V128Op.Eq))
let f64x2_ne = VecBinary (V128 (F64x2 V128Op.Ne))
let f64x2_lt = VecBinary (V128 (F64x2 V128Op.Lt))
let f64x2_le = VecBinary (V128 (F64x2 V128Op.Le))
let f64x2_gt = VecBinary (V128 (F64x2 V128Op.Gt))
let f64x2_ge = VecBinary (V128 (F64x2 V128Op.Ge))
...
let f64x2_promote_low_f32x4 = VecUnary (V128 (F64x2 V128Op.PromoteLowF32x4))
let f64x2_convert_low_i32x4_s = VecUnary (V128 (F64x2 V128Op.ConvertSI32x4))
let f64x2_convert_low_i32x4_u = VecUnary (V128 (F64x2 V128Op.ConvertUI32x4))
