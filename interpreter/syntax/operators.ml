...
let br_on_null x = BrCastNull x
let br_on_non_null x = BrCastFailNull x
let br_on_cast x t = BrCast (x, (NoNull, t))
let br_on_cast_fail x t = BrCastFail (x, (NoNull, t))
let br_on_cast_null x t = BrCast (x, (Null, t))
let br_on_cast_fail_null x t = BrCastFail (x, (Null, t))
...
let ref_is_null = RefTestNull
let ref_as_non_null = RefCastNull  
