...
let i32x4_dot_i8x16_i7x16_add_s = VecTernary (V128 (I32x4 V128Op.RelaxedDotAccum))
let f32x4_relaxed_dot_bf16x8_add_f32x4 = VecTernary (V128 (F32x4 V128Op.RelaxedDotAccum))
