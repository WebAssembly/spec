...
let v128_store align offset = SimdStore {ty = V128Type; align; offset; sz = ()}

let v128_load8_lane align offset i =
  SimdLoadLane ({ty = V128Type; align; offset; sz = Pack8}, i)
let v128_load16_lane align offset i =
  SimdLoadLane ({ty = V128Type; align; offset; sz = Pack16}, i)
let v128_load32_lane align offset i =
  SimdLoadLane ({ty = V128Type; align; offset; sz = Pack32}, i)
let v128_load64_lane align offset i =
  SimdLoadLane ({ty = V128Type; align; offset; sz = Pack64}, i)

let v128_store8_lane align offset i =
  SimdStoreLane ({ty = V128Type; align; offset; sz = Pack8}, i)
let v128_store16_lane align offset i =
  SimdStoreLane ({ty = V128Type; align; offset; sz = Pack16}, i)
let v128_store32_lane align offset i =
  SimdStoreLane ({ty = V128Type; align; offset; sz = Pack32}, i)
let v128_store64_lane align offset i =
  SimdStoreLane ({ty = V128Type; align; offset; sz = Pack64}, i)
...
let i8x16_splat = SimdConvert (V128 V128Op.(I8x16 Splat))
let i8x16_extract_lane_s i = SimdExtract (V128 V128Op.(I8x16 (Extract (i, Some SX))))
let i8x16_extract_lane_u i = SimdExtract (V128 V128Op.(I8x16 (Extract (i, Some ZX))))
...
let i16x8_splat = SimdConvert (V128 V128Op.(I16x8 Splat))
let i16x8_extract_lane_s i = SimdExtract (V128 V128Op.(I16x8 (Extract (i, Some SX))))
let i16x8_extract_lane_u i = SimdExtract (V128 V128Op.(I16x8 (Extract (i, Some ZX))))
...
let i32x4_splat = SimdConvert (V128 V128Op.(I32x4 Splat))
let i32x4_extract_lane i = SimdExtract (V128 V128Op.(I32x4 (Extract (i, None))))
...
let i32x4_trunc_sat_f32x4_s = SimdUnary (V128 V128Op.(I32x4 TruncSatF32x4S))
let i32x4_trunc_sat_f32x4_u = SimdUnary (V128 V128Op.(I32x4 TruncSatF32x4U))
let i32x4_trunc_sat_f64x2_s_zero = SimdUnary (V128 V128Op.(I32x4 TruncSatF64x2SZero))
let i32x4_trunc_sat_f64x2_u_zero = SimdUnary (V128 V128Op.(I32x4 TruncSatF64x2UZero))
let i32x4_dot_i16x8_s = SimdBinary (V128 V128Op.(I32x4 DotI16x8S))
...
let i64x2_splat = SimdConvert (V128 V128Op.(I64x2 Splat))
let i64x2_extract_lane i = SimdExtract (V128 V128Op.(I64x2 (Extract (i, None))))
...
let f32x4_extract_lane i = SimdExtract (V128 V128Op.(F32x4 (Extract (i, None))))
...
let f32x4_convert_i32x4_s = SimdUnary (V128 V128Op.(F32x4 ConvertI32x4S))
let f32x4_convert_i32x4_u = SimdUnary (V128 V128Op.(F32x4 ConvertI32x4U))
let f32x4_pmin = SimdBinary (V128 V128Op.(F32x4 Pmin))
let f32x4_pmax = SimdBinary (V128 V128Op.(F32x4 Pmax))
let f32x4_demote_f64x2_zero = SimdUnary (V128 V128Op.(F32x4 DemoteF64x2Zero))

let f64x2_splat = SimdConvert (V128 V128Op.(F64x2 Splat))
let f64x2_extract_lane i = SimdExtract (V128 V128Op.(F64x2 (Extract (i, None))))
...
let f64x2_convert_low_i32x4_s = SimdUnary (V128 V128Op.(F64x2 ConvertI32x4S))
let f64x2_convert_low_i32x4_u = SimdUnary (V128 V128Op.(F64x2 ConvertI32x4U))
