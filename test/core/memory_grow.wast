...
(assert_invalid
  (module
    ...
    (func $type-operand-missing-in-else
      (i32.const 0) (i32.const 0)
      (if (result i32) (then (i32.const 0)) (else (memory.grow))) (drop)
    )
  )
  "type mismatch"
)
...
(assert_invalid
  (module
    ...
    (func $type-operand-missing-in-br_if
      (i32.const 0)
      (block (br_if 0 (memory.grow) (i32.const 1)) (drop))
    )
  )
  "type mismatch"
)
(assert_invalid
  (module
    ...
    (func $type-operand-missing-in-br_table
      (i32.const 0)
      (block (br_table 0 (memory.grow)) (drop))
    )
  )
  "type mismatch"
)
...
(assert_invalid
  (module
    ...
    (func $type-operand-missing-in-select
      (select (memory.grow) (i32.const 1) (i32.const 2)) (drop)
    )
  )
  "type mismatch"
)
