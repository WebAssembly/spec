...
(assert_trap (invoke "i64.store" (i32.const 0xfff9) (i64.const 0x12345678)) "out of bounds memory access")
...
(assert_trap (invoke "f64.store" (i32.const 0xfff9) (f64.const 0x12345678)) "out of bounds memory access")
