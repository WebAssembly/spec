...
(assert_invalid
  (module
    ...
    (func $type-operand-missing-in-else
      (i32.const 0) (i32.const 0)
      (if (result i32) (then (i32.const 0)) (else (call 0))) (drop)
    )
  )
  "type mismatch"
)
...
(assert_invalid
  (module
    ...
    (func $type-operand-missing-in-br_if
      (i32.const 0)
      (block (br_if 0 (call 0) (i32.const 1)) (drop))
    )
  )
  "type mismatch"
)
...
(assert_invalid
  (module
    ...
    (func $type-operand-missing-in-select
      (select (call 0) (i32.const 1) (i32.const 2)) (drop)
    )
  )
  "type mismatch"
)
...
(assert_invalid
  (module
    ...
    (func $type-operand-missing-in-local.set
      (local i32)
      (local.set 0 (call 0)) (local.get 0) (drop)
    )
  )
  "type mismatch"
)
...
(assert_invalid
  (module
    ...
    (func $type-operand-missing-in-global.set
      (global.set $x (call 0)) (global.get $x) (drop)
    )
  )
  "type mismatch"
)
