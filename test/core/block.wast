...
(assert_invalid
  (module
    (func $type-operand-missing-in-else
      (i32.const 0) (i32.const 0)
      (if (result i32) (then (i32.const 0)) (else (block (result i32)))) (drop)
    )
  )
  "type mismatch"
)
(assert_invalid
  (module
    (func $type-operand-missing-in-br
      (i32.const 0)
      (block (br 0 (block (result i32))) (drop))
    )
  )
  "type mismatch"
)
(assert_invalid
  (module
    (func $type-operand-missing-in-br_if
      (i32.const 0)
      (block (br_if 0 (block (result i32)) (i32.const 1)) (drop))
    )
  )
  "type mismatch"
)
(assert_invalid
  (module
    (func $type-operand-missing-in-br_table
      (i32.const 0)
      (block (br_table 0 (block (result i32))) (drop))
    )
  )
  "type mismatch"
)
...
(assert_invalid
  (module
    (func $type-operand-missing-in-select
      (select (block (result i32)) (i32.const 1) (i32.const 2)) (drop)
    )
  )
  "type mismatch"
)
...
(assert_invalid
  (module
    (func $type-operand-missing-in-local.set
      (local i32)
      (local.set 0 (block (result i32))) (local.get 0) (drop)
    )
  )
  "type mismatch"
)
(assert_invalid
  (module
    (func $type-operand-missing-in-local.tee
      (local i32)
      (local.tee 0 (block (result i32))) (drop)
    )
  )
  "type mismatch"
)
(assert_invalid
  (module
    ...
    (func $type-operand-missing-in-global.set
      (global.set $x (block (result i32))) (global.get $x) (drop)
    )
  )
  "type mismatch"
)
(assert_invalid
  (module
    ...
    (func $type-operand-missing-in-memory.grow
      (memory.grow (block (result i32))) (drop)
    )
  )
  "type mismatch"
)
(assert_invalid
  (module
    ...
    (func $type-operand-missing-in-load
      (i32.load (block (result i32))) (drop)
    )
  )
  "type mismatch"
)
(assert_invalid
  (module
    ...
    (func $type-operand-missing-in-store
      (i32.store (block (result i32)) (i32.const 1))
    )
  )
  "type mismatch"
)
