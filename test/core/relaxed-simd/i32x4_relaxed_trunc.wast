...
(assert_return (invoke "i32x4.relaxed_trunc_f32x4_s"
               ...
               ;; out of range -> 0 or INT32_MIN
               (either (v128.const i32x4 0x80000000 0 0x4f000000 0)
                       (v128.const i32x4 0xcf000000 0x8000000 0x4f000000 0x8000000)))
...
(assert_return (invoke "i32x4.relaxed_trunc_f32x4_u"
                       ...
                       (v128.const f32x4 0 -1.0 0x4f7fffff 4294967296.0))
               ;; out of range -> 0 or UINT32_MAX
...
(assert_return (invoke "i32x4.relaxed_trunc_f64x2_s_zero"
               ...
               (either (v128.const i32x4 0 0 0 0)
                       (v128.const i32x4 0 0 0x8000000 0x8000000)))
