...
(module
    ...
    (func (export "no_dce.i32.load16_s") (param $i i32) (result i32) (i32.load16_s (get_local $i)))
    (func (export "no_dce.i32.load16_u") (param $i i32) (result i32) (i32.load16_u (get_local $i)))
    (func (export "no_dce.i32.load8_s") (param $i i32) (result i32) (i32.load8_s (get_local $i)))
    (func (export "no_dce.i32.load8_u") (param $i i32) (result i32) (i32.load8_u (get_local $i)))
    (func (export "no_dce.i64.load") (param $i i32) (result i64) (i64.load (get_local $i)))
    (func (export "no_dce.i64.load32_s") (param $i i32) (result i64) (i64.load32_s (get_local $i)))
    (func (export "no_dce.i64.load32_u") (param $i i32) (result i64) (i64.load32_u (get_local $i)))
    (func (export "no_dce.i64.load16_s") (param $i i32) (result i64) (i64.load16_s (get_local $i)))
    (func (export "no_dce.i64.load16_u") (param $i i32) (result i64) (i64.load16_u (get_local $i)))
    (func (export "no_dce.i64.load8_s") (param $i i32) (result i64) (i64.load8_s (get_local $i)))
    (func (export "no_dce.i64.load8_u") (param $i i32) (result i64) (i64.load8_u (get_local $i)))
