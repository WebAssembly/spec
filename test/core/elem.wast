...
(module
  ...
  (elem (table 0x0) (i32.const 0) $f $f)
  (elem (table 0x000) (offset (i32.const 0)))
  (elem (table 0) (offset (i32.const 0)) $f $f)
  (elem (table $t) (i32.const 0))
  (elem (table $t) (i32.const 0) $f $f)
  (elem (table $t) (offset (i32.const 0)))
  (elem (table $t) (offset (i32.const 0)) $f $f)
)
