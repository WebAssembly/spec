...
(module
  ...
  (func (export "result") (param i64 f32 f64 i32 i32) (result f64)
    ...
    (f64.add
      (f64.convert_u/i64 (local.tee 0 (i64.const 1)))
      (f64.add
        (f64.promote/f32 (local.tee 1 (f32.const 2)))
        (f64.add
          (local.tee 2 (f64.const 3.3))
          (f64.add
            (f64.convert_u/i32 (local.tee 3 (i32.const 4)))
            (f64.add
              (f64.convert_s/i32 (local.tee 4 (i32.const 5)))
              (f64.add
                (f64.promote/f32 (local.tee 5 (f32.const 5.5)))
                (f64.add
                  (f64.convert_u/i64 (local.tee 6 (i64.const 6)))
                  (f64.add
                    (f64.convert_u/i64 (local.tee 7 (i64.const 0)))
  ...
  (func (export "as-convert-operand") (param i64) (result i32)
    (i32.wrap/i64 (local.tee 0 (i64.const 41)))
  )
