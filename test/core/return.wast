...
(assert_invalid
  (module
    (func $type-operand-missing-in-br (result i32)
      (i32.const 0)
      (block (br 0 (return)))
    )
  )
...
(assert_invalid
  (module
    (func $type-operand-missing-in-br_if (result i32)
      (i32.const 0)
...
(assert_invalid
  (module
    (func $type-operand-missing-in-br_table (result i32)
      (i32.const 0)
...
(assert_invalid
  (module
    (func $type-operand-missing-in-return (result i32)
      (return (return))
    )
  )
  "type mismatch"
...
(assert_invalid
  (module
    (func $type-operand-missing-in-select (result i32)
...
(assert_invalid
  (module
    (func $type-operand-missing-in-call (result i32)
      (call 1 (return))
    )
...
(assert_invalid
  (module
    ...
    (table funcref (elem $f))
    (func $type-operand-missing-in-call_indirect (result i32)
      (block (result i32)
        (call_indirect (type $sig)
          (return) (i32.const 0)
        )
...
(assert_invalid
  (module
    (func $type-operand-missing-in-local.set (result i32)
      (local i32)
...
(assert_invalid
  (module
    (func $type-operand-missing-in-local.tee (result i32)
      (local i32)
      (local.tee 0 (return))
    )
  )
...
(assert_invalid
  (module
    ...
    (func $type-operand-missing-in-global.set (result i32)
...
(assert_invalid
  (module
    (memory 0)
    (func $type-operand-missing-in-memory.grow (result i32)
      (memory.grow (return))
    )
  )
  "type mismatch"
...
(assert_invalid
  (module
    (memory 0)
    (func $type-operand-missing-in-load (result i32)
      (i32.load (return))
    )
  )
  "type mismatch"
...
(assert_invalid
  (module
    (memory 1)
    (func $type-operand-missing-in-store (result i32)
