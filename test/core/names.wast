...
(module
  ...
  (func (export "_") (result i32) (i32.const 2))

  ;; Test that we can use names beginning with a dollar sign.
  (func (export "$") (result i32) (i32.const 3))
  ...
  (func (export "~!@#$%^&*()_+`-={}|[]\\:\";'<>?,./ ") (result i32) (i32.const 5))

  ;; Test that we can use names that have special meaning in JS.
  (func (export "NaN") (result i32) (i32.const 6))
  (func (export "Infinity") (result i32) (i32.const 7))
  (func (export "if") (result i32) (i32.const 8))

  ;; Test that we can use common libc names without conflict.
  (func (export "malloc") (result i32) (i32.const 9))

  ;; Test that we can use some libc hidden names without conflict.
  (func (export "_malloc") (result i32) (i32.const 10))
  (func (export "__malloc") (result i32) (i32.const 11))

  ;; Test that UTF-8 BOM code points can appear in identifiers.
  (func (export "﻿") (result i32) (i32.const 12))
  ...
  ;; NFC or NFD.
  (func (export "Å") (result i32) (i32.const 13))
  (func (export "Å") (result i32) (i32.const 14))
  (func (export "Å") (result i32) (i32.const 15))
)

(assert_return (invoke "") (i32.const 0))
(assert_return (invoke "0") (i32.const 1))
(assert_return (invoke "_") (i32.const 2))
(assert_return (invoke "$") (i32.const 3))
(assert_return (invoke "@") (i32.const 4))
(assert_return (invoke "~!@#$%^&*()_+`-={}|[]\\:\";'<>?,./ ") (i32.const 5))
(assert_return (invoke "NaN") (i32.const 6))
(assert_return (invoke "Infinity") (i32.const 7))
(assert_return (invoke "if") (i32.const 8))
(assert_return (invoke "malloc") (i32.const 9))
(assert_return (invoke "_malloc") (i32.const 10))
(assert_return (invoke "__malloc") (i32.const 11))
(assert_return (invoke "﻿") (i32.const 12))
(assert_return (invoke "Å") (i32.const 13))
(assert_return (invoke "Å") (i32.const 14))
(assert_return (invoke "Å") (i32.const 15))
