...
(assert_invalid
  (module
    (func $type-1st-operand-missing-in-else
      (block
        (i32.const 0) (i32.const 0)
        (if (result i32) (then (i32.const 0)) (else (br_if 0)))
      )
      (i32.eqz) (drop)
    )
  )
...
(assert_invalid
  (module
    (func $type-2nd-operand-missing-in-else
      (block
        (i32.const 0) (i32.const 0)
        (if (result i32) (then (i32.const 0)) (else (br_if 0 (i32.const 1))))
      )
      (i32.eqz) (drop)
    )
  )
...
(assert_invalid
  (module
    (func $type-1st-operand-missing-in-br
      (i32.const 0)
      (block (result i32) (br 0 (br_if 0))) (i32.eqz) (drop)
    )
  )
  "type mismatch"
)
(assert_invalid
  (module
    (func $type-2nd-operand-missing-in-br
      (i32.const 0)
      (block (result i32) (br 0 (br_if 0 (i32.const 1)))) (i32.eqz) (drop)
    )
  )
  "type mismatch"
)
(assert_invalid
  (module
    (func $type-1st-operand-missing-in-br_if
      (i32.const 0)
      (block (result i32) (br_if 0 (br_if 0) (i32.const 1))) (i32.eqz) (drop)
    )
  )
  "type mismatch"
)
(assert_invalid
  (module
    (func $type-2nd-operand-missing-in-br_if
      (i32.const 0)
      (block (result i32) (br_if 0 (br_if 0 (i32.const 1)) (i32.const 1))) (i32.eqz) (drop)
    )
  )
  "type mismatch"
)
(assert_invalid
  (module
    (func $type-1st-operand-missing-in-br_table
      (i32.const 0)
      (block (result i32) (br_table 0 (br_if 0))) (i32.eqz) (drop)
    )
  )
  "type mismatch"
)
(assert_invalid
  (module
    (func $type-2nd-operand-missing-in-br_table
      (i32.const 0)
      (block (result i32) (br_table 0 (br_if 0 (i32.const 1)))) (i32.eqz) (drop)
    )
  )
  "type mismatch"
)
...
(assert_invalid
  (module
    (func $type-1st-operand-missing-in-select
      (block (result i32)
        (select (br_if 0) (i32.const 1) (i32.const 2))
      )
      (i32.eqz) (drop)
    )
  )
...
(assert_invalid
  (module
    (func $type-2nd-operand-missing-in-select
      (block (result i32)
        (select (br_if 0 (i32.const 1)) (i32.const 1) (i32.const 2))
      )
      (i32.eqz) (drop)
    )
  )
...
(assert_invalid
  (module
    (func $type-1st-operand-missing-in-local.set
      (local i32)
      (block (result i32)
        (local.set 0 (br_if 0)) (local.get 0)
      )
      (i32.eqz) (drop)
    )
  )
...
(assert_invalid
  (module
    (func $type-2nd-operand-missing-in-local.set
      (local i32)
      (block (result i32)
        (local.set 0 (br_if 0 (i32.const 1))) (local.get 0)
      )
      (i32.eqz) (drop)
    )
  )
...
(assert_invalid
  (module
    (func $type-2nd-operand-missing-in-local.tee
      (local i32)
      (block (result i32)
        (local.tee 0 (br_if 0 (i32.const 1)))
      )
      (i32.eqz) (drop)
    )
  )
...
(assert_invalid
  (module
    ...
    (func $type-1st-operand-missing-in-global.set
      (block (result i32)
        (global.set $x (br_if 0)) (global.get $x)
      )
      (i32.eqz) (drop)
    )
  )
...
(assert_invalid
  (module
    ...
    (func $type-2nd-operand-missing-in-global.set
      (block (result i32)
        (global.set $x (br_if 0 (i32.const 1))) (global.get $x)
      )
      (i32.eqz) (drop)
    )
  )
...
(assert_invalid
  (module
    ...
    (func $type-2nd-operand-missing-in-memory.grow
      (block (result i32)
        (memory.grow (br_if 0 (i32.const 1)))
      )
      (i32.eqz) (drop)
    )
  )
...
(assert_invalid
  (module
    ...
    (func $type-2nd-operand-missing-in-store
      (block (result i32)
        (i32.store (br_if 0 (i32.const 1)) (i32.const 0))
      )
      (i32.eqz) (drop)
    )
  )
