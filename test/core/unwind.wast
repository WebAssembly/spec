...
(module
  ...
  ;;  (block (result i32)
  ;;    (f32.const 0) (drop (br_if 0 (i32.const 9) (i32.const 1))) (i64.eqz)
  ;;  )
  ;;)
  ...
  ;;  (block (result i32)
  ;;    (f32.const 0) (f64.const 1) (drop (drop (br_if 0 (i32.const 9) (i32.const 1))))
  ;;    (i64.eq)
  ;;  )
  ;;)
  ...
  ;;  (block (result i32)
  ;;    (f32.const 0) (drop (br_if 0 (i32.const 9) (i32.const 1)))
  ;;  )
  ;;)
  ...
  ;;  (block (result i32)
  ;;    (loop (result i32)
  ;;      (f32.const 0) (drop (br_if 1 (i32.const 9) (i32.const 1)))
  ;;    )
  ;;  )
  ;;)
