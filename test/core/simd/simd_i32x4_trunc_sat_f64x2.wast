...
(assert_return (invoke "i32x4.trunc_sat_f64x2_u_zero" (v128.const f64x2 4294967294.0 4294967294.0))
                                                      (v128.const i32x4 0 0 4294967294 4294967294))
(assert_return (invoke "i32x4.trunc_sat_f64x2_u_zero" (v128.const f64x2 -4294967294.0 -4294967294.0))
                                                      (v128.const i32x4 0 0 0 0))
