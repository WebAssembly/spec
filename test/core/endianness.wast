(module
  ...
  (func $i64_store_little (param $address i32) (param $value i64)
    (call $i32_store_little (local.get $address) (i32.wrap/i64 (local.get $value)))
    (call $i32_store_little (i32.add (local.get $address) (i32.const 4)) (i32.wrap/i64 (i64.shr_u (local.get $value) (i64.const 32))))
  )
  ...
  (func $i64_load_little (param $address i32) (result i64)
    (i64.or
      (i64.extend_u/i32 (call $i32_load_little (local.get $address)))
      (i64.shl (i64.extend_u/i32 (call $i32_load_little (i32.add (local.get $address) (i32.const 4)))) (i64.const 32))
    )
  )
  ...
  (func (export "i64_load16_s") (param $value i64) (result i64)
    (call $i16_store_little (i32.const 0) (i32.wrap/i64 (local.get $value)))
  ...
  (func (export "i64_load32_s") (param $value i64) (result i64)
    (call $i32_store_little (i32.const 0) (i32.wrap/i64 (local.get $value)))
  ...
  (func (export "f32_load") (param $value f32) (result f32)
    (call $i32_store_little (i32.const 0) (i32.reinterpret/f32 (local.get $value)))
    (f32.load (i32.const 0))
  )

  (func (export "f64_load") (param $value f64) (result f64)
    (call $i64_store_little (i32.const 0) (i64.reinterpret/f64 (local.get $value)))
