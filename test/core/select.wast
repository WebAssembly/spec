...
(assert_invalid
  (module
    (func $type-3rd-operand-missing-in-block
      (i32.const 0)
...
(assert_invalid
  (module
    (func $type-3rd-operand-missing-in-if
      (i32.const 0)
...
(assert_invalid
  (module
    (func $type-1st-operand-missing-in-else
      (i32.const 0) (i32.const 0) (i32.const 0)
      (if (result i32) (then (i32.const 0)) (else (select) (i32.const 0)))
      (drop) (drop)
    )
  )
  "type mismatch"
...
(assert_invalid
  (module
    (func $type-2nd-operand-missing-in-else
      (i32.const 0) (i32.const 0)
      (if (result i32) (then (i32.const 0)) (else (i32.const 0) (select)))
      (drop)
    )
  )
  "type mismatch"
...
(assert_invalid
  (module
    (func $type-3rd-operand-missing-in-else
      (i32.const 0)
      (if (result i32) (then (i32.const 0)) (else (i32.const 0) (i32.const 0) (select)))
      (drop)
    )
  )
  "type mismatch"
...
(assert_invalid
  (module
    (func $type-2nd-operand-missing-in-br
      (i32.const 0) (i32.const 0)
      (block (br 0 (i32.const 0) (select)) (drop))
    )
  )
  "type mismatch"
)
(assert_invalid
  (module
    (func $type-3rd-operand-missing-in-br
      (i32.const 0)
      (block (br 0 (i32.const 0) (i32.const 0) (select)) (drop))
    )
  )
  "type mismatch"
)
(assert_invalid
  (module
    (func $type-1st-operand-missing-in-br_if
      (i32.const 0) (i32.const 0) (i32.const 0)
      (block (br_if 0 (select) (i32.const 1)) (drop))
    )
  )
  "type mismatch"
)
(assert_invalid
  (module
    (func $type-2nd-operand-missing-in-br_if
      (i32.const 0) (i32.const 0)
      (block (br_if 0 (i32.const 0) (select) (i32.const 1)) (drop))
    )
  )
  "type mismatch"
)
(assert_invalid
  (module
    (func $type-3rd-operand-missing-in-br_if
      (i32.const 0)
      (block (br_if 0 (i32.const 0) (i32.const 0) (select) (i32.const 1)) (drop))
    )
  )
  "type mismatch"
)
...
(assert_invalid
  (module
    (func $type-2nd-operand-missing-in-br_table
      (i32.const 0) (i32.const 0)
      (block (br_table 0 (i32.const 0) (select)) (drop))
    )
  )
  "type mismatch"
)
(assert_invalid
  (module
    (func $type-3rd-operand-missing-in-br_table
      (i32.const 0)
      (block (br_table 0 (i32.const 0) (i32.const 0) (select)) (drop))
    )
  )
  "type mismatch"
)
...
(assert_invalid
  (module
    (func $type-2nd-operand-missing-in-return
      (return (i32.const 0) (select)) (drop)
    )
  )
  "type mismatch"
)
(assert_invalid
  (module
    (func $type-3rd-operand-missing-in-return
      (return (i32.const 0) (i32.const 0) (select)) (drop)
    )
  )
  "type mismatch"
)
(assert_invalid
  (module
    (func $type-1st-operand-missing-in-select
      (select (select) (i32.const 1) (i32.const 2)) (drop)
    )
  )
  "type mismatch"
)
(assert_invalid
  (module
    (func $type-2nd-operand-missing-in-select
      (select (i32.const 0) (select) (i32.const 1) (i32.const 2)) (drop)
    )
  )
  "type mismatch"
)
(assert_invalid
  (module
    (func $type-3rd-operand-missing-in-select
      (select (i32.const 0) (i32.const 0) (select) (i32.const 1) (i32.const 2)) (drop)
    )
  )
  "type mismatch"
)
...
(assert_invalid
  (module
    (func $type-2nd-operand-missing-in-call
      (call 1 (i32.const 0) (select)) (drop)
    )
    (func (param i32 i32) (result i32) (local.get 0))
  )
  "type mismatch"
...
(assert_invalid
  (module
    (func $type-3rd-operand-missing-in-call
      (call 1 (i32.const 0) (i32.const 0) (select)) (drop)
    )
    (func (param i32 i32) (result i32) (local.get 0))
  )
  "type mismatch"
...
(assert_invalid
  (module
    ...
    (func $type-2nd-operand-missing-in-call_indirect
      (block (result i32)
        (call_indirect (type $sig)
          (i32.const 0) (select) (i32.const 0)
        )
        (drop)
      )
    )
...
(assert_invalid
  (module
    ...
    (type $sig (func (param i32) (result i32)))
    (table funcref (elem $f))
    (func $type-3rd-operand-missing-in-call_indirect
      (block (result i32)
        (call_indirect (type $sig)
          (i32.const 0) (i32.const 0) (select) (i32.const 0)
        )
        (drop)
      )
    )
...
(assert_invalid
  (module
    (func $type-1st-operand-missing-in-local.set
      (local i32)
      (local.set 0 (select)) (local.get 0) (drop)
    )
  )
  "type mismatch"
)
(assert_invalid
  (module
    (func $type-2nd-operand-missing-in-local.set
      (local i32)
      (local.set 0 (i32.const 0) (select)) (local.get 0) (drop)
    )
  )
  "type mismatch"
)
(assert_invalid
  (module
    (func $type-3rd-operand-missing-in-local.set
      (local i32)
      (local.set 0 (i32.const 0) (i32.const 0) (select)) (local.get 0) (drop)
    )
  )
  "type mismatch"
)
(assert_invalid
  (module
    (func $type-1st-operand-missing-in-local.tee
      (local i32)
      (local.tee 0 (select)) (drop)
    )
  )
  "type mismatch"
)
(assert_invalid
  (module
    (func $type-2nd-operand-missing-in-local.tee
      (local i32)
      (local.tee 0 (i32.const 0) (select)) (drop)
    )
  )
  "type mismatch"
)
(assert_invalid
  (module
    (func $type-3rd-operand-missing-in-local.tee
      (local i32)
      (local.tee 0 (i32.const 0) (i32.const 0) (select)) (drop)
    )
  )
  "type mismatch"
)
(assert_invalid
  (module
    ...
    (func $type-1st-operand-missing-in-global.set
      (global.set $x (select)) (global.get $x) (drop)
    )
  )
  "type mismatch"
)
(assert_invalid
  (module
    (global $x (mut i32) (i32.const 0))
    (func $type-2nd-operand-missing-in-global.set
      (global.set $x (i32.const 0) (select)) (global.get $x) (drop)
    )
  )
  "type mismatch"
)
(assert_invalid
  (module
    (global $x (mut i32) (i32.const 0))
    (func $type-3rd-operand-missing-in-global.set
      (global.set $x (i32.const 0) (i32.const 0) (select)) (global.get $x) (drop)
    )
  )
  "type mismatch"
)
(assert_invalid
  (module
    (memory 0)
    (func $type-1st-operand-missing-in-memory.grow
      (memory.grow (select)) (drop)
    )
  )
  "type mismatch"
)
(assert_invalid
  (module
    (memory 0)
    (func $type-2nd-operand-missing-in-memory.grow
      (memory.grow (i32.const 0) (select)) (drop)
    )
  )
  "type mismatch"
)
(assert_invalid
  (module
    (memory 0)
    (func $type-2nd-operand-missing-in-memory.grow
      (memory.grow (i32.const 0) (i32.const 0) (select)) (drop)
    )
  )
  "type mismatch"
)
(assert_invalid
  (module
    (memory 0)
    (func $type-1st-operand-missing-in-load
      (i32.load (select)) (drop)
    )
  )
  "type mismatch"
)
(assert_invalid
  (module
    (memory 0)
    (func $type-2nd-operand-missing-in-load
      (i32.load (i32.const 0) (select)) (drop)
    )
  )
  "type mismatch"
)
(assert_invalid
  (module
    (memory 0)
    (func $type-3rd-operand-missing-in-load
      (i32.load (i32.const 0) (i32.const 0) (select)) (drop)
    )
  )
  "type mismatch"
)
(assert_invalid
  (module
    (memory 1)
    (func $type-1st-operand-missing-in-store
      (i32.store (select) (i32.const 1))
    )
  )
  "type mismatch"
)
(assert_invalid
  (module
    (memory 1)
    (func $type-2nd-operand-missing-in-store
      (i32.store (i32.const 1) (select) (i32.const 0))
    )
  )
  "type mismatch"
)
(assert_invalid
  (module
    (memory 1)
    (func $type-3rd-operand-missing-in-store
      (i32.store (i32.const 1) (i32.const 1) (select) (i32.const 0))
    )
  )
  "type mismatch"
)
