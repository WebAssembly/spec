...
{\mathit{valtype}}_{{1}} . {{{{{\mathit{cvtop}}}{\mathsf{\_}}}{{\mathit{valtype}}_{{2}}}}{\mathsf{\_}}}{{{\mathit{sx}}^?}} &\quad
  \mbox{if}~{\mathit{valtype}}_{{1}} \neq {\mathit{valtype}}_{{2}} \\ &&|&
...
{\mathit{C}} \vdash {\mathit{t}}_{{1}} . {{\mathsf{reinterpret}}{\mathsf{\_}}}{{\mathit{t}}_{{2}}} : {\mathit{t}}_{{2}} \rightarrow {\mathit{t}}_{{1}}
...
{\mathit{C}} \vdash {\mathit{nt}}.\mathsf{load}~{({\mathit{n}}~\mathsf{\_}~{\mathit{sx}})^?}~{\mathit{memop}} : \mathsf{i{\scriptstyle32}} \rightarrow {\mathit{nt}}
...
{\mathit{C}} \vdash {\mathit{nt}}.\mathsf{store}~{{\mathit{n}}^?}~{\mathit{memop}} : \mathsf{i{\scriptstyle32}}~{\mathit{nt}} \rightarrow \epsilon
