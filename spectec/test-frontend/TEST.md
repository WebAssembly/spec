...
```sh
$ (../src/exe-watsup/main.exe ../../../../specification/wasm-3.0/*.watsup -v -l --print-il --print-no-pos --check)
watsup 0.5 generator
== Parsing...
== Elaboration...

;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup
syntax NULL =
  | NULL
...
;; ../../../../specification/wasm-3.0/0.1-aux.vars.watsup
syntax N = nat
...
;; ../../../../specification/wasm-3.0/0.2-aux.num.watsup
...
;; ../../../../specification/wasm-3.0/0.2-aux.num.watsup:9.1-9.56
def $sum(nat*) : nat
  ;; ../../../../specification/wasm-3.0/0.2-aux.num.watsup:10.1-10.18
  def $sum([]) = 0
  ;; ../../../../specification/wasm-3.0/0.2-aux.num.watsup:11.1-11.35
...
;; ../../../../specification/wasm-3.0/0.2-aux.num.watsup:13.1-13.57
def $prod(nat*) : nat
  ;; ../../../../specification/wasm-3.0/0.2-aux.num.watsup:14.1-14.19
  def $prod([]) = 1
  ;; ../../../../specification/wasm-3.0/0.2-aux.num.watsup:15.1-15.37
  def $prod{n : n, `n'*` : n*}([n] ++ n'*{n' <- `n'*`}) = (n * $prod(n'*{n' <- `n'*`}))
}

;; ../../../../specification/wasm-3.0/0.3-aux.seq.watsup
...
;; ../../../../specification/wasm-3.0/0.3-aux.seq.watsup:14.1-14.55
def $concat_(syntax X, X**) : X*
  ;; ../../../../specification/wasm-3.0/0.3-aux.seq.watsup:15.1-15.34
  def $concat_{syntax X}(syntax X, []) = []
  ;; ../../../../specification/wasm-3.0/0.3-aux.seq.watsup:16.1-16.64
...
;; ../../../../specification/wasm-3.0/0.3-aux.seq.watsup:18.1-18.61
def $concatn_(syntax X, X**, nat : nat) : X*
  ;; ../../../../specification/wasm-3.0/0.3-aux.seq.watsup:19.1-19.38
  def $concatn_{syntax X, n : n}(syntax X, [], n) = []
  ;; ../../../../specification/wasm-3.0/0.3-aux.seq.watsup:20.1-20.73
...
;; ../../../../specification/wasm-3.0/0.3-aux.seq.watsup:25.1-25.78
def $disjoint_(syntax X, X*) : bool
  ;; ../../../../specification/wasm-3.0/0.3-aux.seq.watsup:26.1-26.37
  def $disjoint_{syntax X}(syntax X, []) = true
  ;; ../../../../specification/wasm-3.0/0.3-aux.seq.watsup:27.1-27.68
...
;; ../../../../specification/wasm-3.0/0.3-aux.seq.watsup:30.1-30.38
def $setminus1_(syntax X, X : X, X*) : X*
  ;; ../../../../specification/wasm-3.0/0.3-aux.seq.watsup:34.1-34.38
  def $setminus1_{syntax X, w : X}(syntax X, w, []) = [w]
  ;; ../../../../specification/wasm-3.0/0.3-aux.seq.watsup:35.1-35.78
  def $setminus1_{syntax X, w : X, w_1 : X, `w'*` : X*}(syntax X, w, [w_1] ++ w'*{w' <- `w'*`}) = []
    -- if (w = w_1)
  ;; ../../../../specification/wasm-3.0/0.3-aux.seq.watsup:36.1-36.77
...
;; ../../../../specification/wasm-3.0/0.3-aux.seq.watsup:29.1-29.56
def $setminus_(syntax X, X*, X*) : X*
  ;; ../../../../specification/wasm-3.0/0.3-aux.seq.watsup:32.1-32.40
  def $setminus_{syntax X, `w*` : X*}(syntax X, [], w*{w <- `w*`}) = []
  ;; ../../../../specification/wasm-3.0/0.3-aux.seq.watsup:33.1-33.90
...
;; ../../../../specification/wasm-3.0/0.3-aux.seq.watsup:41.1-41.46
def $setproduct2_(syntax X, X : X, X**) : X**
  ;; ../../../../specification/wasm-3.0/0.3-aux.seq.watsup:47.1-47.44
  def $setproduct2_{syntax X, w_1 : X}(syntax X, w_1, []) = []
  ;; ../../../../specification/wasm-3.0/0.3-aux.seq.watsup:48.1-48.90
...
;; ../../../../specification/wasm-3.0/0.3-aux.seq.watsup:40.1-40.47
def $setproduct1_(syntax X, X*, X**) : X**
  ;; ../../../../specification/wasm-3.0/0.3-aux.seq.watsup:45.1-45.46
  def $setproduct1_{syntax X, `w**` : X**}(syntax X, [], w*{w <- `w*`}*{`w*` <- `w**`}) = []
  ;; ../../../../specification/wasm-3.0/0.3-aux.seq.watsup:46.1-46.107
...
;; ../../../../specification/wasm-3.0/0.3-aux.seq.watsup:39.1-39.82
def $setproduct_(syntax X, X**) : X**
  ;; ../../../../specification/wasm-3.0/0.3-aux.seq.watsup:43.1-43.40
  def $setproduct_{syntax X}(syntax X, []) = [[]]
  ;; ../../../../specification/wasm-3.0/0.3-aux.seq.watsup:44.1-44.90
...
;; ../../../../specification/wasm-3.0/1.0-syntax.profiles.watsup
def $ND : bool

;; ../../../../specification/wasm-3.0/1.1-syntax.values.watsup
syntax bit =
  | `%`{i : nat}(i : nat)
    -- if ((i = 0) \/ (i = 1))
...
;; ../../../../specification/wasm-3.0/5.1-binary.values.watsup
...
;; ../../../../specification/wasm-3.0/1.1-syntax.values.watsup:89.1-89.25
def $utf8(char*) : byte*
  ;; ../../../../specification/wasm-3.0/5.1-binary.values.watsup:48.1-48.44
  def $utf8{`ch*` : char*}(ch*{ch <- `ch*`}) = $concat_(syntax byte, $utf8([ch])*{ch <- `ch*`})
  ;; ../../../../specification/wasm-3.0/5.1-binary.values.watsup:49.1-51.15
  def $utf8{ch : char, b : byte}([ch]) = [b]
    -- if (ch!`%`_char.0 < 128)
    -- if (`%`_byte(ch!`%`_char.0) = b)
  ;; ../../../../specification/wasm-3.0/5.1-binary.values.watsup:52.1-54.46
  ...
  ;; ../../../../specification/wasm-3.0/5.1-binary.values.watsup:55.1-57.64
  ...
  ;; ../../../../specification/wasm-3.0/5.1-binary.values.watsup:58.1-60.82
...
;; ../../../../specification/wasm-3.0/1.1-syntax.values.watsup:127.1-127.86
def $funcsxx(externidx*) : typeidx*
  ;; ../../../../specification/wasm-3.0/1.1-syntax.values.watsup:133.1-133.24
  def $funcsxx([]) = []
  ;; ../../../../specification/wasm-3.0/1.1-syntax.values.watsup:134.1-134.45
  def $funcsxx{x : idx, `xx*` : externidx*}([FUNC_externidx(x)] ++ xx*{xx <- `xx*`}) = [x] ++ $funcsxx(xx*{xx <- `xx*`})
  ;; ../../../../specification/wasm-3.0/1.1-syntax.values.watsup:135.1-135.58
...
;; ../../../../specification/wasm-3.0/1.1-syntax.values.watsup:128.1-128.88
def $globalsxx(externidx*) : globalidx*
  ;; ../../../../specification/wasm-3.0/1.1-syntax.values.watsup:137.1-137.26
  def $globalsxx([]) = []
  ;; ../../../../specification/wasm-3.0/1.1-syntax.values.watsup:138.1-138.51
  def $globalsxx{x : idx, `xx*` : externidx*}([GLOBAL_externidx(x)] ++ xx*{xx <- `xx*`}) = [x] ++ $globalsxx(xx*{xx <- `xx*`})
  ;; ../../../../specification/wasm-3.0/1.1-syntax.values.watsup:139.1-139.62
...
;; ../../../../specification/wasm-3.0/1.1-syntax.values.watsup:129.1-129.87
def $tablesxx(externidx*) : tableidx*
  ;; ../../../../specification/wasm-3.0/1.1-syntax.values.watsup:141.1-141.25
  def $tablesxx([]) = []
  ;; ../../../../specification/wasm-3.0/1.1-syntax.values.watsup:142.1-142.48
  def $tablesxx{x : idx, `xx*` : externidx*}([TABLE_externidx(x)] ++ xx*{xx <- `xx*`}) = [x] ++ $tablesxx(xx*{xx <- `xx*`})
  ;; ../../../../specification/wasm-3.0/1.1-syntax.values.watsup:143.1-143.60
...
;; ../../../../specification/wasm-3.0/1.1-syntax.values.watsup:130.1-130.85
def $memsxx(externidx*) : memidx*
  ;; ../../../../specification/wasm-3.0/1.1-syntax.values.watsup:145.1-145.23
  def $memsxx([]) = []
  ;; ../../../../specification/wasm-3.0/1.1-syntax.values.watsup:146.1-146.42
  def $memsxx{x : idx, `xx*` : externidx*}([MEM_externidx(x)] ++ xx*{xx <- `xx*`}) = [x] ++ $memsxx(xx*{xx <- `xx*`})
  ;; ../../../../specification/wasm-3.0/1.1-syntax.values.watsup:147.1-147.56
...
;; ../../../../specification/wasm-3.0/1.1-syntax.values.watsup:131.1-131.85
def $tagsxx(externidx*) : tagidx*
  ;; ../../../../specification/wasm-3.0/1.1-syntax.values.watsup:149.1-149.23
  def $tagsxx([]) = []
  ;; ../../../../specification/wasm-3.0/1.1-syntax.values.watsup:150.1-150.42
  def $tagsxx{x : idx, `xx*` : externidx*}([TAG_externidx(x)] ++ xx*{xx <- `xx*`}) = [x] ++ $tagsxx(xx*{xx <- `xx*`})
  ;; ../../../../specification/wasm-3.0/1.1-syntax.values.watsup:151.1-151.56
...
;; ../../../../specification/wasm-3.0/1.1-syntax.values.watsup:170.1-170.29
def $free_list(free*) : free
  ;; ../../../../specification/wasm-3.0/1.1-syntax.values.watsup:175.1-175.25
  def $free_list([]) = {TYPES [], FUNCS [], GLOBALS [], TABLES [], MEMS [], ELEMS [], DATAS [], LOCALS [], LABELS []}
  ;; ../../../../specification/wasm-3.0/1.1-syntax.values.watsup:176.1-176.57
...
;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:39.1-40.28
syntax typeuse =
  | _IDX{typeidx : typeidx}(typeidx : typeidx)
  | DEF{rectype : rectype, n : n}(rectype : rectype, n : n)
  | REC{nat : nat}(nat : nat)

;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:45.1-46.26
syntax heaptype =
  | ANY
  | EQ
  | I31
...
;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:53.1-54.14
syntax valtype =
  | I32
  | I64
  | F32
...
;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:94.1-94.66
syntax storagetype =
  | BOT
  | I32
  | I64
...
;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:104.1-105.16
syntax resulttype = list(syntax valtype)

;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:117.1-117.60
syntax fieldtype =
  | `%%`{mut : mut, storagetype : storagetype}(mut : mut, storagetype : storagetype)

;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:119.1-119.90
syntax functype =
  | `%->%`{resulttype : resulttype}(resulttype : resulttype, resulttype)

;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:120.1-120.64
syntax structtype = list(syntax fieldtype)

;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:121.1-121.54
syntax arraytype = fieldtype

;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:123.1-126.18
syntax comptype =
...
;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:128.1-129.30
syntax subtype =
  | SUB{fin : fin, `typeuse*` : typeuse*, comptype : comptype}(fin : fin, typeuse*{typeuse <- `typeuse*`} : typeuse*, comptype : comptype)

;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:131.1-132.22
syntax rectype =
...
;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:293.1-293.88
def $funcsxt(externtype*) : deftype*
  ;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:299.1-299.24
  def $funcsxt([]) = []
  ;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:300.1-300.47
  def $funcsxt{dt : deftype, `xt*` : externtype*}([FUNC_externtype((dt : deftype <: typeuse))] ++ xt*{xt <- `xt*`}) = [dt] ++ $funcsxt(xt*{xt <- `xt*`})
  ;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:301.1-301.59
...
;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:294.1-294.90
def $globalsxt(externtype*) : globaltype*
  ;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:303.1-303.26
  def $globalsxt([]) = []
  ;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:304.1-304.53
  def $globalsxt{gt : globaltype, `xt*` : externtype*}([GLOBAL_externtype(gt)] ++ xt*{xt <- `xt*`}) = [gt] ++ $globalsxt(xt*{xt <- `xt*`})
  ;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:305.1-305.63
...
;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:295.1-295.89
def $tablesxt(externtype*) : tabletype*
  ;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:307.1-307.25
  def $tablesxt([]) = []
  ;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:308.1-308.50
  def $tablesxt{tt : tabletype, `xt*` : externtype*}([TABLE_externtype(tt)] ++ xt*{xt <- `xt*`}) = [tt] ++ $tablesxt(xt*{xt <- `xt*`})
  ;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:309.1-309.61
...
;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:296.1-296.87
def $memsxt(externtype*) : memtype*
  ;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:311.1-311.23
  def $memsxt([]) = []
  ;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:312.1-312.44
  def $memsxt{mt : memtype, `xt*` : externtype*}([MEM_externtype(mt)] ++ xt*{xt <- `xt*`}) = [mt] ++ $memsxt(xt*{xt <- `xt*`})
  ;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:313.1-313.57
...
;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:297.1-297.87
def $tagsxt(externtype*) : tagtype*
  ;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:315.1-315.23
  def $tagsxt([]) = []
  ;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:316.1-316.44
  def $tagsxt{jt : tagtype, `xt*` : externtype*}([TAG_externtype((jt : deftype <: typeuse))] ++ xt*{xt <- `xt*`}) = [jt] ++ $tagsxt(xt*{xt <- `xt*`})
  ;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:317.1-317.57
...
;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:322.1-322.112
def $subst_typevar(typevar : typevar, typevar*, typeuse*) : typeuse
  ;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:351.1-351.38
  def $subst_typevar{tv : typevar}(tv, [], []) = (tv : typevar <: typeuse)
  ;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:352.1-352.95
  def $subst_typevar{tv : typevar, tv_1 : typevar, `tv'*` : typevar*, tu_1 : typeuse, `tu'*` : typeuse*}(tv, [tv_1] ++ tv'*{tv' <- `tv'*`}, [tu_1] ++ tu'*{tu' <- `tu'*`}) = tu_1
    -- if (tv = tv_1)
  ;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:353.1-353.92
...
;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:323.1-323.112
def $subst_typeuse(typeuse : typeuse, typevar*, typeuse*) : typeuse
  ;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:355.1-355.66
  ...
  ;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:356.1-356.64
...
;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:328.1-328.112
def $subst_heaptype(heaptype : heaptype, typevar*, typeuse*) : heaptype
  ;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:362.1-362.67
  ...
  ;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:363.1-363.65
  ...
  ;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:364.1-364.53
  def $subst_heaptype{ht : heaptype, `tv*` : typevar*, `tu*` : typeuse*}(ht, tv*{tv <- `tv*`}, tu*{tu <- `tu*`}) = ht
    -- otherwise

;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:329.1-329.112
def $subst_reftype(reftype : reftype, typevar*, typeuse*) : reftype
  ;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:366.1-366.83
...
;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:330.1-330.112
def $subst_valtype(valtype : valtype, typevar*, typeuse*) : valtype
  ;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:368.1-368.64
  ...
  ;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:369.1-369.64
  ...
  ;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:370.1-370.64
  ...
  ;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:371.1-371.40
  def $subst_valtype{`tv*` : typevar*, `tu*` : typeuse*}(BOT_valtype, tv*{tv <- `tv*`}, tu*{tu <- `tu*`}) = BOT_valtype

;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:333.1-333.112
def $subst_storagetype(storagetype : storagetype, typevar*, typeuse*) : storagetype
  ;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:375.1-375.66
  ...
  ;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:376.1-376.69
...
;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:334.1-334.112
def $subst_fieldtype(fieldtype : fieldtype, typevar*, typeuse*) : fieldtype
  ;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:378.1-378.80
...
;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:336.1-336.112
def $subst_comptype(comptype : comptype, typevar*, typeuse*) : comptype
  ;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:380.1-380.85
  ...
  ;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:381.1-381.81
  ...
  ;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:382.1-382.78
...
;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:337.1-337.112
def $subst_subtype(subtype : subtype, typevar*, typeuse*) : subtype
  ;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:384.1-385.71
...
;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:338.1-338.112
def $subst_rectype(rectype : rectype, typevar*, typeuse*) : rectype
  ;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:387.1-387.76
...
;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:339.1-339.112
def $subst_deftype(deftype : deftype, typevar*, typeuse*) : deftype
  ;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:389.1-389.78
...
;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:342.1-342.112
def $subst_functype(functype : functype, typevar*, typeuse*) : functype
  ;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:392.1-392.113
...
;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:424.1-424.98
def $subst_all_deftypes(deftype*, heaptype*) : deftype*
  ;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:425.1-425.40
  def $subst_all_deftypes{`tu*` : typeuse*}([], (tu : typeuse <: heaptype)*{tu <- `tu*`}) = []
  ;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:426.1-426.101
...
;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:467.1-467.38
def $free_arraytype(arraytype : arraytype) : free
  ;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:530.1-530.60
  def $free_arraytype{fieldtype : fieldtype}(fieldtype) = $free_fieldtype(fieldtype)

;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:468.1-468.36
def $free_functype(functype : functype) : free
  ;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:525.1-526.67
...
;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:469.1-469.36
def $free_comptype(comptype : comptype) : free
  ;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:532.1-532.69
  def $free_comptype{structtype : structtype}(STRUCT_comptype(structtype)) = $free_structtype(structtype)
  ;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:533.1-533.65
  def $free_comptype{arraytype : arraytype}(ARRAY_comptype(arraytype)) = $free_arraytype(arraytype)
  ;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:534.1-534.61
  def $free_comptype{functype : functype}(FUNC_comptype(functype)) = $free_functype(functype)

;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:470.1-470.34
def $free_subtype(subtype : subtype) : free
  ;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:536.1-537.66
...
;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:471.1-471.34
def $free_rectype(rectype : rectype) : free
  ;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:539.1-539.70
...
;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:499.1-499.34
def $free_deftype(deftype : deftype) : free
  ;; ../../../../specification/wasm-3.0/1.2-syntax.types.watsup:500.1-500.58
...
;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup
...
;; ../../../../specification/wasm-3.0/4.0-execution.configurations.watsup
syntax addr = nat
...
;; ../../../../specification/wasm-3.0/4.0-execution.configurations.watsup:35.1-42.23
syntax addrref =
...
;; ../../../../specification/wasm-3.0/4.0-execution.configurations.watsup:136.1-142.9
syntax instr =
  | NOP
  | UNREACHABLE
  | DROP
...
;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:575.1-575.44
def $shift_labelidxs(labelidx*) : labelidx*
  ;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:576.1-576.32
  def $shift_labelidxs([]) = []
  ;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:577.1-577.66
  def $shift_labelidxs{`labelidx'*` : labelidx*}([`%`_labelidx(0)] ++ labelidx'*{labelidx' <- `labelidx'*`}) = $shift_labelidxs(labelidx'*{labelidx' <- `labelidx'*`})
  ;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:578.1-578.91
...
;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:422.1-422.30
def $free_instr(instr : instr) : free
  ;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:433.1-433.26
  def $free_instr(NOP_instr) = {TYPES [], FUNCS [], GLOBALS [], TABLES [], MEMS [], ELEMS [], DATAS [], LOCALS [], LABELS []}
  ;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:434.1-434.34
  def $free_instr(UNREACHABLE_instr) = {TYPES [], FUNCS [], GLOBALS [], TABLES [], MEMS [], ELEMS [], DATAS [], LOCALS [], LABELS []}
  ;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:435.1-435.27
  def $free_instr(DROP_instr) = {TYPES [], FUNCS [], GLOBALS [], TABLES [], MEMS [], ELEMS [], DATAS [], LOCALS [], LABELS []}
  ;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:436.1-436.86
  ...
  ;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:438.1-438.92
  ...
  ;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:439.1-439.91
  ...
  ;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:440.1-441.79
  ...
  ;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:443.1-443.56
  def $free_instr{labelidx : labelidx}(BR_instr(labelidx)) = $free_labelidx(labelidx)
  ;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:444.1-444.59
  def $free_instr{labelidx : labelidx}(BR_IF_instr(labelidx)) = $free_labelidx(labelidx)
  ;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:445.1-446.68
  ...
  ;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:447.1-447.64
  def $free_instr{labelidx : labelidx}(BR_ON_NULL_instr(labelidx)) = $free_labelidx(labelidx)
  ;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:448.1-448.68
  def $free_instr{labelidx : labelidx}(BR_ON_NON_NULL_instr(labelidx)) = $free_labelidx(labelidx)
  ;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:449.1-450.83
  ...
  ;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:451.1-452.83
  ...
  ;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:454.1-454.55
  def $free_instr{funcidx : funcidx}(CALL_instr(funcidx)) = $free_funcidx(funcidx)
  ;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:455.1-455.59
  def $free_instr{typeuse : typeuse}(CALL_REF_instr(typeuse)) = $free_typeuse(typeuse)
  ;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:456.1-457.53
  ...
  ;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:458.1-458.29
  def $free_instr(RETURN_instr) = {TYPES [], FUNCS [], GLOBALS [], TABLES [], MEMS [], ELEMS [], DATAS [], LOCALS [], LABELS []}
  ;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:459.1-459.62
  def $free_instr{funcidx : funcidx}(RETURN_CALL_instr(funcidx)) = $free_funcidx(funcidx)
  ;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:460.1-460.66
  def $free_instr{typeuse : typeuse}(RETURN_CALL_REF_instr(typeuse)) = $free_typeuse(typeuse)
  ;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:461.1-462.53
  ...
  ;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:488.1-489.49
  ...
  ;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:490.1-491.49
  ...
  ;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:492.1-493.47
  ...
  ;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:519.1-520.51
  ...
  ;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:521.1-521.64
  def $free_instr{`sx?` : sx?, typeidx : typeidx}(ARRAY.GET_instr(sx?{sx <- `sx?`}, typeidx)) = $free_typeidx(typeidx)
  ;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:522.1-522.60
  def $free_instr{typeidx : typeidx}(ARRAY.SET_instr(typeidx)) = $free_typeidx(typeidx)
  ;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:523.1-523.32
  def $free_instr(ARRAY.LEN_instr) = {TYPES [], FUNCS [], GLOBALS [], TABLES [], MEMS [], ELEMS [], DATAS [], LOCALS [], LABELS []}
  ;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:524.1-524.61
  def $free_instr{typeidx : typeidx}(ARRAY.FILL_instr(typeidx)) = $free_typeidx(typeidx)
  ;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:525.1-526.55
  ...
  ;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:527.1-528.51
  ...
  ;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:529.1-530.51
  ...
  ;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:549.1-550.53
  ...
  ;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:551.1-551.60
  def $free_instr{elemidx : elemidx}(ELEM.DROP_instr(elemidx)) = $free_elemidx(elemidx)
  ;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:553.1-554.49
  ...
  ;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:555.1-556.49
  ...
  ;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:557.1-558.49
  ...
  ;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:559.1-560.49
  ...
  ;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:561.1-562.49
  ...
  ;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:563.1-564.49
  ...
  ;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:565.1-565.59
  def $free_instr{memidx : memidx}(MEMORY.SIZE_instr(memidx)) = $free_memidx(memidx)
  ;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:566.1-566.59
  def $free_instr{memidx : memidx}(MEMORY.GROW_instr(memidx)) = $free_memidx(memidx)
  ;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:567.1-567.59
  def $free_instr{memidx : memidx}(MEMORY.FILL_instr(memidx)) = $free_memidx(memidx)
  ;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:568.1-569.51
  ...
  ;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:570.1-571.49
  def $free_instr{memidx : memidx, dataidx : dataidx}(MEMORY.INIT_instr(memidx, dataidx)) = $free_memidx(memidx) +++ $free_dataidx(dataidx)
  ;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:572.1-572.60
  def $free_instr{dataidx : dataidx}(DATA.DROP_instr(dataidx)) = $free_dataidx(dataidx)

;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:423.1-423.31
def $free_block(instr*) : free
  ;; ../../../../specification/wasm-3.0/1.3-syntax.instructions.watsup:580.1-581.47
...
;; ../../../../specification/wasm-3.0/1.4-syntax.modules.watsup
syntax elemmode =
...
;; ../../../../specification/wasm-3.0/2.0-validation.contexts.watsup
syntax init =
  | SET
  | UNSET
...
;; ../../../../specification/wasm-3.0/2.0-validation.contexts.watsup:46.1-46.86
def $with_locals(context : context, localidx*, localtype*) : context
  ;; ../../../../specification/wasm-3.0/2.0-validation.contexts.watsup:48.1-48.34
  def $with_locals{C : context}(C, [], []) = C
  ;; ../../../../specification/wasm-3.0/2.0-validation.contexts.watsup:49.1-49.90
...
;; ../../../../specification/wasm-3.0/2.0-validation.contexts.watsup:57.1-57.94
def $clos_deftypes(deftype*) : deftype*
  ;; ../../../../specification/wasm-3.0/2.0-validation.contexts.watsup:64.1-64.30
  def $clos_deftypes([]) = []
  ;; ../../../../specification/wasm-3.0/2.0-validation.contexts.watsup:65.1-65.101
...
;; ../../../../specification/wasm-3.0/2.1-validation.types.watsup
...
;; ../../../../specification/wasm-3.0/2.2-validation.subtyping.watsup
...
relation Comptype_ok: `%|-%:OK`(context, comptype)
  ...
  ;; ../../../../specification/wasm-3.0/2.1-validation.types.watsup:131.1-133.39
  rule array{C : context, fieldtype : fieldtype}:
    `%|-%:OK`(C, ARRAY_comptype(fieldtype))
    -- Fieldtype_ok: `%|-%:OK`(C, fieldtype)

  ;; ../../../../specification/wasm-3.0/2.1-validation.types.watsup:135.1-137.37
  rule func{C : context, functype : functype}:
    `%|-%:OK`(C, FUNC_comptype(functype))
    -- Functype_ok: `%|-%:OK`(C, functype)

;; ../../../../specification/wasm-3.0/2.1-validation.types.watsup:86.1-86.103
relation Functype_ok: `%|-%:OK`(context, functype)
  ;; ../../../../specification/wasm-3.0/2.1-validation.types.watsup:211.1-214.35
...
;; ../../../../specification/wasm-3.0/2.1-validation.types.watsup:87.1-87.123
relation Subtype_ok: `%|-%:%`(context, subtype, oktypeidx)
  ;; ../../../../specification/wasm-3.0/2.1-validation.types.watsup:140.1-147.49
...
;; ../../../../specification/wasm-3.0/2.1-validation.types.watsup:88.1-88.123
relation Rectype_ok: `%|-%:%`(context, rectype, oktypeidx)
  ;; ../../../../specification/wasm-3.0/2.1-validation.types.watsup:169.1-170.23
  rule empty{C : context, x : idx}:
    `%|-%:%`(C, REC_rectype(`%`_list([])), OK_oktypeidx(x))

  ;; ../../../../specification/wasm-3.0/2.1-validation.types.watsup:172.1-175.48
  ...
  ;; ../../../../specification/wasm-3.0/2.1-validation.types.watsup:177.1-179.60
...
;; ../../../../specification/wasm-3.0/2.1-validation.types.watsup:89.1-89.126
relation Subtype_ok2: `%|-%:%`(context, subtype, oktypeidxnat)
  ;; ../../../../specification/wasm-3.0/2.1-validation.types.watsup:159.1-166.49
...
;; ../../../../specification/wasm-3.0/2.1-validation.types.watsup:90.1-90.126
relation Rectype_ok2: `%|-%:%`(context, rectype, oktypeidxnat)
  ;; ../../../../specification/wasm-3.0/2.1-validation.types.watsup:181.1-182.24
  rule empty{C : context, x : idx, i : nat}:
    `%|-%:%`(C, REC_rectype(`%`_list([])), OK_oktypeidxnat(x, i))

  ;; ../../../../specification/wasm-3.0/2.1-validation.types.watsup:184.1-187.55
...
;; ../../../../specification/wasm-3.0/2.1-validation.types.watsup:91.1-91.102
relation Deftype_ok: `%|-%:OK`(context, deftype)
  ;; ../../../../specification/wasm-3.0/2.1-validation.types.watsup:190.1-194.14
...
;; ../../../../specification/wasm-3.0/2.1-validation.types.watsup:94.1-94.108
relation Comptype_sub: `%|-%<:%`(context, comptype, comptype)
  ;; ../../../../specification/wasm-3.0/2.2-validation.subtyping.watsup:166.1-168.41
...
relation Deftype_sub: `%|-%<:%`(context, deftype, deftype)
  ...
  ;; ../../../../specification/wasm-3.0/2.2-validation.subtyping.watsup:183.1-186.49
...
;; ../../../../specification/wasm-3.0/2.2-validation.subtyping.watsup:9.1-9.104
relation Heaptype_sub: `%|-%<:%`(context, heaptype, heaptype)
  ;; ../../../../specification/wasm-3.0/2.2-validation.subtyping.watsup:20.1-21.28
  rule refl{C : context, heaptype : heaptype}:
    `%|-%<:%`(C, heaptype, heaptype)

  ;; ../../../../specification/wasm-3.0/2.2-validation.subtyping.watsup:23.1-27.48
  ...
  ;; ../../../../specification/wasm-3.0/2.2-validation.subtyping.watsup:29.1-30.17
  rule `eq-any`{C : context}:
    `%|-%<:%`(C, EQ_heaptype, ANY_heaptype)

  ;; ../../../../specification/wasm-3.0/2.2-validation.subtyping.watsup:32.1-33.17
  rule `i31-eq`{C : context}:
    `%|-%<:%`(C, I31_heaptype, EQ_heaptype)

  ;; ../../../../specification/wasm-3.0/2.2-validation.subtyping.watsup:35.1-36.20
  rule `struct-eq`{C : context}:
    `%|-%<:%`(C, STRUCT_heaptype, EQ_heaptype)

  ;; ../../../../specification/wasm-3.0/2.2-validation.subtyping.watsup:38.1-39.19
  rule `array-eq`{C : context}:
    `%|-%<:%`(C, ARRAY_heaptype, EQ_heaptype)

  ;; ../../../../specification/wasm-3.0/2.2-validation.subtyping.watsup:41.1-43.42
  ...
  ;; ../../../../specification/wasm-3.0/2.2-validation.subtyping.watsup:45.1-47.40
  ...
  ;; ../../../../specification/wasm-3.0/2.2-validation.subtyping.watsup:49.1-51.38
  ...
  ;; ../../../../specification/wasm-3.0/2.2-validation.subtyping.watsup:53.1-55.46
  ...
  ;; ../../../../specification/wasm-3.0/2.2-validation.subtyping.watsup:57.1-59.53
  ...
  ;; ../../../../specification/wasm-3.0/2.2-validation.subtyping.watsup:61.1-63.53
  ...
  ;; ../../../../specification/wasm-3.0/2.2-validation.subtyping.watsup:65.1-67.40
...
relation Valtype_sub: `%|-%<:%`(context, valtype, valtype)
  ...
  ;; ../../../../specification/wasm-3.0/2.2-validation.subtyping.watsup:102.1-104.46
  ...
  ;; ../../../../specification/wasm-3.0/2.2-validation.subtyping.watsup:106.1-108.46
  ...
  ;; ../../../../specification/wasm-3.0/2.2-validation.subtyping.watsup:110.1-111.22
  rule bot{C : context, valtype : valtype}:
    `%|-%<:%`(C, BOT_valtype, valtype)

;; ../../../../specification/wasm-3.0/2.2-validation.subtyping.watsup:116.1-116.115
relation Resulttype_sub: `%|-%<:%`(context, resulttype, resulttype)
  ;; ../../../../specification/wasm-3.0/2.2-validation.subtyping.watsup:119.1-121.37
  rule _{C : context, `t_1*` : valtype*, `t_2*` : valtype*}:
    `%|-%<:%`(C, `%`_resulttype(t_1*{t_1 <- `t_1*`}), `%`_resulttype(t_2*{t_2 <- `t_2*`}))
    -- (Valtype_sub: `%|-%<:%`(C, t_1, t_2))*{t_1 <- `t_1*`, t_2 <- `t_2*`}

;; ../../../../specification/wasm-3.0/2.2-validation.subtyping.watsup:134.1-134.119
relation Storagetype_sub: `%|-%<:%`(context, storagetype, storagetype)
  ;; ../../../../specification/wasm-3.0/2.2-validation.subtyping.watsup:147.1-149.46
  ...
  ;; ../../../../specification/wasm-3.0/2.2-validation.subtyping.watsup:151.1-153.49
...
;; ../../../../specification/wasm-3.0/2.2-validation.subtyping.watsup:135.1-135.117
relation Fieldtype_sub: `%|-%<:%`(context, fieldtype, fieldtype)
  ;; ../../../../specification/wasm-3.0/2.2-validation.subtyping.watsup:156.1-158.40
  rule const{C : context, zt_1 : storagetype, zt_2 : storagetype}:
    `%|-%<:%`(C, `%%`_fieldtype(?(), zt_1), `%%`_fieldtype(?(), zt_2))
    -- Storagetype_sub: `%|-%<:%`(C, zt_1, zt_2)

  ;; ../../../../specification/wasm-3.0/2.2-validation.subtyping.watsup:160.1-163.40
...
;; ../../../../specification/wasm-3.0/2.2-validation.subtyping.watsup:136.1-136.116
relation Functype_sub: `%|-%<:%`(context, functype, functype)
  ;; ../../../../specification/wasm-3.0/2.2-validation.subtyping.watsup:204.1-207.41
...
relation Externtype_ok: `%|-%:OK`(context, externtype)
  ;; ../../../../specification/wasm-3.0/2.1-validation.types.watsup
  rule func{C : context, typeuse : typeuse, functype : functype}:
...
;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup
...
;; ../../../../specification/wasm-3.0/4.1-execution.values.watsup
...
;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:5.1-5.95
relation Instr_ok: `%|-%:%`(context, instr, instrtype)
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:18.1-19.24
  rule nop{C : context}:
    `%|-%:%`(C, NOP_instr, `%->_%%`_instrtype(`%`_resulttype([]), [], `%`_resulttype([])))

  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:21.1-23.42
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:25.1-27.29
  rule drop{C : context, t : valtype}:
    `%|-%:%`(C, DROP_instr, `%->_%%`_instrtype(`%`_resulttype([t]), [], `%`_resulttype([])))
    -- Valtype_ok: `%|-%:OK`(C, t)

  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:30.1-32.29
  rule `select-expl`{C : context, t : valtype}:
    `%|-%:%`(C, SELECT_instr(?([t])), `%->_%%`_instrtype(`%`_resulttype([t t I32_valtype]), [], `%`_resulttype([t])))
    -- Valtype_ok: `%|-%:OK`(C, t)

  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:34.1-38.37
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:54.1-57.67
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:59.1-62.67
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:64.1-68.71
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:73.1-76.42
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:78.1-80.25
  rule br_if{C : context, l : labelidx, `t*` : valtype*}:
    `%|-%:%`(C, BR_IF_instr(l), `%->_%%`_instrtype(`%`_resulttype(t*{t <- `t*`} ++ [I32_valtype]), [], `%`_resulttype(t*{t <- `t*`})))
    -- if (C.LABELS_context[l!`%`_labelidx.0]!`%`_resulttype.0 = t*{t <- `t*`})

  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:82.1-86.49
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:88.1-91.31
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:93.1-95.34
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:97.1-103.34
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:105.1-111.49
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:116.1-118.47
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:120.1-122.47
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:124.1-128.47
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:130.1-133.42
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:136.1-141.42
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:144.1-149.42
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:152.1-160.42
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:167.1-170.42
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:172.1-174.42
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:176.1-180.34
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:203.1-204.33
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:206.1-207.34
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:209.1-210.39
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:212.1-213.39
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:215.1-216.40
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:218.1-219.44
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:224.1-226.31
  rule ref.null{C : context, ht : heaptype}:
    `%|-%:%`(C, REF.NULL_instr(ht), `%->_%%`_instrtype(`%`_resulttype([]), [], `%`_resulttype([REF_valtype(?(NULL_NULL), ht)])))
    -- Heaptype_ok: `%|-%:OK`(C, ht)

  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:228.1-231.20
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:233.1-234.34
  rule ref.i31{C : context}:
    `%|-%:%`(C, REF.I31_instr, `%->_%%`_instrtype(`%`_resulttype([I32_valtype]), [], `%`_resulttype([REF_valtype(?(), I31_heaptype)])))

  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:236.1-238.31
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:240.1-242.31
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:244.1-245.51
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:247.1-251.33
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:253.1-257.33
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:262.1-263.42
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:268.1-270.44
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:272.1-275.48
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:277.1-281.39
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:283.1-286.24
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:291.1-293.42
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:295.1-298.45
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:300.1-302.42
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:304.1-307.40
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:309.1-313.24
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:315.1-318.39
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:320.1-322.42
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:324.1-325.43
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:327.1-329.42
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:331.1-335.40
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:337.1-340.44
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:342.1-346.24
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:351.1-353.20
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:355.1-357.20
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:362.1-363.35
  rule vconst{C : context, c : vec_(V128_Vnn)}:
    `%|-%:%`(C, VCONST_instr(V128_vectype, c), `%->_%%`_instrtype(`%`_resulttype([]), [], `%`_resulttype([V128_valtype])))

  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:365.1-366.41
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:368.1-369.48
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:371.1-372.55
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:374.1-375.44
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:377.1-378.37
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:380.1-381.44
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:383.1-384.51
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:386.1-387.40
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:389.1-390.44
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:392.1-393.47
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:395.1-396.33
  rule vbitmask{C : context, sh : ishape}:
    `%|-%:%`(C, VBITMASK_instr(sh), `%->_%%`_instrtype(`%`_resulttype([V128_valtype]), [], `%`_resulttype([I32_valtype])))

  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:398.1-399.50
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:401.1-403.29
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:405.1-406.44
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:408.1-410.21
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:412.1-414.21
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:416.1-417.50
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:419.1-420.57
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:422.1-423.64
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:425.1-426.48
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:428.1-429.58
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:434.1-436.28
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:438.1-440.29
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:442.1-444.29
  rule local.tee{C : context, x : idx, t : valtype, init : init}:
    `%|-%:%`(C, LOCAL.TEE_instr(x), `%->_%%`_instrtype(`%`_resulttype([t]), [x], `%`_resulttype([t])))
    -- if (C.LOCALS_context[x!`%`_idx.0] = `%%`_localtype(init, t))

  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:449.1-451.29
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:453.1-455.29
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:460.1-462.32
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:464.1-466.32
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:468.1-470.32
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:472.1-474.32
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:476.1-478.32
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:480.1-484.36
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:486.1-490.36
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:492.1-494.24
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:499.1-501.32
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:503.1-505.32
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:507.1-509.32
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:511.1-514.38
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:516.1-519.24
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:521.1-523.24
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:534.1-537.43
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:539.1-542.35
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:553.1-556.43
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:558.1-561.35
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:563.1-566.46
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:568.1-571.39
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:573.1-576.35
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:578.1-581.35
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:583.1-587.21
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:589.1-592.46
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:594.1-598.21
...
;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:6.1-6.96
relation Instrs_ok: `%|-%:%`(context, instr*, instrtype)
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:603.1-604.24
  rule empty{C : context}:
    `%|-%:%`(C, [], `%->_%%`_instrtype(`%`_resulttype([]), [], `%`_resulttype([])))

  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:607.1-611.82
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:613.1-617.33
  ...
  ;; ../../../../specification/wasm-3.0/2.3-validation.instructions.watsup:620.1-623.33
...
;; ../../../../specification/wasm-3.0/2.4-validation.modules.watsup
...
;; ../../../../specification/wasm-3.0/2.4-validation.modules.watsup:135.1-135.100
relation Globals_ok: `%|-%:%`(context, global*, globaltype*)
  ;; ../../../../specification/wasm-3.0/2.4-validation.modules.watsup:179.1-180.17
  rule empty{C : context}:
    `%|-%:%`(C, [], [])

  ;; ../../../../specification/wasm-3.0/2.4-validation.modules.watsup:182.1-185.54
...
;; ../../../../specification/wasm-3.0/2.4-validation.modules.watsup:134.1-134.98
relation Types_ok: `%|-%:%`(context, type*, deftype*)
  ;; ../../../../specification/wasm-3.0/2.4-validation.modules.watsup:171.1-172.17
  rule empty{C : context}:
    `%|-%:%`(C, [], [])

  ;; ../../../../specification/wasm-3.0/2.4-validation.modules.watsup:174.1-177.49
...
;; ../../../../specification/wasm-3.0/3.0-numerics.relaxed.watsup
syntax relaxed2 =
  | `%`{i : nat}(i : nat)
    -- if ((i = 0) \/ (i = 1))
...
;; ../../../../specification/wasm-3.0/3.1-numerics.scalar.watsup
...
;; ../../../../specification/wasm-3.0/3.2-numerics.vector.watsup
...
def $lcvtop__(shape_1 : shape, shape_2 : shape, vcvtop__ : vcvtop__(shape_1, shape_2), lane_ : lane_($lanetype(shape_1))) : lane_($lanetype(shape_2))*
  ;; ../../../../specification/wasm-3.0/3.2-numerics.vector.watsup
  def $lcvtop__{Jnn_1 : Jnn, M_1 : M, Jnn_2 : Jnn, M_2 : M, sx : sx, c_1 : lane_($lanetype(`%X%`_shape((Jnn_1 : Jnn <: lanetype), `%`_dim(M_1)))), c : iN($lsizenn2((Jnn_2 : Jnn <: lanetype)))}(`%X%`_shape((Jnn_1 : Jnn <: lanetype), `%`_dim(M_1)), `%X%`_shape((Jnn_2 : Jnn <: lanetype), `%`_dim(M_2)), EXTEND_vcvtop__(sx), c_1) = [c]
    -- if (c = $extend__($lsizenn1((Jnn_1 : Jnn <: lanetype)), $lsizenn2((Jnn_2 : Jnn <: lanetype)), sx, c_1))
  ;; ../../../../specification/wasm-3.0/3.2-numerics.vector.watsup
  def $lcvtop__{Jnn_1 : Jnn, M_1 : M, Fnn_2 : Fnn, M_2 : M, sx : sx, c_1 : lane_($lanetype(`%X%`_shape((Jnn_1 : Jnn <: lanetype), `%`_dim(M_1)))), c : fN($lsizenn2((Fnn_2 : Fnn <: lanetype)))}(`%X%`_shape((Jnn_1 : Jnn <: lanetype), `%`_dim(M_1)), `%X%`_shape((Fnn_2 : Fnn <: lanetype), `%`_dim(M_2)), CONVERT_vcvtop__(sx), c_1) = [c]
    -- if (c = $convert__($lsizenn1((Jnn_1 : Jnn <: lanetype)), $lsizenn2((Fnn_2 : Fnn <: lanetype)), sx, c_1))
  ;; ../../../../specification/wasm-3.0/3.2-numerics.vector.watsup
  def $lcvtop__{Fnn_1 : Fnn, M_1 : M, Inn_2 : Inn, M_2 : M, sx : sx, c_1 : lane_($lanetype(`%X%`_shape((Fnn_1 : Fnn <: lanetype), `%`_dim(M_1)))), `c?` : iN($lsizenn2((Inn_2 : Inn <: lanetype)))?}(`%X%`_shape((Fnn_1 : Fnn <: lanetype), `%`_dim(M_1)), `%X%`_shape((Inn_2 : Inn <: lanetype), `%`_dim(M_2)), TRUNC_SAT_vcvtop__(sx), c_1) = lift(c?{c <- `c?`})
    -- if (c?{c <- `c?`} = $trunc_sat__($lsizenn1((Fnn_1 : Fnn <: lanetype)), $lsizenn2((Inn_2 : Inn <: lanetype)), sx, c_1))
  ;; ../../../../specification/wasm-3.0/3.2-numerics.vector.watsup
  def $lcvtop__{Fnn_1 : Fnn, M_1 : M, Inn_2 : Inn, M_2 : M, sx : sx, c_1 : lane_($lanetype(`%X%`_shape((Fnn_1 : Fnn <: lanetype), `%`_dim(M_1)))), `c?` : iN($lsizenn2((Inn_2 : Inn <: lanetype)))?}(`%X%`_shape((Fnn_1 : Fnn <: lanetype), `%`_dim(M_1)), `%X%`_shape((Inn_2 : Inn <: lanetype), `%`_dim(M_2)), RELAXED_TRUNC_vcvtop__(sx), c_1) = lift(c?{c <- `c?`})
    -- if (c?{c <- `c?`} = $relaxed_trunc__($lsizenn1((Fnn_1 : Fnn <: lanetype)), $lsizenn2((Inn_2 : Inn <: lanetype)), sx, c_1))
  ;; ../../../../specification/wasm-3.0/3.2-numerics.vector.watsup
  def $lcvtop__{Fnn_1 : Fnn, M_1 : M, Fnn_2 : Fnn, M_2 : M, c_1 : lane_($lanetype(`%X%`_shape((Fnn_1 : Fnn <: lanetype), `%`_dim(M_1)))), `c*` : fN($lsizenn2((Fnn_2 : Fnn <: lanetype)))*}(`%X%`_shape((Fnn_1 : Fnn <: lanetype), `%`_dim(M_1)), `%X%`_shape((Fnn_2 : Fnn <: lanetype), `%`_dim(M_2)), DEMOTE_vcvtop__, c_1) = c*{c <- `c*`}
    -- if (c*{c <- `c*`} = $demote__($lsizenn1((Fnn_1 : Fnn <: lanetype)), $lsizenn2((Fnn_2 : Fnn <: lanetype)), c_1))
  ;; ../../../../specification/wasm-3.0/3.2-numerics.vector.watsup
  def $lcvtop__{Fnn_1 : Fnn, M_1 : M, Fnn_2 : Fnn, M_2 : M, c_1 : lane_($lanetype(`%X%`_shape((Fnn_1 : Fnn <: lanetype), `%`_dim(M_1)))), `c*` : fN($lsizenn2((Fnn_2 : Fnn <: lanetype)))*}(`%X%`_shape((Fnn_1 : Fnn <: lanetype), `%`_dim(M_1)), `%X%`_shape((Fnn_2 : Fnn <: lanetype), `%`_dim(M_2)), PROMOTE_vcvtop__, c_1) = c*{c <- `c*`}
...
def $vextbinop__(ishape_1 : ishape, ishape_2 : ishape, vextbinop__ : vextbinop__(ishape_1, ishape_2), vec_ : vec_(V128_Vnn), vec_ : vec_(V128_Vnn)) : vec_(V128_Vnn)
  ;; ../../../../specification/wasm-3.0/3.2-numerics.vector.watsup
  def $vextbinop__{Jnn_1 : Jnn, M_1 : M, Jnn_2 : Jnn, M_2 : M, sx : sx, half : half__(`%X%`_shape((Jnn_1 : Jnn <: lanetype), `%`_dim(M_1)), `%X%`_shape((Jnn_2 : Jnn <: lanetype), `%`_dim(M_2))), v_1 : vec_(V128_Vnn), v_2 : vec_(V128_Vnn), i : nat}(`%`_ishape(`%X%`_shape((Jnn_1 : Jnn <: lanetype), `%`_dim(M_1))), `%`_ishape(`%X%`_shape((Jnn_2 : Jnn <: lanetype), `%`_dim(M_2))), EXTMUL_vextbinop__(sx, half), v_1, v_2) = $ivextbinop__(`%X%`_shape((Jnn_1 : Jnn <: lanetype), `%`_dim(M_1)), `%X%`_shape((Jnn_2 : Jnn <: lanetype), `%`_dim(M_2)), def $ivmul_, sx, sx, `%`_laneidx(i), `%`_laneidx(M_2), v_1, v_2)
    -- if (i = $half__(`%X%`_shape((Jnn_1 : Jnn <: lanetype), `%`_dim(M_1)), `%X%`_shape((Jnn_2 : Jnn <: lanetype), `%`_dim(M_2)), half, 0, M_2))
  ;; ../../../../specification/wasm-3.0/3.2-numerics.vector.watsup
...
;; ../../../../specification/wasm-3.0/4.0-execution.configurations.watsup:193.1-193.87
def $funcsxa(externaddr*) : funcaddr*
  ;; ../../../../specification/wasm-3.0/4.0-execution.configurations.watsup:199.1-199.24
  def $funcsxa([]) = []
  ;; ../../../../specification/wasm-3.0/4.0-execution.configurations.watsup:200.1-200.45
  def $funcsxa{a : addr, `xa*` : externaddr*}([FUNC_externaddr(a)] ++ xa*{xa <- `xa*`}) = [a] ++ $funcsxa(xa*{xa <- `xa*`})
  ;; ../../../../specification/wasm-3.0/4.0-execution.configurations.watsup:201.1-201.59
...
;; ../../../../specification/wasm-3.0/4.0-execution.configurations.watsup:194.1-194.89
def $globalsxa(externaddr*) : globaladdr*
  ;; ../../../../specification/wasm-3.0/4.0-execution.configurations.watsup:203.1-203.26
  def $globalsxa([]) = []
  ;; ../../../../specification/wasm-3.0/4.0-execution.configurations.watsup:204.1-204.51
  def $globalsxa{a : addr, `xa*` : externaddr*}([GLOBAL_externaddr(a)] ++ xa*{xa <- `xa*`}) = [a] ++ $globalsxa(xa*{xa <- `xa*`})
  ;; ../../../../specification/wasm-3.0/4.0-execution.configurations.watsup:205.1-205.63
...
;; ../../../../specification/wasm-3.0/4.0-execution.configurations.watsup:195.1-195.88
def $tablesxa(externaddr*) : tableaddr*
  ;; ../../../../specification/wasm-3.0/4.0-execution.configurations.watsup:207.1-207.25
  def $tablesxa([]) = []
  ;; ../../../../specification/wasm-3.0/4.0-execution.configurations.watsup:208.1-208.48
  def $tablesxa{a : addr, `xa*` : externaddr*}([TABLE_externaddr(a)] ++ xa*{xa <- `xa*`}) = [a] ++ $tablesxa(xa*{xa <- `xa*`})
  ;; ../../../../specification/wasm-3.0/4.0-execution.configurations.watsup:209.1-209.61
...
;; ../../../../specification/wasm-3.0/4.0-execution.configurations.watsup:196.1-196.86
def $memsxa(externaddr*) : memaddr*
  ;; ../../../../specification/wasm-3.0/4.0-execution.configurations.watsup:211.1-211.23
  def $memsxa([]) = []
  ;; ../../../../specification/wasm-3.0/4.0-execution.configurations.watsup:212.1-212.42
  def $memsxa{a : addr, `xa*` : externaddr*}([MEM_externaddr(a)] ++ xa*{xa <- `xa*`}) = [a] ++ $memsxa(xa*{xa <- `xa*`})
  ;; ../../../../specification/wasm-3.0/4.0-execution.configurations.watsup:213.1-213.57
...
;; ../../../../specification/wasm-3.0/4.0-execution.configurations.watsup:197.1-197.86
def $tagsxa(externaddr*) : tagaddr*
  ;; ../../../../specification/wasm-3.0/4.0-execution.configurations.watsup:215.1-215.23
  def $tagsxa([]) = []
  ;; ../../../../specification/wasm-3.0/4.0-execution.configurations.watsup:216.1-216.42
  def $tagsxa{a : addr, `xa*` : externaddr*}([TAG_externaddr(a)] ++ xa*{xa <- `xa*`}) = [a] ++ $tagsxa(xa*{xa <- `xa*`})
  ;; ../../../../specification/wasm-3.0/4.0-execution.configurations.watsup:217.1-217.57
...
;; ../../../../specification/wasm-3.0/4.1-execution.values.watsup:25.1-25.60
relation Ref_ok: `%|-%:%`(store, ref, reftype)
  ;; ../../../../specification/wasm-3.0/4.1-execution.values.watsup:35.1-37.35
  ...
  ;; ../../../../specification/wasm-3.0/4.1-execution.values.watsup:39.1-40.33
  rule i31{s : store, i : u31}:
    `%|-%:%`(s, REF.I31_NUM_ref(i), REF_reftype(?(), I31_heaptype))

  ;; ../../../../specification/wasm-3.0/4.1-execution.values.watsup:42.1-44.31
  ...
  ;; ../../../../specification/wasm-3.0/4.1-execution.values.watsup:46.1-48.30
  ...
  ;; ../../../../specification/wasm-3.0/4.1-execution.values.watsup:50.1-52.29
  ...
  ;; ../../../../specification/wasm-3.0/4.1-execution.values.watsup:54.1-56.24
  rule exn{s : store, a : addr, exn : exninst}:
    `%|-%:%`(s, REF.EXN_ADDR_ref(a), REF_reftype(?(), EXN_heaptype))
    -- if (s.EXNS_store[a] = exn)

  ;; ../../../../specification/wasm-3.0/4.1-execution.values.watsup:58.1-59.35
  rule host{s : store, a : addr}:
    `%|-%:%`(s, REF.HOST_ADDR_ref(a), REF_reftype(?(), ANY_heaptype))

  ;; ../../../../specification/wasm-3.0/4.1-execution.values.watsup:61.1-63.38
  ...
  ;; ../../../../specification/wasm-3.0/4.1-execution.values.watsup:65.1-68.34
...
;; ../../../../specification/wasm-3.0/4.1-execution.values.watsup:86.1-86.84
relation Externaddr_ok: `%|-%:%`(store, externaddr, externtype)
  ;; ../../../../specification/wasm-3.0/4.1-execution.values.watsup:88.1-90.30
  ...
  ;; ../../../../specification/wasm-3.0/4.1-execution.values.watsup:92.1-94.34
  ...
  ;; ../../../../specification/wasm-3.0/4.1-execution.values.watsup:96.1-98.32
  ...
  ;; ../../../../specification/wasm-3.0/4.1-execution.values.watsup:100.1-102.28
  rule mem{s : store, a : addr, meminst : meminst}:
    `%|-%:%`(s, MEM_externaddr(a), MEM_externtype(meminst.TYPE_meminst))
    -- if (s.MEMS_store[a] = meminst)

  ;; ../../../../specification/wasm-3.0/4.1-execution.values.watsup:104.1-106.28
  ...
  ;; ../../../../specification/wasm-3.0/4.1-execution.values.watsup:108.1-111.37
...
;; ../../../../specification/wasm-3.0/4.2-execution.types.watsup
...
;; ../../../../specification/wasm-3.0/4.3-execution.instructions.watsup
...
;; ../../../../specification/wasm-3.0/4.3-execution.instructions.watsup:5.1-5.88
relation Step: `%~>%`(config, config)
  ;; ../../../../specification/wasm-3.0/4.3-execution.instructions.watsup:13.1-15.34
  ...
  ;; ../../../../specification/wasm-3.0/4.3-execution.instructions.watsup:17.1-19.37
  rule read{z : state, `instr*` : instr*, `instr'*` : instr*}:
    `%~>%`(`%;%`_config(z, instr*{instr <- `instr*`}), `%;%`_config(z, instr'*{instr' <- `instr'*`}))
    -- Step_read: `%~>%`(`%;%`_config(z, instr*{instr <- `instr*`}), instr'*{instr' <- `instr'*`})

  ;; ../../../../specification/wasm-3.0/4.3-execution.instructions.watsup:32.1-35.41
  ...
  ;; ../../../../specification/wasm-3.0/4.3-execution.instructions.watsup:37.1-39.36
  ...
  ;; ../../../../specification/wasm-3.0/4.3-execution.instructions.watsup:41.1-43.45
  ...
  ;; ../../../../specification/wasm-3.0/4.3-execution.instructions.watsup:227.1-231.49
  ...
  ;; ../../../../specification/wasm-3.0/4.3-execution.instructions.watsup:406.1-410.65
  ...
  ;; ../../../../specification/wasm-3.0/4.3-execution.instructions.watsup:426.1-427.53
  ...
  ;; ../../../../specification/wasm-3.0/4.3-execution.instructions.watsup:429.1-431.45
  ...
  ;; ../../../../specification/wasm-3.0/4.3-execution.instructions.watsup:444.1-449.65
  ...
  ;; ../../../../specification/wasm-3.0/4.3-execution.instructions.watsup:489.1-490.64
  ...
  ;; ../../../../specification/wasm-3.0/4.3-execution.instructions.watsup:492.1-494.39
  ...
  ;; ../../../../specification/wasm-3.0/4.3-execution.instructions.watsup:496.1-499.43
  ...
  ;; ../../../../specification/wasm-3.0/4.3-execution.instructions.watsup:810.1-812.32
  ...
  ;; ../../../../specification/wasm-3.0/4.3-execution.instructions.watsup:821.1-824.46
  ...
  ;; ../../../../specification/wasm-3.0/4.3-execution.instructions.watsup:826.1-827.86
  ...
  ;; ../../../../specification/wasm-3.0/4.3-execution.instructions.watsup:887.1-888.51
  rule elem.drop{z : state, x : idx}:
    `%~>%`(`%;%`_config(z, [ELEM.DROP_instr(x)]), `%;%`_config($with_elem(z, x, []), []))

  ;; ../../../../specification/wasm-3.0/4.3-execution.instructions.watsup:971.1-974.60
  ...
  ;; ../../../../specification/wasm-3.0/4.3-execution.instructions.watsup:976.1-980.29
  ...
  ;; ../../../../specification/wasm-3.0/4.3-execution.instructions.watsup:982.1-985.52
  ...
  ;; ../../../../specification/wasm-3.0/4.3-execution.instructions.watsup:987.1-991.52
  ...
  ;; ../../../../specification/wasm-3.0/4.3-execution.instructions.watsup:993.1-995.63
  ...
  ;; ../../../../specification/wasm-3.0/4.3-execution.instructions.watsup:997.1-999.31
  ...
  ;; ../../../../specification/wasm-3.0/4.3-execution.instructions.watsup:1002.1-1004.50
  ...
  ;; ../../../../specification/wasm-3.0/4.3-execution.instructions.watsup:1006.1-1010.49
  ...
  ;; ../../../../specification/wasm-3.0/4.3-execution.instructions.watsup:1019.1-1022.37
  ...
  ;; ../../../../specification/wasm-3.0/4.3-execution.instructions.watsup:1024.1-1025.83
  ...
  ;; ../../../../specification/wasm-3.0/4.3-execution.instructions.watsup:1085.1-1086.51
...
;; ../../../../specification/wasm-3.0/4.3-execution.instructions.watsup:8.1-8.92
relation Steps: `%~>*%`(config, config)
  ;; ../../../../specification/wasm-3.0/4.3-execution.instructions.watsup:21.1-22.26
  rule refl{z : state, `instr*` : instr*}:
    `%~>*%`(`%;%`_config(z, instr*{instr <- `instr*`}), `%;%`_config(z, instr*{instr <- `instr*`}))

  ;; ../../../../specification/wasm-3.0/4.3-execution.instructions.watsup:24.1-27.44
...
;; ../../../../specification/wasm-3.0/4.4-execution.modules.watsup
rec {

;; ../../../../specification/wasm-3.0/4.4-execution.modules.watsup:7.1-7.63
def $alloctypes(type*) : deftype*
  ;; ../../../../specification/wasm-3.0/4.4-execution.modules.watsup:8.1-8.27
  def $alloctypes([]) = []
  ;; ../../../../specification/wasm-3.0/4.4-execution.modules.watsup:9.1-13.24
...
;; ../../../../specification/wasm-3.0/4.4-execution.modules.watsup:20.1-20.113
def $allocfuncs(store : store, deftype*, funccode*, moduleinst*) : (store, funcaddr*)
  ;; ../../../../specification/wasm-3.0/4.4-execution.modules.watsup:21.1-21.45
  def $allocfuncs{s : store}(s, [], [], []) = (s, [])
  ;; ../../../../specification/wasm-3.0/4.4-execution.modules.watsup:22.1-24.71
...
;; ../../../../specification/wasm-3.0/4.4-execution.modules.watsup:31.1-31.102
def $allocglobals(store : store, globaltype*, val*) : (store, globaladdr*)
  ;; ../../../../specification/wasm-3.0/4.4-execution.modules.watsup:32.1-32.42
  def $allocglobals{s : store}(s, [], []) = (s, [])
  ;; ../../../../specification/wasm-3.0/4.4-execution.modules.watsup:33.1-35.62
...
;; ../../../../specification/wasm-3.0/4.4-execution.modules.watsup:42.1-42.98
def $alloctables(store : store, tabletype*, ref*) : (store, tableaddr*)
  ;; ../../../../specification/wasm-3.0/4.4-execution.modules.watsup:43.1-43.41
  def $alloctables{s : store}(s, [], []) = (s, [])
  ;; ../../../../specification/wasm-3.0/4.4-execution.modules.watsup:44.1-46.60
...
;; ../../../../specification/wasm-3.0/4.4-execution.modules.watsup:53.1-53.82
def $allocmems(store : store, memtype*) : (store, memaddr*)
  ;; ../../../../specification/wasm-3.0/4.4-execution.modules.watsup:54.1-54.34
  def $allocmems{s : store}(s, []) = (s, [])
  ;; ../../../../specification/wasm-3.0/4.4-execution.modules.watsup:55.1-57.49
...
;; ../../../../specification/wasm-3.0/4.4-execution.modules.watsup:64.1-64.82
def $alloctags(store : store, tagtype*) : (store, tagaddr*)
  ;; ../../../../specification/wasm-3.0/4.4-execution.modules.watsup:65.1-65.34
  def $alloctags{s : store}(s, []) = (s, [])
  ;; ../../../../specification/wasm-3.0/4.4-execution.modules.watsup:66.1-68.49
...
;; ../../../../specification/wasm-3.0/4.4-execution.modules.watsup:75.1-75.97
def $allocelems(store : store, elemtype*, ref**) : (store, elemaddr*)
  ;; ../../../../specification/wasm-3.0/4.4-execution.modules.watsup:76.1-76.40
  def $allocelems{s : store}(s, [], []) = (s, [])
  ;; ../../../../specification/wasm-3.0/4.4-execution.modules.watsup:77.1-79.55
...
;; ../../../../specification/wasm-3.0/4.4-execution.modules.watsup:86.1-86.98
def $allocdatas(store : store, datatype*, byte**) : (store, dataaddr*)
  ;; ../../../../specification/wasm-3.0/4.4-execution.modules.watsup:87.1-87.40
  def $allocdatas{s : store}(s, [], []) = (s, [])
  ;; ../../../../specification/wasm-3.0/4.4-execution.modules.watsup:88.1-90.53
...
;; ../../../../specification/wasm-3.0/4.4-execution.modules.watsup:166.1-166.94
def $evalglobals(state : state, globaltype*, expr*) : (state, val*)
  ;; ../../../../specification/wasm-3.0/4.4-execution.modules.watsup:167.1-167.41
  def $evalglobals{z : state}(z, [], []) = (z, [])
  ;; ../../../../specification/wasm-3.0/4.4-execution.modules.watsup:168.1-173.81
...
def $invoke(store : store, funcaddr : funcaddr, val*) : config
  ;; ../../../../specification/wasm-3.0/4.4-execution.modules.watsup
  def $invoke{s : store, funcaddr : funcaddr, `val*` : val*, `t_1*` : valtype*, `t_2*` : valtype*}(s, funcaddr, val*{val <- `val*`}) = `%;%`_config(`%;%`_state(s, {LOCALS [], MODULE {TYPES [], FUNCS [], GLOBALS [], TABLES [], MEMS [], TAGS [], ELEMS [], DATAS [], EXPORTS []}}), (val : val <: instr)*{val <- `val*`} ++ [REF.FUNC_ADDR_instr(funcaddr) CALL_REF_instr((s.FUNCS_store[funcaddr].TYPE_funcinst : deftype <: typeuse))])
...
;; ../../../../specification/wasm-3.0/5.1-binary.values.watsup:9.1-11.82
grammar BuN(N : N) : uN(N)
  ;; ../../../../specification/wasm-3.0/5.1-binary.values.watsup:10.5-10.83
  prod{n : n} `%`_byte(n):Bbyte => `%`_uN(n)
    -- if ((n < (2 ^ 7)) /\ (n < (2 ^ N)))
  ;; ../../../../specification/wasm-3.0/5.1-binary.values.watsup:11.5-11.82
...
;; ../../../../specification/wasm-3.0/5.2-binary.types.watsup
...
;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup
...
;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:794.1-808.73
grammar Binstr : instr
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:16.5-16.24
  prod 0x00 => UNREACHABLE_instr
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:17.5-17.16
  prod 0x01 => NOP_instr
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:18.5-18.57
  prod{bt : blocktype, `in*` : instr*} {0x02 bt:Bblocktype in:Binstr*{in <- `in*`} 0x0B} => BLOCK_instr(bt, in*{in <- `in*`})
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:19.5-19.56
  prod{bt : blocktype, `in*` : instr*} {0x03 bt:Bblocktype in:Binstr*{in <- `in*`} 0x0B} => LOOP_instr(bt, in*{in <- `in*`})
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:20.5-20.63
  prod{bt : blocktype, `in*` : instr*} {0x04 bt:Bblocktype in:Binstr*{in <- `in*`} 0x0B} => `IF%%ELSE%`_instr(bt, in*{in <- `in*`}, [])
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:21.5-22.55
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:23.5-23.30
  prod{x : idx} {0x08 x:Btagidx} => THROW_instr(x)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:24.5-24.22
  prod 0x0A => THROW_REF_instr
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:25.5-25.29
  prod{l : labelidx} {0x0C l:Blabelidx} => BR_instr(l)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:26.5-26.32
  prod{l : labelidx} {0x0D l:Blabelidx} => BR_IF_instr(l)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:27.5-27.62
  prod{`l*` : labelidx*, l_n : labelidx} {0x0E l*{l <- `l*`}:Blist(syntax labelidx, grammar Blabelidx) l_n:Blabelidx} => BR_TABLE_instr(l*{l <- `l*`}, l_n)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:28.5-28.19
  prod 0x0F => RETURN_instr
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:29.5-29.30
  prod{x : idx} {0x10 x:Bfuncidx} => CALL_instr(x)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:30.5-30.60
  prod{y : idx, x : idx} {0x11 y:Btypeidx x:Btableidx} => CALL_INDIRECT_instr(x, _IDX_typeuse(y))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:31.5-31.37
  prod{x : idx} {0x12 x:Bfuncidx} => RETURN_CALL_instr(x)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:32.5-32.67
  prod{y : idx, x : idx} {0x13 y:Btypeidx x:Btableidx} => RETURN_CALL_INDIRECT_instr(x, _IDX_typeuse(y))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:33.5-33.81
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:54.5-54.37
  prod{ht : heaptype} {0xD0 ht:Bheaptype} => REF.NULL_instr(ht)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:55.5-55.24
  prod 0xD1 => REF.IS_NULL_instr
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:56.5-56.34
  prod{x : idx} {0xD2 x:Bfuncidx} => REF.FUNC_instr(x)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:57.5-57.19
  prod 0xD3 => REF.EQ_instr
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:58.5-58.28
  prod 0xD4 => REF.AS_NON_NULL_instr
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:59.5-59.37
  prod{l : labelidx} {0xD5 l:Blabelidx} => BR_ON_NULL_instr(l)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:60.5-60.41
  prod{l : labelidx} {0xD6 l:Blabelidx} => BR_ON_NON_NULL_instr(l)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:64.5-64.43
  prod{x : idx} {0xFB `%`_u32(0):Bu32 x:Btypeidx} => STRUCT.NEW_instr(x)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:65.5-65.51
  prod{x : idx} {0xFB `%`_u32(1):Bu32 x:Btypeidx} => STRUCT.NEW_DEFAULT_instr(x)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:66.5-66.52
  prod{x : idx, i : u32} {0xFB `%`_u32(2):Bu32 x:Btypeidx i:Bu32} => STRUCT.GET_instr(?(), x, i)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:67.5-67.54
  prod{x : idx, i : u32} {0xFB `%`_u32(3):Bu32 x:Btypeidx i:Bu32} => STRUCT.GET_instr(?(S_sx), x, i)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:68.5-68.54
  prod{x : idx, i : u32} {0xFB `%`_u32(4):Bu32 x:Btypeidx i:Bu32} => STRUCT.GET_instr(?(U_sx), x, i)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:69.5-69.52
  prod{x : idx, i : u32} {0xFB `%`_u32(5):Bu32 x:Btypeidx i:Bu32} => STRUCT.SET_instr(x, i)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:73.5-73.42
  prod{x : idx} {0xFB `%`_u32(6):Bu32 x:Btypeidx} => ARRAY.NEW_instr(x)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:74.5-74.50
  prod{x : idx} {0xFB `%`_u32(7):Bu32 x:Btypeidx} => ARRAY.NEW_DEFAULT_instr(x)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:75.5-75.57
  prod{x : idx, n : n} {0xFB `%`_u32(8):Bu32 x:Btypeidx `%`_u32(n):Bu32} => ARRAY.NEW_FIXED_instr(x, `%`_u32(n))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:76.5-76.60
  prod{x : idx, y : idx} {0xFB `%`_u32(9):Bu32 x:Btypeidx y:Bdataidx} => ARRAY.NEW_DATA_instr(x, y)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:77.5-77.61
  prod{x : idx, y : idx} {0xFB `%`_u32(10):Bu32 x:Btypeidx y:Belemidx} => ARRAY.NEW_ELEM_instr(x, y)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:78.5-78.43
  prod{x : idx} {0xFB `%`_u32(11):Bu32 x:Btypeidx} => ARRAY.GET_instr(?(), x)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:79.5-79.45
  prod{x : idx} {0xFB `%`_u32(12):Bu32 x:Btypeidx} => ARRAY.GET_instr(?(S_sx), x)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:80.5-80.45
  prod{x : idx} {0xFB `%`_u32(13):Bu32 x:Btypeidx} => ARRAY.GET_instr(?(U_sx), x)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:81.5-81.43
  prod{x : idx} {0xFB `%`_u32(14):Bu32 x:Btypeidx} => ARRAY.SET_instr(x)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:82.5-82.30
  prod {0xFB `%`_u32(15):Bu32} => ARRAY.LEN_instr
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:83.5-83.44
  prod{x : idx} {0xFB `%`_u32(16):Bu32 x:Btypeidx} => ARRAY.FILL_instr(x)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:84.5-84.65
  prod{x_1 : idx, x_2 : idx} {0xFB `%`_u32(17):Bu32 x_1:Btypeidx x_2:Btypeidx} => ARRAY.COPY_instr(x_1, x_2)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:85.5-85.62
  prod{x : idx, y : idx} {0xFB `%`_u32(18):Bu32 x:Btypeidx y:Bdataidx} => ARRAY.INIT_DATA_instr(x, y)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:86.5-86.62
  prod{x : idx, y : idx} {0xFB `%`_u32(19):Bu32 x:Btypeidx y:Belemidx} => ARRAY.INIT_ELEM_instr(x, y)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:90.5-90.51
  prod{ht : heaptype} {0xFB `%`_u32(20):Bu32 ht:Bheaptype} => REF.TEST_instr(REF_reftype(?(), ht))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:91.5-91.56
  prod{ht : heaptype} {0xFB `%`_u32(21):Bu32 ht:Bheaptype} => REF.TEST_instr(REF_reftype(?(NULL_NULL), ht))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:92.5-92.51
  prod{ht : heaptype} {0xFB `%`_u32(22):Bu32 ht:Bheaptype} => REF.CAST_instr(REF_reftype(?(), ht))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:93.5-93.56
  prod{ht : heaptype} {0xFB `%`_u32(23):Bu32 ht:Bheaptype} => REF.CAST_instr(REF_reftype(?(NULL_NULL), ht))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:94.5-95.94
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:96.5-97.99
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:101.5-101.39
  prod {0xFB `%`_u32(26):Bu32} => ANY.CONVERT_EXTERN_instr
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:102.5-102.39
  prod {0xFB `%`_u32(27):Bu32} => EXTERN.CONVERT_ANY_instr
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:106.5-106.28
  prod {0xFB `%`_u32(28):Bu32} => REF.I31_instr
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:107.5-107.30
  prod {0xFB `%`_u32(29):Bu32} => I31.GET_instr(S_sx)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:108.5-108.30
  prod {0xFB `%`_u32(30):Bu32} => I31.GET_instr(U_sx)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:115.5-115.17
  prod 0x1A => DROP_instr
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:116.5-116.19
  prod 0x1B => SELECT_instr(?())
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:117.5-117.41
  prod{`t*` : valtype*} {0x1C t*{t <- `t*`}:Blist(syntax valtype, grammar Bvaltype)} => SELECT_instr(?(t*{t <- `t*`}))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:124.5-124.36
  prod{x : idx} {0x20 x:Blocalidx} => LOCAL.GET_instr(x)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:125.5-125.36
  prod{x : idx} {0x21 x:Blocalidx} => LOCAL.SET_instr(x)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:126.5-126.36
  prod{x : idx} {0x22 x:Blocalidx} => LOCAL.TEE_instr(x)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:130.5-130.38
  prod{x : idx} {0x23 x:Bglobalidx} => GLOBAL.GET_instr(x)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:131.5-131.38
  prod{x : idx} {0x24 x:Bglobalidx} => GLOBAL.SET_instr(x)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:138.5-138.36
  prod{x : idx} {0x25 x:Btableidx} => TABLE.GET_instr(x)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:139.5-139.36
  prod{x : idx} {0x26 x:Btableidx} => TABLE.SET_instr(x)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:140.5-140.58
  prod{y : idx, x : idx} {0xFC `%`_u32(12):Bu32 y:Belemidx x:Btableidx} => TABLE.INIT_instr(x, y)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:141.5-141.43
  prod{x : idx} {0xFC `%`_u32(13):Bu32 x:Belemidx} => ELEM.DROP_instr(x)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:142.5-142.67
  prod{x_1 : idx, x_2 : idx} {0xFC `%`_u32(14):Bu32 x_1:Btableidx x_2:Btableidx} => TABLE.COPY_instr(x_1, x_2)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:143.5-143.45
  prod{x : idx} {0xFC `%`_u32(15):Bu32 x:Btableidx} => TABLE.GROW_instr(x)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:144.5-144.45
  prod{x : idx} {0xFC `%`_u32(16):Bu32 x:Btableidx} => TABLE.SIZE_instr(x)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:145.5-145.45
  prod{x : idx} {0xFC `%`_u32(17):Bu32 x:Btableidx} => TABLE.FILL_instr(x)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:158.5-158.41
  prod{x : idx, ao : memarg} {0x28 (x, ao):Bmemarg} => LOAD_instr(I32_numtype, ?(), x, ao)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:159.5-159.41
  prod{x : idx, ao : memarg} {0x29 (x, ao):Bmemarg} => LOAD_instr(I64_numtype, ?(), x, ao)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:160.5-160.41
  prod{x : idx, ao : memarg} {0x2A (x, ao):Bmemarg} => LOAD_instr(F32_numtype, ?(), x, ao)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:161.5-161.41
  prod{x : idx, ao : memarg} {0x2B (x, ao):Bmemarg} => LOAD_instr(F64_numtype, ?(), x, ao)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:162.5-162.50
  prod{x : idx, ao : memarg} {0x2C (x, ao):Bmemarg} => LOAD_instr(I32_numtype, ?(`%_%`_loadop_(`%`_sz(8), S_sx)), x, ao)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:163.5-163.50
  prod{x : idx, ao : memarg} {0x2D (x, ao):Bmemarg} => LOAD_instr(I32_numtype, ?(`%_%`_loadop_(`%`_sz(8), U_sx)), x, ao)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:164.5-164.51
  prod{x : idx, ao : memarg} {0x2E (x, ao):Bmemarg} => LOAD_instr(I32_numtype, ?(`%_%`_loadop_(`%`_sz(16), S_sx)), x, ao)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:165.5-165.51
  prod{x : idx, ao : memarg} {0x2F (x, ao):Bmemarg} => LOAD_instr(I32_numtype, ?(`%_%`_loadop_(`%`_sz(16), U_sx)), x, ao)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:166.5-166.50
  prod{x : idx, ao : memarg} {0x30 (x, ao):Bmemarg} => LOAD_instr(I64_numtype, ?(`%_%`_loadop_(`%`_sz(8), S_sx)), x, ao)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:167.5-167.50
  prod{x : idx, ao : memarg} {0x31 (x, ao):Bmemarg} => LOAD_instr(I64_numtype, ?(`%_%`_loadop_(`%`_sz(8), U_sx)), x, ao)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:168.5-168.51
  prod{x : idx, ao : memarg} {0x32 (x, ao):Bmemarg} => LOAD_instr(I64_numtype, ?(`%_%`_loadop_(`%`_sz(16), S_sx)), x, ao)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:169.5-169.51
  prod{x : idx, ao : memarg} {0x33 (x, ao):Bmemarg} => LOAD_instr(I64_numtype, ?(`%_%`_loadop_(`%`_sz(16), U_sx)), x, ao)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:170.5-170.51
  prod{x : idx, ao : memarg} {0x34 (x, ao):Bmemarg} => LOAD_instr(I64_numtype, ?(`%_%`_loadop_(`%`_sz(32), S_sx)), x, ao)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:171.5-171.51
  prod{x : idx, ao : memarg} {0x35 (x, ao):Bmemarg} => LOAD_instr(I64_numtype, ?(`%_%`_loadop_(`%`_sz(32), U_sx)), x, ao)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:172.5-172.42
  prod{x : idx, ao : memarg} {0x36 (x, ao):Bmemarg} => STORE_instr(I32_numtype, ?(), x, ao)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:173.5-173.42
  prod{x : idx, ao : memarg} {0x37 (x, ao):Bmemarg} => STORE_instr(I64_numtype, ?(), x, ao)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:174.5-174.42
  prod{x : idx, ao : memarg} {0x38 (x, ao):Bmemarg} => STORE_instr(F32_numtype, ?(), x, ao)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:175.5-175.42
  prod{x : idx, ao : memarg} {0x39 (x, ao):Bmemarg} => STORE_instr(F64_numtype, ?(), x, ao)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:176.5-176.45
  prod{x : idx, ao : memarg} {0x3A (x, ao):Bmemarg} => STORE_instr(I32_numtype, ?(`%`_storeop_(`%`_sz(8))), x, ao)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:177.5-177.46
  prod{x : idx, ao : memarg} {0x3B (x, ao):Bmemarg} => STORE_instr(I32_numtype, ?(`%`_storeop_(`%`_sz(16))), x, ao)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:178.5-178.45
  prod{x : idx, ao : memarg} {0x3C (x, ao):Bmemarg} => STORE_instr(I64_numtype, ?(`%`_storeop_(`%`_sz(8))), x, ao)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:179.5-179.46
  prod{x : idx, ao : memarg} {0x3D (x, ao):Bmemarg} => STORE_instr(I64_numtype, ?(`%`_storeop_(`%`_sz(16))), x, ao)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:180.5-180.46
  prod{x : idx, ao : memarg} {0x3E (x, ao):Bmemarg} => STORE_instr(I64_numtype, ?(`%`_storeop_(`%`_sz(32))), x, ao)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:181.5-181.36
  prod{x : idx} {0x3F x:Bmemidx} => MEMORY.SIZE_instr(x)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:182.5-182.36
  prod{x : idx} {0x40 x:Bmemidx} => MEMORY.GROW_instr(x)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:183.5-183.56
  prod{y : idx, x : idx} {0xFC `%`_u32(8):Bu32 y:Bdataidx x:Bmemidx} => MEMORY.INIT_instr(x, y)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:184.5-184.42
  prod{x : idx} {0xFC `%`_u32(9):Bu32 x:Bdataidx} => DATA.DROP_instr(x)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:185.5-185.64
  prod{x_1 : idx, x_2 : idx} {0xFC `%`_u32(10):Bu32 x_1:Bmemidx x_2:Bmemidx} => MEMORY.COPY_instr(x_1, x_2)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:186.5-186.44
  prod{x : idx} {0xFC `%`_u32(11):Bu32 x:Bmemidx} => MEMORY.FILL_instr(x)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:194.5-194.31
  prod{n : n} {0x41 `%`_u32(n):Bu32} => CONST_instr(I32_numtype, `%`_num_(n))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:195.5-195.31
  prod{n : n} {0x42 `%`_u64(n):Bu64} => CONST_instr(I64_numtype, `%`_num_(n))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:196.5-196.31
  prod{p : f32} {0x43 p:Bf32} => CONST_instr(F32_numtype, p)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:197.5-197.31
  prod{p : f64} {0x44 p:Bf64} => CONST_instr(F64_numtype, p)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:201.5-201.27
  prod 0x45 => TESTOP_instr(I32_numtype, EQZ_testop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:205.5-205.25
  prod 0x46 => RELOP_instr(I32_numtype, EQ_relop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:206.5-206.25
  prod 0x47 => RELOP_instr(I32_numtype, NE_relop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:207.5-207.29
  prod 0x48 => RELOP_instr(I32_numtype, LT_relop_(S_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:208.5-208.29
  prod 0x49 => RELOP_instr(I32_numtype, LT_relop_(U_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:209.5-209.29
  prod 0x4A => RELOP_instr(I32_numtype, GT_relop_(S_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:210.5-210.29
  prod 0x4B => RELOP_instr(I32_numtype, GT_relop_(U_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:211.5-211.29
  prod 0x4C => RELOP_instr(I32_numtype, LE_relop_(S_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:212.5-212.29
  prod 0x4D => RELOP_instr(I32_numtype, LE_relop_(U_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:213.5-213.29
  prod 0x4E => RELOP_instr(I32_numtype, GE_relop_(S_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:214.5-214.29
  prod 0x4F => RELOP_instr(I32_numtype, GE_relop_(U_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:218.5-218.27
  prod 0x50 => TESTOP_instr(I64_numtype, EQZ_testop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:222.5-222.25
  prod 0x51 => RELOP_instr(I64_numtype, EQ_relop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:223.5-223.25
  prod 0x52 => RELOP_instr(I64_numtype, NE_relop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:224.5-224.29
  prod 0x53 => RELOP_instr(I64_numtype, LT_relop_(S_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:225.5-225.29
  prod 0x54 => RELOP_instr(I64_numtype, LT_relop_(U_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:226.5-226.29
  prod 0x55 => RELOP_instr(I64_numtype, GT_relop_(S_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:227.5-227.29
  prod 0x56 => RELOP_instr(I64_numtype, GT_relop_(U_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:228.5-228.29
  prod 0x57 => RELOP_instr(I64_numtype, LE_relop_(S_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:229.5-229.29
  prod 0x58 => RELOP_instr(I64_numtype, LE_relop_(U_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:230.5-230.29
  prod 0x59 => RELOP_instr(I64_numtype, GE_relop_(S_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:231.5-231.29
  prod 0x5A => RELOP_instr(I64_numtype, GE_relop_(U_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:235.5-235.25
  prod 0x5B => RELOP_instr(F32_numtype, EQ_relop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:236.5-236.25
  prod 0x5C => RELOP_instr(F32_numtype, NE_relop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:237.5-237.25
  prod 0x5D => RELOP_instr(F32_numtype, LT_relop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:238.5-238.25
  prod 0x5E => RELOP_instr(F32_numtype, GT_relop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:239.5-239.25
  prod 0x5F => RELOP_instr(F32_numtype, LE_relop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:240.5-240.25
  prod 0x60 => RELOP_instr(F32_numtype, GE_relop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:244.5-244.25
  prod 0x61 => RELOP_instr(F64_numtype, EQ_relop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:245.5-245.25
  prod 0x62 => RELOP_instr(F64_numtype, NE_relop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:246.5-246.25
  prod 0x63 => RELOP_instr(F64_numtype, LT_relop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:247.5-247.25
  prod 0x64 => RELOP_instr(F64_numtype, GT_relop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:248.5-248.25
  prod 0x65 => RELOP_instr(F64_numtype, LE_relop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:249.5-249.25
  prod 0x66 => RELOP_instr(F64_numtype, GE_relop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:253.5-253.25
  prod 0x67 => UNOP_instr(I32_numtype, CLZ_unop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:254.5-254.25
  prod 0x68 => UNOP_instr(I32_numtype, CTZ_unop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:255.5-255.28
  prod 0x69 => UNOP_instr(I32_numtype, POPCNT_unop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:259.5-259.26
  prod 0x6A => BINOP_instr(I32_numtype, ADD_binop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:260.5-260.26
  prod 0x6B => BINOP_instr(I32_numtype, SUB_binop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:261.5-261.26
  prod 0x6C => BINOP_instr(I32_numtype, MUL_binop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:262.5-262.30
  prod 0x6D => BINOP_instr(I32_numtype, DIV_binop_(S_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:263.5-263.30
  prod 0x6E => BINOP_instr(I32_numtype, DIV_binop_(U_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:264.5-264.30
  prod 0x6F => BINOP_instr(I32_numtype, REM_binop_(S_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:265.5-265.30
  prod 0x70 => BINOP_instr(I32_numtype, REM_binop_(U_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:266.5-266.26
  prod 0x71 => BINOP_instr(I32_numtype, AND_binop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:267.5-267.25
  prod 0x72 => BINOP_instr(I32_numtype, OR_binop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:268.5-268.26
  prod 0x73 => BINOP_instr(I32_numtype, XOR_binop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:269.5-269.26
  prod 0x74 => BINOP_instr(I32_numtype, SHL_binop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:270.5-270.30
  prod 0x75 => BINOP_instr(I32_numtype, SHR_binop_(S_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:271.5-271.30
  prod 0x76 => BINOP_instr(I32_numtype, SHR_binop_(U_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:272.5-272.27
  prod 0x77 => BINOP_instr(I32_numtype, ROTL_binop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:273.5-273.27
  prod 0x78 => BINOP_instr(I32_numtype, ROTR_binop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:277.5-277.25
  prod 0x79 => UNOP_instr(I64_numtype, CLZ_unop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:278.5-278.25
  prod 0x7A => UNOP_instr(I64_numtype, CTZ_unop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:279.5-279.28
  prod 0x7B => UNOP_instr(I64_numtype, POPCNT_unop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:283.5-283.33
  prod 0xC0 => UNOP_instr(I32_numtype, EXTEND_unop_(`%`_sz(8)))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:284.5-284.34
  prod 0xC1 => UNOP_instr(I32_numtype, EXTEND_unop_(`%`_sz(16)))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:288.5-288.33
  prod 0xC2 => UNOP_instr(I64_numtype, EXTEND_unop_(`%`_sz(8)))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:289.5-289.34
  prod 0xC3 => UNOP_instr(I64_numtype, EXTEND_unop_(`%`_sz(16)))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:290.5-290.34
  prod 0xC4 => UNOP_instr(I64_numtype, EXTEND_unop_(`%`_sz(32)))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:294.5-294.26
  prod 0x7C => BINOP_instr(I64_numtype, ADD_binop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:295.5-295.26
  prod 0x7D => BINOP_instr(I64_numtype, SUB_binop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:296.5-296.26
  prod 0x7E => BINOP_instr(I64_numtype, MUL_binop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:297.5-297.30
  prod 0x7F => BINOP_instr(I64_numtype, DIV_binop_(S_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:298.5-298.30
  prod 0x80 => BINOP_instr(I64_numtype, DIV_binop_(U_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:299.5-299.30
  prod 0x81 => BINOP_instr(I64_numtype, REM_binop_(S_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:300.5-300.30
  prod 0x82 => BINOP_instr(I64_numtype, REM_binop_(U_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:301.5-301.26
  prod 0x83 => BINOP_instr(I64_numtype, AND_binop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:302.5-302.25
  prod 0x84 => BINOP_instr(I64_numtype, OR_binop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:303.5-303.26
  prod 0x85 => BINOP_instr(I64_numtype, XOR_binop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:304.5-304.26
  prod 0x86 => BINOP_instr(I64_numtype, SHL_binop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:305.5-305.30
  prod 0x87 => BINOP_instr(I64_numtype, SHR_binop_(S_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:306.5-306.30
  prod 0x88 => BINOP_instr(I64_numtype, SHR_binop_(U_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:307.5-307.27
  prod 0x89 => BINOP_instr(I64_numtype, ROTL_binop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:308.5-308.27
  prod 0x8A => BINOP_instr(I64_numtype, ROTR_binop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:312.5-312.25
  prod 0x8B => UNOP_instr(F32_numtype, ABS_unop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:313.5-313.25
  prod 0x8C => UNOP_instr(F32_numtype, NEG_unop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:314.5-314.26
  prod 0x8D => UNOP_instr(F32_numtype, CEIL_unop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:315.5-315.27
  prod 0x8E => UNOP_instr(F32_numtype, FLOOR_unop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:316.5-316.27
  prod 0x8F => UNOP_instr(F32_numtype, TRUNC_unop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:317.5-317.29
  prod 0x90 => UNOP_instr(F32_numtype, NEAREST_unop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:318.5-318.26
  prod 0x91 => UNOP_instr(F32_numtype, SQRT_unop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:322.5-322.26
  prod 0x92 => BINOP_instr(F32_numtype, ADD_binop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:323.5-323.26
  prod 0x93 => BINOP_instr(F32_numtype, SUB_binop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:324.5-324.26
  prod 0x94 => BINOP_instr(F32_numtype, MUL_binop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:325.5-325.26
  prod 0x95 => BINOP_instr(F32_numtype, DIV_binop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:326.5-326.26
  prod 0x96 => BINOP_instr(F32_numtype, MIN_binop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:327.5-327.26
  prod 0x97 => BINOP_instr(F32_numtype, MAX_binop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:328.5-328.31
  prod 0x98 => BINOP_instr(F32_numtype, COPYSIGN_binop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:332.5-332.25
  prod 0x99 => UNOP_instr(F64_numtype, ABS_unop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:333.5-333.25
  prod 0x9A => UNOP_instr(F64_numtype, NEG_unop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:334.5-334.26
  prod 0x9B => UNOP_instr(F64_numtype, CEIL_unop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:335.5-335.27
  prod 0x9C => UNOP_instr(F64_numtype, FLOOR_unop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:336.5-336.27
  prod 0x9D => UNOP_instr(F64_numtype, TRUNC_unop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:337.5-337.29
  prod 0x9E => UNOP_instr(F64_numtype, NEAREST_unop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:338.5-338.26
  prod 0x9F => UNOP_instr(F64_numtype, SQRT_unop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:342.5-342.26
  prod 0xA0 => BINOP_instr(F64_numtype, ADD_binop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:343.5-343.26
  prod 0xA1 => BINOP_instr(F64_numtype, SUB_binop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:344.5-344.26
  prod 0xA2 => BINOP_instr(F64_numtype, MUL_binop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:345.5-345.26
  prod 0xA3 => BINOP_instr(F64_numtype, DIV_binop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:346.5-346.26
  prod 0xA4 => BINOP_instr(F64_numtype, MIN_binop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:347.5-347.26
  prod 0xA5 => BINOP_instr(F64_numtype, MAX_binop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:348.5-348.31
  prod 0xA6 => BINOP_instr(F64_numtype, COPYSIGN_binop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:353.5-353.31
  prod 0xA7 => CVTOP_instr(I32_numtype, I64_numtype, WRAP_cvtop__)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:354.5-354.36
  prod 0xA8 => CVTOP_instr(I32_numtype, F32_numtype, TRUNC_cvtop__(S_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:355.5-355.36
  prod 0xA9 => CVTOP_instr(I32_numtype, F32_numtype, TRUNC_cvtop__(U_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:356.5-356.36
  prod 0xAA => CVTOP_instr(I32_numtype, F64_numtype, TRUNC_cvtop__(S_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:357.5-357.36
  prod 0xAB => CVTOP_instr(I32_numtype, F64_numtype, TRUNC_cvtop__(U_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:358.5-358.37
  prod 0xAC => CVTOP_instr(I64_numtype, I32_numtype, EXTEND_cvtop__(S_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:359.5-359.37
  prod 0xAD => CVTOP_instr(I64_numtype, I32_numtype, EXTEND_cvtop__(U_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:360.5-360.36
  prod 0xAE => CVTOP_instr(I64_numtype, F32_numtype, TRUNC_cvtop__(S_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:361.5-361.36
  prod 0xAF => CVTOP_instr(I64_numtype, F32_numtype, TRUNC_cvtop__(U_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:362.5-362.36
  prod 0xB0 => CVTOP_instr(I64_numtype, F64_numtype, TRUNC_cvtop__(S_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:363.5-363.36
  prod 0xB1 => CVTOP_instr(I64_numtype, F64_numtype, TRUNC_cvtop__(U_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:364.5-364.38
  prod 0xB2 => CVTOP_instr(F32_numtype, I32_numtype, CONVERT_cvtop__(S_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:365.5-365.38
  prod 0xB3 => CVTOP_instr(F32_numtype, I32_numtype, CONVERT_cvtop__(U_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:366.5-366.38
  prod 0xB4 => CVTOP_instr(F32_numtype, I64_numtype, CONVERT_cvtop__(S_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:367.5-367.38
  prod 0xB5 => CVTOP_instr(F32_numtype, I64_numtype, CONVERT_cvtop__(U_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:368.5-368.33
  prod 0xB6 => CVTOP_instr(F32_numtype, F64_numtype, DEMOTE_cvtop__)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:369.5-369.38
  prod 0xB7 => CVTOP_instr(F64_numtype, I32_numtype, CONVERT_cvtop__(S_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:370.5-370.38
  prod 0xB8 => CVTOP_instr(F64_numtype, I32_numtype, CONVERT_cvtop__(U_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:371.5-371.38
  prod 0xB9 => CVTOP_instr(F64_numtype, I64_numtype, CONVERT_cvtop__(S_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:372.5-372.38
  prod 0xBA => CVTOP_instr(F64_numtype, I64_numtype, CONVERT_cvtop__(U_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:373.5-373.34
  prod 0xBB => CVTOP_instr(F32_numtype, F64_numtype, PROMOTE_cvtop__)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:374.5-374.38
  prod 0xBC => CVTOP_instr(I32_numtype, F32_numtype, REINTERPRET_cvtop__)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:375.5-375.38
  prod 0xBD => CVTOP_instr(I64_numtype, F64_numtype, REINTERPRET_cvtop__)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:376.5-376.38
  prod 0xBE => CVTOP_instr(F32_numtype, I32_numtype, REINTERPRET_cvtop__)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:377.5-377.38
  prod 0xBF => CVTOP_instr(F64_numtype, I64_numtype, REINTERPRET_cvtop__)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:381.5-381.47
  prod {0xFC `%`_u32(0):Bu32} => CVTOP_instr(I32_numtype, F32_numtype, TRUNC_SAT_cvtop__(S_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:382.5-382.47
  prod {0xFC `%`_u32(1):Bu32} => CVTOP_instr(I32_numtype, F32_numtype, TRUNC_SAT_cvtop__(U_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:383.5-383.47
  prod {0xFC `%`_u32(2):Bu32} => CVTOP_instr(I32_numtype, F64_numtype, TRUNC_SAT_cvtop__(S_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:384.5-384.47
  prod {0xFC `%`_u32(3):Bu32} => CVTOP_instr(I32_numtype, F64_numtype, TRUNC_SAT_cvtop__(U_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:385.5-385.47
  prod {0xFC `%`_u32(4):Bu32} => CVTOP_instr(I64_numtype, F32_numtype, TRUNC_SAT_cvtop__(S_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:386.5-386.47
  prod {0xFC `%`_u32(5):Bu32} => CVTOP_instr(I64_numtype, F32_numtype, TRUNC_SAT_cvtop__(U_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:387.5-387.47
  prod {0xFC `%`_u32(6):Bu32} => CVTOP_instr(I64_numtype, F64_numtype, TRUNC_SAT_cvtop__(S_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:388.5-388.47
  prod {0xFC `%`_u32(7):Bu32} => CVTOP_instr(I64_numtype, F64_numtype, TRUNC_SAT_cvtop__(U_sx))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:398.5-398.50
  prod{x : idx, ao : memarg} {0xFD `%`_u32(0):Bu32 (x, ao):Bmemarg} => VLOAD_instr(V128_vectype, ?(), x, ao)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:399.5-399.70
  prod{x : idx, ao : memarg} {0xFD `%`_u32(1):Bu32 (x, ao):Bmemarg} => VLOAD_instr(V128_vectype, ?(`SHAPE%X%_%`_vloadop_(`%`_sz(8), 8, S_sx)), x, ao)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:400.5-400.70
  prod{x : idx, ao : memarg} {0xFD `%`_u32(2):Bu32 (x, ao):Bmemarg} => VLOAD_instr(V128_vectype, ?(`SHAPE%X%_%`_vloadop_(`%`_sz(8), 8, U_sx)), x, ao)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:401.5-401.71
  prod{x : idx, ao : memarg} {0xFD `%`_u32(3):Bu32 (x, ao):Bmemarg} => VLOAD_instr(V128_vectype, ?(`SHAPE%X%_%`_vloadop_(`%`_sz(16), 4, S_sx)), x, ao)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:402.5-402.71
  prod{x : idx, ao : memarg} {0xFD `%`_u32(4):Bu32 (x, ao):Bmemarg} => VLOAD_instr(V128_vectype, ?(`SHAPE%X%_%`_vloadop_(`%`_sz(16), 4, U_sx)), x, ao)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:403.5-403.71
  prod{x : idx, ao : memarg} {0xFD `%`_u32(5):Bu32 (x, ao):Bmemarg} => VLOAD_instr(V128_vectype, ?(`SHAPE%X%_%`_vloadop_(`%`_sz(32), 2, S_sx)), x, ao)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:404.5-404.71
  prod{x : idx, ao : memarg} {0xFD `%`_u32(6):Bu32 (x, ao):Bmemarg} => VLOAD_instr(V128_vectype, ?(`SHAPE%X%_%`_vloadop_(`%`_sz(32), 2, U_sx)), x, ao)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:405.5-405.61
  prod{x : idx, ao : memarg} {0xFD `%`_u32(7):Bu32 (x, ao):Bmemarg} => VLOAD_instr(V128_vectype, ?(SPLAT_vloadop_(`%`_sz(8))), x, ao)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:406.5-406.62
  prod{x : idx, ao : memarg} {0xFD `%`_u32(8):Bu32 (x, ao):Bmemarg} => VLOAD_instr(V128_vectype, ?(SPLAT_vloadop_(`%`_sz(16))), x, ao)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:407.5-407.62
  prod{x : idx, ao : memarg} {0xFD `%`_u32(9):Bu32 (x, ao):Bmemarg} => VLOAD_instr(V128_vectype, ?(SPLAT_vloadop_(`%`_sz(32))), x, ao)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:408.5-408.63
  prod{x : idx, ao : memarg} {0xFD `%`_u32(10):Bu32 (x, ao):Bmemarg} => VLOAD_instr(V128_vectype, ?(SPLAT_vloadop_(`%`_sz(64))), x, ao)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:409.5-409.52
  prod{x : idx, ao : memarg} {0xFD `%`_u32(11):Bu32 (x, ao):Bmemarg} => VSTORE_instr(V128_vectype, x, ao)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:410.5-410.72
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:411.5-411.73
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:412.5-412.73
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:413.5-413.73
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:414.5-414.73
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:415.5-415.74
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:416.5-416.74
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:417.5-417.74
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:428.5-428.49
  prod {0xFD `%`_u32(14):Bu32} => VSWIZZLOP_instr(`%`_bshape(`%X%`_shape(I8_lanetype, `%`_dim(16))), SWIZZLE_vswizzlop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:429.5-429.58
  prod {0xFD `%`_u32(256):Bu32} => VSWIZZLOP_instr(`%`_bshape(`%X%`_shape(I8_lanetype, `%`_dim(16))), RELAXED_SWIZZLE_vswizzlop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:433.5-433.38
  prod {0xFD `%`_u32(15):Bu32} => VSPLAT_instr(`%X%`_shape(I8_lanetype, `%`_dim(16)))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:434.5-434.38
  prod {0xFD `%`_u32(16):Bu32} => VSPLAT_instr(`%X%`_shape(I16_lanetype, `%`_dim(8)))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:435.5-435.38
  prod {0xFD `%`_u32(17):Bu32} => VSPLAT_instr(`%X%`_shape(I32_lanetype, `%`_dim(4)))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:436.5-436.38
  prod {0xFD `%`_u32(18):Bu32} => VSPLAT_instr(`%X%`_shape(I64_lanetype, `%`_dim(2)))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:437.5-437.38
  prod {0xFD `%`_u32(19):Bu32} => VSPLAT_instr(`%X%`_shape(F32_lanetype, `%`_dim(4)))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:438.5-438.38
  prod {0xFD `%`_u32(20):Bu32} => VSPLAT_instr(`%X%`_shape(F64_lanetype, `%`_dim(2)))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:442.5-442.60
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:443.5-443.60
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:444.5-444.58
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:445.5-445.60
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:446.5-446.60
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:447.5-447.58
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:448.5-448.58
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:449.5-449.58
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:450.5-450.58
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:451.5-451.58
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:452.5-452.58
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:453.5-453.58
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:454.5-454.58
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:455.5-455.58
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:575.5-575.72
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:603.5-603.66
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:604.5-604.65
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:605.5-605.66
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:631.5-631.69
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:632.5-632.68
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:633.5-633.69
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:634.5-634.69
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:638.5-638.72
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:639.5-639.72
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:643.5-643.42
  prod {0xFD `%`_u32(160):Bu32} => VUNOP_instr(`%X%`_shape(I32_lanetype, `%`_dim(4)), ABS_vunop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:644.5-644.42
  prod {0xFD `%`_u32(161):Bu32} => VUNOP_instr(`%X%`_shape(I32_lanetype, `%`_dim(4)), NEG_vunop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:648.5-648.49
  prod {0xFD `%`_u32(163):Bu32} => VTESTOP_instr(`%X%`_shape(I32_lanetype, `%`_dim(4)), ALL_TRUE_vtestop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:652.5-652.41
  prod {0xFD `%`_u32(164):Bu32} => VBITMASK_instr(`%`_ishape(`%X%`_shape(I32_lanetype, `%`_dim(4))))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:656.5-656.65
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:657.5-657.66
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:658.5-658.65
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:659.5-659.66
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:680.5-680.68
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:681.5-681.69
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:682.5-682.68
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:683.5-683.69
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:687.5-687.74
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:691.5-691.42
  prod {0xFD `%`_u32(192):Bu32} => VUNOP_instr(`%X%`_shape(I64_lanetype, `%`_dim(2)), ABS_vunop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:692.5-692.42
  prod {0xFD `%`_u32(193):Bu32} => VUNOP_instr(`%X%`_shape(I64_lanetype, `%`_dim(2)), NEG_vunop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:696.5-696.49
  prod {0xFD `%`_u32(195):Bu32} => VTESTOP_instr(`%X%`_shape(I64_lanetype, `%`_dim(2)), ALL_TRUE_vtestop_)
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:700.5-700.41
  prod {0xFD `%`_u32(196):Bu32} => VBITMASK_instr(`%`_ishape(`%X%`_shape(I64_lanetype, `%`_dim(2))))
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:704.5-704.65
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:705.5-705.66
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:706.5-706.65
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:707.5-707.66
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:733.5-733.69
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:734.5-734.68
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:735.5-735.69
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:796.5-796.61
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:802.5-802.69
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:803.5-803.66
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:804.5-804.66
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:805.5-805.68
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:806.5-806.68
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:807.5-807.73
  ...
  ;; ../../../../specification/wasm-3.0/5.3-binary.instructions.watsup:808.5-808.73
...
;; ../../../../specification/wasm-3.0/5.4-binary.modules.watsup
...
;; ../../../../specification/wasm-3.0/X.1-notation.syntax.watsup
syntax A = nat
...
;; ../../../../specification/wasm-3.0/X.2-notation.typing.watsup
syntax T = nat
...
;; ../../../../specification/wasm-3.0/X.2-notation.typing.watsup:20.1-20.82
relation NotationTypingInstrScheme: `%|-%:%`(context, instr*, functype)
  ;; ../../../../specification/wasm-3.0/X.2-notation.typing.watsup:22.1-23.38
  ...
  ;; ../../../../specification/wasm-3.0/X.2-notation.typing.watsup:25.1-27.29
  rule global.get{C : context, x : idx, t : valtype, mut : mut}:
    `%|-%:%`(C, [GLOBAL.GET_instr(x)], `%->%`_functype(`%`_resulttype([]), `%`_resulttype([t])))
    -- if (C.GLOBALS_context[x!`%`_idx.0] = `%%`_globaltype(mut, t))

  ;; ../../../../specification/wasm-3.0/X.2-notation.typing.watsup:29.1-32.78
...
;; ../../../../specification/wasm-3.0/X.3-notation.execution.watsup
...
;; ../../../../specification/wasm-3.0/X.3-notation.execution.watsup:32.1-32.117
def $allocXs(syntax X, syntax Y, store : store, X*, Y*) : (store, addr*)
  ;; ../../../../specification/wasm-3.0/X.3-notation.execution.watsup:33.1-33.57
  def $allocXs{syntax X, syntax Y, s : store}(syntax X, syntax Y, s, [], []) = (s, [])
  ;; ../../../../specification/wasm-3.0/X.3-notation.execution.watsup:34.1-36.65
...
;; ../../../../specification/wasm-3.0/X.4-notation.binary.watsup
grammar Btypewriter : ()
  ;; ../../../../specification/wasm-3.0/X.4-notation.binary.watsup
  prod 0x00 => ()
