...
;; 0.2-aux.num.watsup:9.1-9.56
def $sum(nat*) : nat
  ;; 0.2-aux.num.watsup:10.1-10.18
  def $sum([]) = 0
  ;; 0.2-aux.num.watsup:11.1-11.35
...
;; 0.2-aux.num.watsup:13.1-13.57
def $prod(nat*) : nat
  ;; 0.2-aux.num.watsup:14.1-14.19
  def $prod([]) = 1
  ;; 0.2-aux.num.watsup:15.1-15.37
...
;; 0.3-aux.seq.watsup:14.1-14.55
def $concat_(syntax X, X**) : X*
  ;; 0.3-aux.seq.watsup:15.1-15.34
  def $concat_{syntax X}(syntax X, []) = []
  ;; 0.3-aux.seq.watsup:16.1-16.64
...
;; 0.3-aux.seq.watsup:18.1-18.61
def $concatn_(syntax X, X**, nat : nat) : X*
  ;; 0.3-aux.seq.watsup:19.1-19.38
  def $concatn_{syntax X, n : n}(syntax X, [], n) = []
  ;; 0.3-aux.seq.watsup:20.1-20.73
...
;; 0.3-aux.seq.watsup:25.1-25.78
def $disjoint_(syntax X, X*) : bool
  ;; 0.3-aux.seq.watsup:26.1-26.37
  def $disjoint_{syntax X}(syntax X, []) = true
  ;; 0.3-aux.seq.watsup:27.1-27.68
...
;; 0.3-aux.seq.watsup:29.1-29.56
def $setminus_(syntax X, X*, X*) : X*
  ;; 0.3-aux.seq.watsup:32.1-32.40
  def $setminus_{syntax X, `w*` : X*}(syntax X, [], w*{w <- `w*`}) = []
  ;; 0.3-aux.seq.watsup:33.1-33.90
...
;; 0.3-aux.seq.watsup:41.1-41.46
def $setproduct2_(syntax X, X : X, X**) : X**
  ;; 0.3-aux.seq.watsup:47.1-47.44
  def $setproduct2_{syntax X, w_1 : X}(syntax X, w_1, []) = []
  ;; 0.3-aux.seq.watsup:48.1-48.90
...
;; 0.3-aux.seq.watsup:40.1-40.47
def $setproduct1_(syntax X, X*, X**) : X**
  ;; 0.3-aux.seq.watsup:45.1-45.46
  def $setproduct1_{syntax X, `w**` : X**}(syntax X, [], w*{w <- `w*`}*{`w*` <- `w**`}) = []
  ;; 0.3-aux.seq.watsup:46.1-46.107
...
;; 0.3-aux.seq.watsup:39.1-39.82
def $setproduct_(syntax X, X**) : X**
  ;; 0.3-aux.seq.watsup:43.1-43.40
  def $setproduct_{syntax X}(syntax X, []) = [[]]
  ;; 0.3-aux.seq.watsup:44.1-44.90
...
;; 1.0-syntax.profiles.watsup
def $ND : bool

;; 1.1-syntax.values.watsup
syntax bit =
  | `%`{i : nat}(i : nat)
    -- if ((i = 0) \/ (i = 1))
...
;; 1.1-syntax.values.watsup:89.1-89.25
def $utf8(char*) : byte*
  ;; 5.1-binary.values.watsup:48.1-48.44
  def $utf8{`ch*` : char*}(ch*{ch <- `ch*`}) = $concat_(syntax byte, $utf8([ch])*{ch <- `ch*`})
  ;; 5.1-binary.values.watsup:49.1-51.15
  def $utf8{ch : char, b : byte}([ch]) = [b]
    -- if (ch!`%`_char.0 < 128)
    -- if (`%`_byte(ch!`%`_char.0) = b)
  ;; 5.1-binary.values.watsup:52.1-54.46
  ...
  ;; 5.1-binary.values.watsup:55.1-57.64
  ...
  ;; 5.1-binary.values.watsup:58.1-60.82
...
;; 1.1-syntax.values.watsup:127.1-127.86
def $funcsxx(externidx*) : typeidx*
  ;; 1.1-syntax.values.watsup:133.1-133.24
  def $funcsxx([]) = []
  ;; 1.1-syntax.values.watsup:134.1-134.45
  def $funcsxx{x : idx, `xx*` : externidx*}([FUNC_externidx(x)] ++ xx*{xx <- `xx*`}) = [x] ++ $funcsxx(xx*{xx <- `xx*`})
  ;; 1.1-syntax.values.watsup:135.1-135.58
...
;; 1.1-syntax.values.watsup:128.1-128.88
def $globalsxx(externidx*) : globalidx*
  ;; 1.1-syntax.values.watsup:137.1-137.26
  def $globalsxx([]) = []
  ;; 1.1-syntax.values.watsup:138.1-138.51
  def $globalsxx{x : idx, `xx*` : externidx*}([GLOBAL_externidx(x)] ++ xx*{xx <- `xx*`}) = [x] ++ $globalsxx(xx*{xx <- `xx*`})
  ;; 1.1-syntax.values.watsup:139.1-139.62
...
;; 1.1-syntax.values.watsup:129.1-129.87
def $tablesxx(externidx*) : tableidx*
  ;; 1.1-syntax.values.watsup:141.1-141.25
  def $tablesxx([]) = []
  ;; 1.1-syntax.values.watsup:142.1-142.48
  def $tablesxx{x : idx, `xx*` : externidx*}([TABLE_externidx(x)] ++ xx*{xx <- `xx*`}) = [x] ++ $tablesxx(xx*{xx <- `xx*`})
  ;; 1.1-syntax.values.watsup:143.1-143.60
...
;; 1.1-syntax.values.watsup:130.1-130.85
def $memsxx(externidx*) : memidx*
  ;; 1.1-syntax.values.watsup:145.1-145.23
  def $memsxx([]) = []
  ;; 1.1-syntax.values.watsup:146.1-146.42
  def $memsxx{x : idx, `xx*` : externidx*}([MEM_externidx(x)] ++ xx*{xx <- `xx*`}) = [x] ++ $memsxx(xx*{xx <- `xx*`})
  ;; 1.1-syntax.values.watsup:147.1-147.56
...
;; 1.1-syntax.values.watsup:131.1-131.85
def $tagsxx(externidx*) : tagidx*
  ;; 1.1-syntax.values.watsup:149.1-149.23
  def $tagsxx([]) = []
  ;; 1.1-syntax.values.watsup:150.1-150.42
  def $tagsxx{x : idx, `xx*` : externidx*}([TAG_externidx(x)] ++ xx*{xx <- `xx*`}) = [x] ++ $tagsxx(xx*{xx <- `xx*`})
  ;; 1.1-syntax.values.watsup:151.1-151.56
...
;; 1.1-syntax.values.watsup:170.1-170.29
def $free_list(free*) : free
  ;; 1.1-syntax.values.watsup:175.1-175.25
  def $free_list([]) = {TYPES [], FUNCS [], GLOBALS [], TABLES [], MEMS [], ELEMS [], DATAS [], LOCALS [], LABELS []}
  ;; 1.1-syntax.values.watsup:176.1-176.57
...
;; 1.2-syntax.types.watsup:53.1-54.14
syntax valtype =
  | I32
  | I64
  | F32
...
;; 1.2-syntax.types.watsup:94.1-94.66
syntax storagetype =
  | BOT
  | I32
  | I64
...
;; 1.2-syntax.types.watsup:293.1-293.88
def $funcsxt(externtype*) : deftype*
  ;; 1.2-syntax.types.watsup:299.1-299.24
  def $funcsxt([]) = []
  ;; 1.2-syntax.types.watsup:300.1-300.47
  def $funcsxt{dt : deftype, `xt*` : externtype*}([FUNC_externtype((dt : deftype <: typeuse))] ++ xt*{xt <- `xt*`}) = [dt] ++ $funcsxt(xt*{xt <- `xt*`})
  ;; 1.2-syntax.types.watsup:301.1-301.59
...
;; 1.2-syntax.types.watsup:294.1-294.90
def $globalsxt(externtype*) : globaltype*
  ;; 1.2-syntax.types.watsup:303.1-303.26
  def $globalsxt([]) = []
  ;; 1.2-syntax.types.watsup:304.1-304.53
  def $globalsxt{gt : globaltype, `xt*` : externtype*}([GLOBAL_externtype(gt)] ++ xt*{xt <- `xt*`}) = [gt] ++ $globalsxt(xt*{xt <- `xt*`})
  ;; 1.2-syntax.types.watsup:305.1-305.63
...
;; 1.2-syntax.types.watsup:295.1-295.89
def $tablesxt(externtype*) : tabletype*
  ;; 1.2-syntax.types.watsup:307.1-307.25
  def $tablesxt([]) = []
  ;; 1.2-syntax.types.watsup:308.1-308.50
  def $tablesxt{tt : tabletype, `xt*` : externtype*}([TABLE_externtype(tt)] ++ xt*{xt <- `xt*`}) = [tt] ++ $tablesxt(xt*{xt <- `xt*`})
  ;; 1.2-syntax.types.watsup:309.1-309.61
...
;; 1.2-syntax.types.watsup:296.1-296.87
def $memsxt(externtype*) : memtype*
  ;; 1.2-syntax.types.watsup:311.1-311.23
  def $memsxt([]) = []
  ;; 1.2-syntax.types.watsup:312.1-312.44
  def $memsxt{mt : memtype, `xt*` : externtype*}([MEM_externtype(mt)] ++ xt*{xt <- `xt*`}) = [mt] ++ $memsxt(xt*{xt <- `xt*`})
  ;; 1.2-syntax.types.watsup:313.1-313.57
...
;; 1.2-syntax.types.watsup:297.1-297.87
def $tagsxt(externtype*) : tagtype*
  ;; 1.2-syntax.types.watsup:315.1-315.23
  def $tagsxt([]) = []
  ;; 1.2-syntax.types.watsup:316.1-316.44
  def $tagsxt{jt : tagtype, `xt*` : externtype*}([TAG_externtype((jt : deftype <: typeuse))] ++ xt*{xt <- `xt*`}) = [jt] ++ $tagsxt(xt*{xt <- `xt*`})
  ;; 1.2-syntax.types.watsup:317.1-317.57
...
;; 1.2-syntax.types.watsup:323.1-323.112
def $subst_typeuse(typeuse : typeuse, typevar*, typeuse*) : typeuse
  ;; 1.2-syntax.types.watsup:355.1-355.66
  ...
  ;; 1.2-syntax.types.watsup:356.1-356.64
...
;; 1.2-syntax.types.watsup:328.1-328.112
def $subst_heaptype(heaptype : heaptype, typevar*, typeuse*) : heaptype
  ;; 1.2-syntax.types.watsup:362.1-362.67
  ...
  ;; 1.2-syntax.types.watsup:363.1-363.65
...
;; 1.2-syntax.types.watsup:330.1-330.112
def $subst_valtype(valtype : valtype, typevar*, typeuse*) : valtype
  ;; 1.2-syntax.types.watsup:368.1-368.64
  ...
  ;; 1.2-syntax.types.watsup:369.1-369.64
  ...
  ;; 1.2-syntax.types.watsup:370.1-370.64
...
def $subst_storagetype(storagetype : storagetype, typevar*, typeuse*) : storagetype
  ...
  ;; 1.2-syntax.types.watsup:376.1-376.69
...
;; 1.2-syntax.types.watsup:334.1-334.112
def $subst_fieldtype(fieldtype : fieldtype, typevar*, typeuse*) : fieldtype
  ;; 1.2-syntax.types.watsup:378.1-378.80
...
;; 1.2-syntax.types.watsup:336.1-336.112
def $subst_comptype(comptype : comptype, typevar*, typeuse*) : comptype
  ;; 1.2-syntax.types.watsup:380.1-380.85
  ...
  ;; 1.2-syntax.types.watsup:381.1-381.81
  ...
  ;; 1.2-syntax.types.watsup:382.1-382.78
...
;; 1.2-syntax.types.watsup:337.1-337.112
def $subst_subtype(subtype : subtype, typevar*, typeuse*) : subtype
  ;; 1.2-syntax.types.watsup:384.1-385.71
...
;; 1.2-syntax.types.watsup:338.1-338.112
def $subst_rectype(rectype : rectype, typevar*, typeuse*) : rectype
  ;; 1.2-syntax.types.watsup:387.1-387.76
...
;; 1.2-syntax.types.watsup:339.1-339.112
def $subst_deftype(deftype : deftype, typevar*, typeuse*) : deftype
  ;; 1.2-syntax.types.watsup:389.1-389.78
...
;; 1.2-syntax.types.watsup:342.1-342.112
def $subst_functype(functype : functype, typevar*, typeuse*) : functype
  ;; 1.2-syntax.types.watsup:392.1-392.113
...
;; 1.2-syntax.types.watsup:424.1-424.98
def $subst_all_deftypes(deftype*, heaptype*) : deftype*
  ;; 1.2-syntax.types.watsup:425.1-425.40
  def $subst_all_deftypes{`tu*` : typeuse*}([], (tu : typeuse <: heaptype)*{tu <- `tu*`}) = []
  ;; 1.2-syntax.types.watsup:426.1-426.101
...
;; 1.2-syntax.types.watsup:471.1-471.34
def $free_rectype(rectype : rectype) : free
  ;; 1.2-syntax.types.watsup:539.1-539.70
...
;; 1.2-syntax.types.watsup:499.1-499.34
def $free_deftype(deftype : deftype) : free
  ;; 1.2-syntax.types.watsup:500.1-500.58
...
;; 1.3-syntax.instructions.watsup
...
;; 4.0-execution.configurations.watsup
syntax addr = nat
...
;; 4.0-execution.configurations.watsup:35.1-42.23
syntax addrref =
...
;; 4.0-execution.configurations.watsup:136.1-142.9
syntax instr =
  | NOP
  | UNREACHABLE
  | DROP
...
;; 1.3-syntax.instructions.watsup:575.1-575.44
def $shift_labelidxs(labelidx*) : labelidx*
  ;; 1.3-syntax.instructions.watsup:576.1-576.32
  def $shift_labelidxs([]) = []
  ;; 1.3-syntax.instructions.watsup:577.1-577.66
  def $shift_labelidxs{`labelidx'*` : labelidx*}([`%`_labelidx(0)] ++ labelidx'*{labelidx' <- `labelidx'*`}) = $shift_labelidxs(labelidx'*{labelidx' <- `labelidx'*`})
  ;; 1.3-syntax.instructions.watsup:578.1-578.91
...
def $free_instr(instr : instr) : free
  ...
  ;; 1.3-syntax.instructions.watsup:438.1-438.92
  ...
  ;; 1.3-syntax.instructions.watsup:439.1-439.91
  ...
  ;; 1.3-syntax.instructions.watsup:440.1-441.79
  ...
  ;; 1.3-syntax.instructions.watsup:451.1-452.83
  ...
  ;; 1.3-syntax.instructions.watsup:488.1-489.49
  ...
  ;; 1.3-syntax.instructions.watsup:490.1-491.49
  ...
  ;; 1.3-syntax.instructions.watsup:492.1-493.47
  ...
  ;; 1.3-syntax.instructions.watsup:519.1-520.51
  ...
  ;; 1.3-syntax.instructions.watsup:527.1-528.51
  ...
  ;; 1.3-syntax.instructions.watsup:529.1-530.51
  ...
  ;; 1.3-syntax.instructions.watsup:549.1-550.53
  ...
  ;; 1.3-syntax.instructions.watsup:551.1-551.60
  def $free_instr{elemidx : elemidx}(ELEM.DROP_instr(elemidx)) = $free_elemidx(elemidx)
  ;; 1.3-syntax.instructions.watsup:553.1-554.49
  ...
  ;; 1.3-syntax.instructions.watsup:555.1-556.49
  ...
  ;; 1.3-syntax.instructions.watsup:557.1-558.49
  ...
  ;; 1.3-syntax.instructions.watsup:559.1-560.49
  ...
  ;; 1.3-syntax.instructions.watsup:561.1-562.49
  ...
  ;; 1.3-syntax.instructions.watsup:563.1-564.49
...
;; 2.0-validation.contexts.watsup
syntax init =
  | SET
  | UNSET
...
;; 2.0-validation.contexts.watsup:46.1-46.86
def $with_locals(context : context, localidx*, localtype*) : context
  ;; 2.0-validation.contexts.watsup:48.1-48.34
  def $with_locals{C : context}(C, [], []) = C
  ;; 2.0-validation.contexts.watsup:49.1-49.90
...
;; 2.0-validation.contexts.watsup:57.1-57.94
def $clos_deftypes(deftype*) : deftype*
  ;; 2.0-validation.contexts.watsup:64.1-64.30
  def $clos_deftypes([]) = []
  ;; 2.0-validation.contexts.watsup:65.1-65.101
...
;; 2.2-validation.subtyping.watsup
...
;; 2.1-validation.types.watsup:88.1-88.123
relation Rectype_ok: `%|-%:%`(context, rectype, oktypeidx)
  ;; 2.1-validation.types.watsup:169.1-170.23
  rule empty{C : context, x : idx}:
    `%|-%:%`(C, REC_rectype(`%`_list([])), OK_oktypeidx(x))

  ;; 2.1-validation.types.watsup:172.1-175.48
  ...
  ;; 2.1-validation.types.watsup:177.1-179.60
...
;; 2.1-validation.types.watsup:91.1-91.102
relation Deftype_ok: `%|-%:OK`(context, deftype)
  ;; 2.1-validation.types.watsup:190.1-194.14
...
;; 2.2-validation.subtyping.watsup:9.1-9.104
relation Heaptype_sub: `%|-%<:%`(context, heaptype, heaptype)
  ;; 2.2-validation.subtyping.watsup:20.1-21.28
  rule refl{C : context, heaptype : heaptype}:
    `%|-%<:%`(C, heaptype, heaptype)

  ;; 2.2-validation.subtyping.watsup:23.1-27.48
  ...
  ;; 2.2-validation.subtyping.watsup:29.1-30.17
  rule `eq-any`{C : context}:
    `%|-%<:%`(C, EQ_heaptype, ANY_heaptype)

  ;; 2.2-validation.subtyping.watsup:32.1-33.17
  rule `i31-eq`{C : context}:
    `%|-%<:%`(C, I31_heaptype, EQ_heaptype)

  ;; 2.2-validation.subtyping.watsup:35.1-36.20
  rule `struct-eq`{C : context}:
    `%|-%<:%`(C, STRUCT_heaptype, EQ_heaptype)

  ;; 2.2-validation.subtyping.watsup:38.1-39.19
  rule `array-eq`{C : context}:
    `%|-%<:%`(C, ARRAY_heaptype, EQ_heaptype)

  ;; 2.2-validation.subtyping.watsup:41.1-43.42
  ...
  ;; 2.2-validation.subtyping.watsup:45.1-47.40
  ...
  ;; 2.2-validation.subtyping.watsup:49.1-51.38
  ...
  ;; 2.2-validation.subtyping.watsup:53.1-55.46
  ...
  ;; 2.2-validation.subtyping.watsup:57.1-59.53
  ...
  ;; 2.2-validation.subtyping.watsup:61.1-63.53
  ...
  ;; 2.2-validation.subtyping.watsup:65.1-67.40
...
;; 2.3-validation.instructions.watsup
...
;; 2.3-validation.instructions.watsup:5.1-5.95
relation Instr_ok: `%|-%:%`(context, instr, instrtype)
  ;; 2.3-validation.instructions.watsup:18.1-19.24
  rule nop{C : context}:
    `%|-%:%`(C, NOP_instr, `%->_%%`_instrtype(`%`_resulttype([]), [], `%`_resulttype([])))

  ;; 2.3-validation.instructions.watsup:21.1-23.42
  ...
  ;; 2.3-validation.instructions.watsup:54.1-57.67
  ...
  ;; 2.3-validation.instructions.watsup:59.1-62.67
  ...
  ;; 2.3-validation.instructions.watsup:64.1-68.71
  ...
  ;; 2.3-validation.instructions.watsup:73.1-76.42
  ...
  ;; 2.3-validation.instructions.watsup:88.1-91.31
  ...
  ;; 2.3-validation.instructions.watsup:93.1-95.34
  ...
  ;; 2.3-validation.instructions.watsup:97.1-103.34
  ...
  ;; 2.3-validation.instructions.watsup:105.1-111.49
  ...
  ;; 2.3-validation.instructions.watsup:116.1-118.47
  ...
  ;; 2.3-validation.instructions.watsup:120.1-122.47
  ...
  ;; 2.3-validation.instructions.watsup:124.1-128.47
  ...
  ;; 2.3-validation.instructions.watsup:130.1-133.42
  ...
  ;; 2.3-validation.instructions.watsup:136.1-141.42
  ...
  ;; 2.3-validation.instructions.watsup:144.1-149.42
  ...
  ;; 2.3-validation.instructions.watsup:152.1-160.42
  ...
  ;; 2.3-validation.instructions.watsup:167.1-170.42
  ...
  ;; 2.3-validation.instructions.watsup:172.1-174.42
  ...
  ;; 2.3-validation.instructions.watsup:176.1-180.34
  ...
  ;; 2.3-validation.instructions.watsup:203.1-204.33
  ...
  ;; 2.3-validation.instructions.watsup:206.1-207.34
  ...
  ;; 2.3-validation.instructions.watsup:209.1-210.39
  ...
  ;; 2.3-validation.instructions.watsup:212.1-213.39
  ...
  ;; 2.3-validation.instructions.watsup:215.1-216.40
  ...
  ;; 2.3-validation.instructions.watsup:218.1-219.44
  ...
  ;; 2.3-validation.instructions.watsup:240.1-242.31
  ...
  ;; 2.3-validation.instructions.watsup:244.1-245.51
  ...
  ;; 2.3-validation.instructions.watsup:247.1-251.33
  ...
  ;; 2.3-validation.instructions.watsup:253.1-257.33
  ...
  ;; 2.3-validation.instructions.watsup:262.1-263.42
  ...
  ;; 2.3-validation.instructions.watsup:268.1-270.44
  ...
  ;; 2.3-validation.instructions.watsup:272.1-275.48
  ...
  ;; 2.3-validation.instructions.watsup:277.1-281.39
  ...
  ;; 2.3-validation.instructions.watsup:283.1-286.24
  ...
  ;; 2.3-validation.instructions.watsup:291.1-293.42
  ...
  ;; 2.3-validation.instructions.watsup:295.1-298.45
  ...
  ;; 2.3-validation.instructions.watsup:300.1-302.42
  ...
  ;; 2.3-validation.instructions.watsup:304.1-307.40
  ...
  ;; 2.3-validation.instructions.watsup:309.1-313.24
  ...
  ;; 2.3-validation.instructions.watsup:315.1-318.39
  ...
  ;; 2.3-validation.instructions.watsup:320.1-322.42
  ...
  ;; 2.3-validation.instructions.watsup:324.1-325.43
  ...
  ;; 2.3-validation.instructions.watsup:327.1-329.42
  ...
  ;; 2.3-validation.instructions.watsup:331.1-335.40
  ...
  ;; 2.3-validation.instructions.watsup:337.1-340.44
  ...
  ;; 2.3-validation.instructions.watsup:342.1-346.24
  ...
  ;; 2.3-validation.instructions.watsup:351.1-353.20
  ...
  ;; 2.3-validation.instructions.watsup:355.1-357.20
  ...
  ;; 2.3-validation.instructions.watsup:368.1-369.48
  ...
  ;; 2.3-validation.instructions.watsup:371.1-372.55
  ...
  ;; 2.3-validation.instructions.watsup:374.1-375.44
  ...
  ;; 2.3-validation.instructions.watsup:377.1-378.37
  ...
  ;; 2.3-validation.instructions.watsup:380.1-381.44
  ...
  ;; 2.3-validation.instructions.watsup:383.1-384.51
  ...
  ;; 2.3-validation.instructions.watsup:386.1-387.40
  ...
  ;; 2.3-validation.instructions.watsup:389.1-390.44
  ...
  ;; 2.3-validation.instructions.watsup:392.1-393.47
  ...
  ;; 2.3-validation.instructions.watsup:401.1-403.29
  ...
  ;; 2.3-validation.instructions.watsup:405.1-406.44
  ...
  ;; 2.3-validation.instructions.watsup:408.1-410.21
  ...
  ;; 2.3-validation.instructions.watsup:412.1-414.21
  ...
  ;; 2.3-validation.instructions.watsup:416.1-417.50
  ...
  ;; 2.3-validation.instructions.watsup:419.1-420.57
  ...
  ;; 2.3-validation.instructions.watsup:422.1-423.64
  ...
  ;; 2.3-validation.instructions.watsup:425.1-426.48
  ...
  ;; 2.3-validation.instructions.watsup:428.1-429.58
  ...
  ;; 2.3-validation.instructions.watsup:434.1-436.28
  ...
  ;; 2.3-validation.instructions.watsup:438.1-440.29
  ...
  ;; 2.3-validation.instructions.watsup:453.1-455.29
  ...
  ;; 2.3-validation.instructions.watsup:460.1-462.32
  ...
  ;; 2.3-validation.instructions.watsup:464.1-466.32
  ...
  ;; 2.3-validation.instructions.watsup:468.1-470.32
  ...
  ;; 2.3-validation.instructions.watsup:472.1-474.32
  ...
  ;; 2.3-validation.instructions.watsup:476.1-478.32
  ...
  ;; 2.3-validation.instructions.watsup:480.1-484.36
  ...
  ;; 2.3-validation.instructions.watsup:486.1-490.36
  ...
  ;; 2.3-validation.instructions.watsup:492.1-494.24
  ...
  ;; 2.3-validation.instructions.watsup:499.1-501.32
  ...
  ;; 2.3-validation.instructions.watsup:503.1-505.32
  ...
  ;; 2.3-validation.instructions.watsup:507.1-509.32
  ...
  ;; 2.3-validation.instructions.watsup:511.1-514.38
  ...
  ;; 2.3-validation.instructions.watsup:516.1-519.24
  ...
  ;; 2.3-validation.instructions.watsup:521.1-523.24
  ...
  ;; 2.3-validation.instructions.watsup:534.1-537.43
  ...
  ;; 2.3-validation.instructions.watsup:539.1-542.35
  ...
  ;; 2.3-validation.instructions.watsup:553.1-556.43
  ...
  ;; 2.3-validation.instructions.watsup:558.1-561.35
  ...
  ;; 2.3-validation.instructions.watsup:563.1-566.46
  ...
  ;; 2.3-validation.instructions.watsup:568.1-571.39
  ...
  ;; 2.3-validation.instructions.watsup:573.1-576.35
  ...
  ;; 2.3-validation.instructions.watsup:578.1-581.35
  ...
  ;; 2.3-validation.instructions.watsup:583.1-587.21
  ...
  ;; 2.3-validation.instructions.watsup:589.1-592.46
  ...
  ;; 2.3-validation.instructions.watsup:594.1-598.21
...
;; 2.3-validation.instructions.watsup:6.1-6.96
relation Instrs_ok: `%|-%:%`(context, instr*, instrtype)
  ;; 2.3-validation.instructions.watsup:603.1-604.24
  rule empty{C : context}:
    `%|-%:%`(C, [], `%->_%%`_instrtype(`%`_resulttype([]), [], `%`_resulttype([])))

  ;; 2.3-validation.instructions.watsup:607.1-611.82
  ...
  ;; 2.3-validation.instructions.watsup:613.1-617.33
  ...
  ;; 2.3-validation.instructions.watsup:620.1-623.33
...
;; 2.4-validation.modules.watsup:135.1-135.100
relation Globals_ok: `%|-%:%`(context, global*, globaltype*)
  ;; 2.4-validation.modules.watsup:179.1-180.17
  rule empty{C : context}:
    `%|-%:%`(C, [], [])

  ;; 2.4-validation.modules.watsup:182.1-185.54
...
;; 2.4-validation.modules.watsup:134.1-134.98
relation Types_ok: `%|-%:%`(context, type*, deftype*)
  ;; 2.4-validation.modules.watsup:171.1-172.17
  rule empty{C : context}:
    `%|-%:%`(C, [], [])

  ;; 2.4-validation.modules.watsup:174.1-177.49
...
;; 4.0-execution.configurations.watsup:193.1-193.87
def $funcsxa(externaddr*) : funcaddr*
  ;; 4.0-execution.configurations.watsup:199.1-199.24
  def $funcsxa([]) = []
  ;; 4.0-execution.configurations.watsup:200.1-200.45
  def $funcsxa{a : addr, `xa*` : externaddr*}([FUNC_externaddr(a)] ++ xa*{xa <- `xa*`}) = [a] ++ $funcsxa(xa*{xa <- `xa*`})
  ;; 4.0-execution.configurations.watsup:201.1-201.59
...
;; 4.0-execution.configurations.watsup:194.1-194.89
def $globalsxa(externaddr*) : globaladdr*
  ;; 4.0-execution.configurations.watsup:203.1-203.26
  def $globalsxa([]) = []
  ;; 4.0-execution.configurations.watsup:204.1-204.51
  def $globalsxa{a : addr, `xa*` : externaddr*}([GLOBAL_externaddr(a)] ++ xa*{xa <- `xa*`}) = [a] ++ $globalsxa(xa*{xa <- `xa*`})
  ;; 4.0-execution.configurations.watsup:205.1-205.63
...
;; 4.0-execution.configurations.watsup:195.1-195.88
def $tablesxa(externaddr*) : tableaddr*
  ;; 4.0-execution.configurations.watsup:207.1-207.25
  def $tablesxa([]) = []
  ;; 4.0-execution.configurations.watsup:208.1-208.48
  def $tablesxa{a : addr, `xa*` : externaddr*}([TABLE_externaddr(a)] ++ xa*{xa <- `xa*`}) = [a] ++ $tablesxa(xa*{xa <- `xa*`})
  ;; 4.0-execution.configurations.watsup:209.1-209.61
...
;; 4.0-execution.configurations.watsup:196.1-196.86
def $memsxa(externaddr*) : memaddr*
  ;; 4.0-execution.configurations.watsup:211.1-211.23
  def $memsxa([]) = []
  ;; 4.0-execution.configurations.watsup:212.1-212.42
  def $memsxa{a : addr, `xa*` : externaddr*}([MEM_externaddr(a)] ++ xa*{xa <- `xa*`}) = [a] ++ $memsxa(xa*{xa <- `xa*`})
  ;; 4.0-execution.configurations.watsup:213.1-213.57
...
;; 4.0-execution.configurations.watsup:197.1-197.86
def $tagsxa(externaddr*) : tagaddr*
  ;; 4.0-execution.configurations.watsup:215.1-215.23
  def $tagsxa([]) = []
  ;; 4.0-execution.configurations.watsup:216.1-216.42
  def $tagsxa{a : addr, `xa*` : externaddr*}([TAG_externaddr(a)] ++ xa*{xa <- `xa*`}) = [a] ++ $tagsxa(xa*{xa <- `xa*`})
  ;; 4.0-execution.configurations.watsup:217.1-217.57
...
;; 4.1-execution.values.watsup:25.1-25.60
relation Ref_ok: `%|-%:%`(store, ref, reftype)
  ;; 4.1-execution.values.watsup:35.1-37.35
  ...
  ;; 4.1-execution.values.watsup:39.1-40.33
  rule i31{s : store, i : u31}:
    `%|-%:%`(s, REF.I31_NUM_ref(i), REF_reftype(?(), I31_heaptype))

  ;; 4.1-execution.values.watsup:42.1-44.31
  ...
  ;; 4.1-execution.values.watsup:46.1-48.30
  ...
  ;; 4.1-execution.values.watsup:50.1-52.29
  ...
  ;; 4.1-execution.values.watsup:65.1-68.34
...
;; 4.1-execution.values.watsup:86.1-86.84
relation Externaddr_ok: `%|-%:%`(store, externaddr, externtype)
  ;; 4.1-execution.values.watsup:88.1-90.30
  ...
  ;; 4.1-execution.values.watsup:92.1-94.34
  ...
  ;; 4.1-execution.values.watsup:96.1-98.32
  ...
  ;; 4.1-execution.values.watsup:108.1-111.37
...
;; 4.3-execution.instructions.watsup
...
;; 4.3-execution.instructions.watsup:5.1-5.88
relation Step: `%~>%`(config, config)
  ;; 4.3-execution.instructions.watsup:13.1-15.34
  ...
  ;; 4.3-execution.instructions.watsup:37.1-39.36
  ...
  ;; 4.3-execution.instructions.watsup:41.1-43.45
  ...
  ;; 4.3-execution.instructions.watsup:227.1-231.49
  ...
  ;; 4.3-execution.instructions.watsup:406.1-410.65
  ...
  ;; 4.3-execution.instructions.watsup:426.1-427.53
  ...
  ;; 4.3-execution.instructions.watsup:429.1-431.45
  ...
  ;; 4.3-execution.instructions.watsup:444.1-449.65
  ...
  ;; 4.3-execution.instructions.watsup:489.1-490.64
  ...
  ;; 4.3-execution.instructions.watsup:492.1-494.39
  ...
  ;; 4.3-execution.instructions.watsup:496.1-499.43
  ...
  ;; 4.3-execution.instructions.watsup:810.1-812.32
  ...
  ;; 4.3-execution.instructions.watsup:821.1-824.46
  ...
  ;; 4.3-execution.instructions.watsup:826.1-827.86
  ...
  ;; 4.3-execution.instructions.watsup:887.1-888.51
  rule elem.drop{z : state, x : idx}:
    `%~>%`(`%;%`_config(z, [ELEM.DROP_instr(x)]), `%;%`_config($with_elem(z, x, []), []))

  ;; 4.3-execution.instructions.watsup:971.1-974.60
  ...
  ;; 4.3-execution.instructions.watsup:976.1-980.29
  ...
  ;; 4.3-execution.instructions.watsup:982.1-985.52
  ...
  ;; 4.3-execution.instructions.watsup:987.1-991.52
  ...
  ;; 4.3-execution.instructions.watsup:993.1-995.63
  ...
  ;; 4.3-execution.instructions.watsup:997.1-999.31
  ...
  ;; 4.3-execution.instructions.watsup:1002.1-1004.50
  ...
  ;; 4.3-execution.instructions.watsup:1006.1-1010.49
  ...
  ;; 4.3-execution.instructions.watsup:1019.1-1022.37
  ...
  ;; 4.3-execution.instructions.watsup:1024.1-1025.83
  ...
  ;; 4.3-execution.instructions.watsup:1085.1-1086.51
...
;; 4.3-execution.instructions.watsup:8.1-8.92
relation Steps: `%~>*%`(config, config)
  ;; 4.3-execution.instructions.watsup:21.1-22.26
  rule refl{z : state, `instr*` : instr*}:
    `%~>*%`(`%;%`_config(z, instr*{instr <- `instr*`}), `%;%`_config(z, instr*{instr <- `instr*`}))

  ;; 4.3-execution.instructions.watsup:24.1-27.44
...
;; 4.4-execution.modules.watsup
rec {

;; 4.4-execution.modules.watsup:7.1-7.63
def $alloctypes(type*) : deftype*
  ;; 4.4-execution.modules.watsup:8.1-8.27
  def $alloctypes([]) = []
  ;; 4.4-execution.modules.watsup:9.1-13.24
...
;; 4.4-execution.modules.watsup:20.1-20.113
def $allocfuncs(store : store, deftype*, funccode*, moduleinst*) : (store, funcaddr*)
  ;; 4.4-execution.modules.watsup:21.1-21.45
  def $allocfuncs{s : store}(s, [], [], []) = (s, [])
  ;; 4.4-execution.modules.watsup:22.1-24.71
...
;; 4.4-execution.modules.watsup:31.1-31.102
def $allocglobals(store : store, globaltype*, val*) : (store, globaladdr*)
  ;; 4.4-execution.modules.watsup:32.1-32.42
  def $allocglobals{s : store}(s, [], []) = (s, [])
  ;; 4.4-execution.modules.watsup:33.1-35.62
...
;; 4.4-execution.modules.watsup:42.1-42.98
def $alloctables(store : store, tabletype*, ref*) : (store, tableaddr*)
  ;; 4.4-execution.modules.watsup:43.1-43.41
  def $alloctables{s : store}(s, [], []) = (s, [])
  ;; 4.4-execution.modules.watsup:44.1-46.60
...
;; 4.4-execution.modules.watsup:53.1-53.82
def $allocmems(store : store, memtype*) : (store, memaddr*)
  ;; 4.4-execution.modules.watsup:54.1-54.34
  def $allocmems{s : store}(s, []) = (s, [])
  ;; 4.4-execution.modules.watsup:55.1-57.49
...
;; 4.4-execution.modules.watsup:64.1-64.82
def $alloctags(store : store, tagtype*) : (store, tagaddr*)
  ;; 4.4-execution.modules.watsup:65.1-65.34
  def $alloctags{s : store}(s, []) = (s, [])
  ;; 4.4-execution.modules.watsup:66.1-68.49
...
;; 4.4-execution.modules.watsup:75.1-75.97
def $allocelems(store : store, elemtype*, ref**) : (store, elemaddr*)
  ;; 4.4-execution.modules.watsup:76.1-76.40
  def $allocelems{s : store}(s, [], []) = (s, [])
  ;; 4.4-execution.modules.watsup:77.1-79.55
...
;; 4.4-execution.modules.watsup:86.1-86.98
def $allocdatas(store : store, datatype*, byte**) : (store, dataaddr*)
  ;; 4.4-execution.modules.watsup:87.1-87.40
  def $allocdatas{s : store}(s, [], []) = (s, [])
  ;; 4.4-execution.modules.watsup:88.1-90.53
...
;; 4.4-execution.modules.watsup:166.1-166.94
def $evalglobals(state : state, globaltype*, expr*) : (state, val*)
  ;; 4.4-execution.modules.watsup:167.1-167.41
  def $evalglobals{z : state}(z, [], []) = (z, [])
  ;; 4.4-execution.modules.watsup:168.1-173.81
...
;; 5.1-binary.values.watsup:9.1-11.82
grammar BuN(N : N) : uN(N)
  ;; 5.1-binary.values.watsup:10.5-10.83
  prod{n : n} `%`_byte(n):Bbyte => `%`_uN(n)
    -- if ((n < (2 ^ 7)) /\ (n < (2 ^ N)))
  ;; 5.1-binary.values.watsup:11.5-11.82
...
;; 5.3-binary.instructions.watsup
...
grammar Binstr : instr
  ...
  ;; 5.3-binary.instructions.watsup:96.5-97.99
  ...
  ;; 5.3-binary.instructions.watsup:411.5-411.73
  ...
  ;; 5.3-binary.instructions.watsup:412.5-412.73
  ...
  ;; 5.3-binary.instructions.watsup:413.5-413.73
  ...
  ;; 5.3-binary.instructions.watsup:414.5-414.73
  ...
  ;; 5.3-binary.instructions.watsup:415.5-415.74
  ...
  ;; 5.3-binary.instructions.watsup:416.5-416.74
  ...
  ;; 5.3-binary.instructions.watsup:417.5-417.74
  ...
  ;; 5.3-binary.instructions.watsup:443.5-443.60
  ...
  ;; 5.3-binary.instructions.watsup:444.5-444.58
  ...
  ;; 5.3-binary.instructions.watsup:445.5-445.60
  ...
  ;; 5.3-binary.instructions.watsup:446.5-446.60
  ...
  ;; 5.3-binary.instructions.watsup:447.5-447.58
  ...
  ;; 5.3-binary.instructions.watsup:448.5-448.58
  ...
  ;; 5.3-binary.instructions.watsup:449.5-449.58
  ...
  ;; 5.3-binary.instructions.watsup:450.5-450.58
  ...
  ;; 5.3-binary.instructions.watsup:451.5-451.58
  ...
  ;; 5.3-binary.instructions.watsup:452.5-452.58
  ...
  ;; 5.3-binary.instructions.watsup:453.5-453.58
  ...
  ;; 5.3-binary.instructions.watsup:454.5-454.58
  ...
  ;; 5.3-binary.instructions.watsup:455.5-455.58
  ...
  ;; 5.3-binary.instructions.watsup:575.5-575.72
  ...
  ;; 5.3-binary.instructions.watsup:603.5-603.66
  ...
  ;; 5.3-binary.instructions.watsup:604.5-604.65
  ...
  ;; 5.3-binary.instructions.watsup:605.5-605.66
  ...
  ;; 5.3-binary.instructions.watsup:631.5-631.69
  ...
  ;; 5.3-binary.instructions.watsup:632.5-632.68
  ...
  ;; 5.3-binary.instructions.watsup:633.5-633.69
  ...
  ;; 5.3-binary.instructions.watsup:634.5-634.69
  ...
  ;; 5.3-binary.instructions.watsup:638.5-638.72
  ...
  ;; 5.3-binary.instructions.watsup:639.5-639.72
  ...
  ;; 5.3-binary.instructions.watsup:657.5-657.66
  ...
  ;; 5.3-binary.instructions.watsup:658.5-658.65
  ...
  ;; 5.3-binary.instructions.watsup:659.5-659.66
  ...
  ;; 5.3-binary.instructions.watsup:680.5-680.68
  ...
  ;; 5.3-binary.instructions.watsup:681.5-681.69
  ...
  ;; 5.3-binary.instructions.watsup:682.5-682.68
  ...
  ;; 5.3-binary.instructions.watsup:683.5-683.69
  ...
  ;; 5.3-binary.instructions.watsup:687.5-687.74
  ...
  ;; 5.3-binary.instructions.watsup:705.5-705.66
  ...
  ;; 5.3-binary.instructions.watsup:706.5-706.65
  ...
  ;; 5.3-binary.instructions.watsup:707.5-707.66
  ...
  ;; 5.3-binary.instructions.watsup:733.5-733.69
  ...
  ;; 5.3-binary.instructions.watsup:734.5-734.68
  ...
  ;; 5.3-binary.instructions.watsup:735.5-735.69
  ...
  ;; 5.3-binary.instructions.watsup:796.5-796.61
  ...
  ;; 5.3-binary.instructions.watsup:802.5-802.69
  ...
  ;; 5.3-binary.instructions.watsup:803.5-803.66
  ...
  ;; 5.3-binary.instructions.watsup:804.5-804.66
  ...
  ;; 5.3-binary.instructions.watsup:805.5-805.68
  ...
  ;; 5.3-binary.instructions.watsup:806.5-806.68
  ...
  ;; 5.3-binary.instructions.watsup:807.5-807.73
  ...
  ;; 5.3-binary.instructions.watsup:808.5-808.73
...
;; X.2-notation.typing.watsup:20.1-20.82
relation NotationTypingInstrScheme: `%|-%:%`(context, instr*, functype)
  ;; X.2-notation.typing.watsup:22.1-23.38
  ...
  ;; X.2-notation.typing.watsup:25.1-27.29
  rule global.get{C : context, x : idx, t : valtype, mut : mut}:
    `%|-%:%`(C, [GLOBAL.GET_instr(x)], `%->%`_functype(`%`_resulttype([]), `%`_resulttype([t])))
    -- if (C.GLOBALS_context[x!`%`_idx.0] = `%%`_globaltype(mut, t))

  ;; X.2-notation.typing.watsup:29.1-32.78
...
;; X.3-notation.execution.watsup:32.1-32.117
def $allocXs(syntax X, syntax Y, store : store, X*, Y*) : (store, addr*)
  ;; X.3-notation.execution.watsup:33.1-33.57
  def $allocXs{syntax X, syntax Y, s : store}(syntax X, syntax Y, s, [], []) = (s, [])
  ;; X.3-notation.execution.watsup:34.1-36.65
