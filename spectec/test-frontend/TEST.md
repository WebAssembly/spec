...
grammar Belem : elem
  ...
  ;; ../../../../specification/wasm-3.0/5.4-binary.modules.spectec
  prod{`e*` : expr*, x : idx, e_O : expr} {{`%`_u32(6):Bu32} {x:Btableidx} {e_O:Bexpr} {e*{e <- `e*`}:Blist(syntax expr, grammar Bexpr)}} => ELEM_elem(REF_reftype(?(NULL_null), FUNC_heaptype), e*{e <- `e*`}, ACTIVE_elemmode(x, e_O))
  ;; ../../../../specification/wasm-3.0/5.4-binary.modules.spectec
