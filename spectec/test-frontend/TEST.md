...
relation Instr_ok2: `%;%|-%:%`(store, context, instr, instrtype)
  ...
  ;; ../../../../specification/wasm-latest/7.1-soundness.configurations.spectec:14.1-16.43
  ...
  ;; ../../../../specification/wasm-latest/7.1-soundness.configurations.spectec:19.1-24.42
  ...
  ;; ../../../../specification/wasm-latest/7.1-soundness.configurations.spectec:26.1-28.27
  rule ref{s : store, C : context, ref : ref, rt : reftype}:
    `%;%|-%:%`(s, C, (ref : ref <: instr), `%->_%%`_instrtype(`%`_resulttype([],), [], `%`_resulttype([(rt : reftype <: valtype)],)))
    -- Ref_ok: `%|-%:%`(s, ref, rt)

  ;; ../../../../specification/wasm-latest/7.1-soundness.configurations.spectec:30.1-33.68
  ...
  ;; ../../../../specification/wasm-latest/7.1-soundness.configurations.spectec:35.1-39.35
  ...
  ;; ../../../../specification/wasm-latest/7.1-soundness.configurations.spectec:41.1-44.49
  ...
  ;; ../../../../specification/wasm-latest/7.1-soundness.configurations.spectec:46.1-48.42
...
relation Instrs_ok2: `%;%|-%:%`(store, context, instr*, instrtype)
  ;; ../../../../specification/wasm-latest/7.1-soundness.configurations.spectec:51.1-52.27
  rule empty{s : store, C : context}:
    `%;%|-%:%`(s, C, [], `%->_%%`_instrtype(`%`_resulttype([],), [], `%`_resulttype([],)))

  ;; ../../../../specification/wasm-latest/7.1-soundness.configurations.spectec:54.1-58.86
  ...
  ;; ../../../../specification/wasm-latest/7.1-soundness.configurations.spectec:60.1-64.33
  ...
  ;; ../../../../specification/wasm-latest/7.1-soundness.configurations.spectec:67.1-70.33
...
relation Expr_ok2: `%;%|-%:%`(store, context, expr, resulttype)
  ;; ../../../../specification/wasm-latest/7.1-soundness.configurations.spectec:73.1-75.44
...
;; ../../../../specification/wasm-latest/7.1-soundness.configurations.spectec:221.1-222.50
relation ImmutReachable: `%>>_%%`(fieldval, store, fieldval)
  ;; ../../../../specification/wasm-latest/7.1-soundness.configurations.spectec:235.1-238.35
  rule trans{fv_1 : fieldval, s : store, fv_2 : fieldval, fv' : fieldval}:
    `%>>_%%`(fv_1, s, fv_2)
    -- ImmutReachable: `%>>_%%`(fv_1, s, fv')
    -- ImmutReachable: `%>>_%%`(fv', s, fv_2)

  ;; ../../../../specification/wasm-latest/7.1-soundness.configurations.spectec:240.1-243.20
  ...
  ;; ../../../../specification/wasm-latest/7.1-soundness.configurations.spectec:245.1-247.42
  ...
  ;; ../../../../specification/wasm-latest/7.1-soundness.configurations.spectec:249.1-250.44
  rule `ref.exn`{a : addr, s : store, i : nat}:
    `%>>_%%`(`REF.EXN_ADDR`_fieldval(a), s, (s.EXNS_store[a].FIELDS_exninst[i] : val <: fieldval))

  ;; ../../../../specification/wasm-latest/7.1-soundness.configurations.spectec:252.1-253.28
