...
def subst_heaptype : (heaptype, typevar*, heaptype*) -> heaptype
  ...
  ;; 2-syntax-aux.watsup:110.1-110.54
...
relation Step_pure: `%*~>%*`(admininstr*, admininstr*)
  ;; 8-reduction.watsup:47.1-48.24
  rule unreachable:
    `%*~>%*`([UNREACHABLE_admininstr], [TRAP_admininstr])

  ;; 8-reduction.watsup:50.1-51.19
  rule nop:
    `%*~>%*`([NOP_admininstr], [])

  ;; 8-reduction.watsup:53.1-54.24
  rule drop {val : val}:
    `%*~>%*`([(val <: admininstr) DROP_admininstr], [])

  ;; 8-reduction.watsup:57.1-59.16
  ...
  ;; 8-reduction.watsup:170.1-171.46
  rule return_call_ref-frame-null {ht : heaptype, x : idx}:
    `%*~>%*`([REF.NULL_admininstr(ht) RETURN_CALL_REF_admininstr(x)], [TRAP_admininstr])

  ;; 8-reduction.watsup:173.1-174.66
  rule return_call_ref-frame-addr {a : addr, x : idx}:
    `%*~>%*`([REF.FUNC_ADDR_admininstr(a) RETURN_CALL_REF_admininstr(x)], [RETURN_CALL_ADDR_admininstr(a)])

  ;; 8-reduction.watsup:177.1-178.84
  ...
  ;; 8-reduction.watsup:180.1-181.98
  ...
  ;; 8-reduction.watsup:206.1-207.60
  ...
  ;; 8-reduction.watsup:212.1-214.33
  ...
  ;; 8-reduction.watsup:225.1-227.46
  ...
  ;; 8-reduction.watsup:230.1-232.37
  ...
  ;; 8-reduction.watsup:234.1-236.40
  ...
  ;; 8-reduction.watsup:239.1-240.70
  ...
  ;; 8-reduction.watsup:243.1-245.48
  ...
  ;; 8-reduction.watsup:247.1-249.54
  ...
  ;; 8-reduction.watsup:279.1-281.55
  ...
  ;; 8-reduction.watsup:537.1-538.55
  ...
  ;; 8-reduction.watsup:541.1-542.55
  ...
  ;; 8-reduction.watsup:544.1-545.55
  ...
  ;; 8-reduction.watsup:557.1-558.47
...
relation Step_read: `%~>%*`(config, admininstr*)
  ...
  ;; 8-reduction.watsup:157.1-158.47
  ...
  ;; 8-reduction.watsup:163.1-164.55
  rule call_ref-func {a : addr, x : idx, z : state}:
    `%~>%*`(`%;%*`(z, [REF.FUNC_ADDR_admininstr(a) CALL_REF_admininstr(x)]), [CALL_ADDR_admininstr(a)])

  ;; 8-reduction.watsup:167.1-168.61
  rule return_call {x : idx, z : state}:
    `%~>%*`(`%;%*`(z, [RETURN_CALL_admininstr(x)]), [RETURN_CALL_ADDR_admininstr($funcaddr(z)[x])])

  ;; 8-reduction.watsup:184.1-189.59
  ...
  ;; 8-reduction.watsup:191.1-194.29
  rule return_call_addr-frame {a : addr, f : frame, instr* : instr*, k : nat, m : nat, n : n, t_1^n : valtype^n, t_2^m : valtype^m, val* : val*, val'^n : val^n, val''* : val*, z : state}:
    `%~>%*`(`%;%*`(z, [FRAME__admininstr(k, f, (val <: admininstr)*{val} :: [RETURN_CALL_ADDR_admininstr(a)] :: (instr <: admininstr)*{instr})]), (val' <: admininstr)^n{val'} :: [CALL_ADDR_admininstr(a)])
    -- Expand: `%~~%`($funcinst(z)[a].TYPE_funcinst, FUNC_comptype(`%->%`(t_1^n{t_1}, t_2^m{t_2})))
    -- if (val*{val} = val''*{val''} :: val'^n{val'})

  ;; 8-reduction.watsup:196.1-197.91
  rule return_call_addr-label {a : addr, instr* : instr*, instr'* : instr*, k : nat, val* : val*, z : state}:
    `%~>%*`(`%;%*`(z, [LABEL__admininstr(k, instr'*{instr'}, (val <: admininstr)*{val} :: [RETURN_CALL_ADDR_admininstr(a)] :: (instr <: admininstr)*{instr})]), (val <: admininstr)*{val} :: [RETURN_CALL_ADDR_admininstr(a)])

  ;; 8-reduction.watsup:254.1-255.55
  rule ref.func {x : idx, z : state}:
    `%~>%*`(`%;%*`(z, [REF.FUNC_admininstr(x)]), [REF.FUNC_ADDR_admininstr($funcaddr(z)[x])])

  ;; 8-reduction.watsup:293.1-296.65
  ...
  ;; 8-reduction.watsup:335.1-336.50
  ...
  ;; 8-reduction.watsup:338.1-341.41
  ...
  ;; 8-reduction.watsup:355.1-356.70
  ...
  ;; 8-reduction.watsup:358.1-361.40
  ...
  ;; 8-reduction.watsup:369.1-371.38
  ...
  ;; 8-reduction.watsup:373.1-375.40
  ...
  ;; 8-reduction.watsup:378.1-381.59
  ...
  ;; 8-reduction.watsup:383.1-387.85
  ...
  rule array.copy-le {a_1 : addr, a_2 : addr, i_1 : nat, i_2 : nat, mut : mut, n : n, sx? : sx?, x_1 : idx, x_2 : idx, z : state, zt_2 : storagetype}:
    `%~>%*`(`%;%*`(z, [REF.ARRAY_ADDR_admininstr(a_1) CONST_admininstr(I32_numtype, i_1) REF.ARRAY_ADDR_admininstr(a_2) CONST_admininstr(I32_numtype, i_2) CONST_admininstr(I32_numtype, n) ARRAY.COPY_admininstr(x_1, x_2)]), [REF.ARRAY_ADDR_admininstr(a_1) CONST_admininstr(I32_numtype, i_1) REF.ARRAY_ADDR_admininstr(a_2) CONST_admininstr(I32_numtype, i_2) ARRAY.GET_admininstr(sx?{sx}, x_1) ARRAY.SET_admininstr(x_1) REF.ARRAY_ADDR_admininstr(a_1) CONST_admininstr(I32_numtype, (i_1 + 1)) REF.ARRAY_ADDR_admininstr(a_2) CONST_admininstr(I32_numtype, (i_2 + 1)) CONST_admininstr(I32_numtype, (n - 1)) ARRAY.COPY_admininstr(x_1, x_2)])
    -- otherwise
    -- Expand: `%~~%`($type(z, x_2), ARRAY_comptype(`%%`(mut, zt_2)))
    -- if (sx?{sx} = $sxfield(zt_2))
    -- if (i_1 <= i_2)

  ;; 8-reduction.watsup:472.1-478.15
  rule array.copy-gt {a_1 : addr, a_2 : addr, i_1 : nat, i_2 : nat, n : n, sx? : sx?, x_1 : idx, x_2 : idx, z : state}:
    `%~>%*`(`%;%*`(z, [REF.ARRAY_ADDR_admininstr(a_1) CONST_admininstr(I32_numtype, i_1) REF.ARRAY_ADDR_admininstr(a_2) CONST_admininstr(I32_numtype, i_2) CONST_admininstr(I32_numtype, n) ARRAY.COPY_admininstr(x_1, x_2)]), [REF.ARRAY_ADDR_admininstr(a_1) CONST_admininstr(I32_numtype, ((i_1 + n) - 1)) REF.ARRAY_ADDR_admininstr(a_2) CONST_admininstr(I32_numtype, ((i_2 + n) - 1)) ARRAY.GET_admininstr(sx?{sx}, x_1) ARRAY.SET_admininstr(x_1) REF.ARRAY_ADDR_admininstr(a_1) CONST_admininstr(I32_numtype, i_1) REF.ARRAY_ADDR_admininstr(a_2) CONST_admininstr(I32_numtype, i_2) CONST_admininstr(I32_numtype, (n - 1)) ARRAY.COPY_admininstr(x_1, x_2)])
    -- otherwise
  ...
  ;; 8-reduction.watsup:497.1-502.34
  ...
  ;; 8-reduction.watsup:505.1-506.93
  ...
  ;; 8-reduction.watsup:508.1-510.44
  ...
  ;; 8-reduction.watsup:512.1-515.59
  ...
  ;; 8-reduction.watsup:517.1-520.14
  ...
  ;; 8-reduction.watsup:522.1-529.79
  ...
  ;; 8-reduction.watsup:576.1-578.32
  ...
  ;; 8-reduction.watsup:606.1-609.14
  ...
  ;; 8-reduction.watsup:611.1-615.15
  ...
  ;; 8-reduction.watsup:618.1-620.73
  ...
  ;; 8-reduction.watsup:622.1-625.14
  ...
  ;; 8-reduction.watsup:627.1-632.15
  ...
  ;; 8-reduction.watsup:634.1-638.15
  ...
  ;; 8-reduction.watsup:641.1-643.72
  ...
  ;; 8-reduction.watsup:645.1-648.14
  ...
  ;; 8-reduction.watsup:650.1-654.15
  ...
  ;; 8-reduction.watsup:663.1-665.53
  ...
  ;; 8-reduction.watsup:667.1-669.70
  ...
  ;; 8-reduction.watsup:671.1-673.45
  ...
  ;; 8-reduction.watsup:675.1-677.54
  ...
  ;; 8-reduction.watsup:697.1-699.44
  ...
  ;; 8-reduction.watsup:710.1-712.37
  ...
  ;; 8-reduction.watsup:714.1-717.14
  ...
  ;; 8-reduction.watsup:719.1-723.15
  ...
  ;; 8-reduction.watsup:726.1-728.77
  ...
  ;; 8-reduction.watsup:730.1-733.14
  ...
  ;; 8-reduction.watsup:735.1-740.19
  ...
  ;; 8-reduction.watsup:742.1-746.15
  ...
  ;; 8-reduction.watsup:749.1-751.70
...
relation Step: `%~>%`(config, config)
  ...
  ;; 8-reduction.watsup:324.1-327.61
  ...
  ;; 8-reduction.watsup:344.1-345.53
  ...
  ;; 8-reduction.watsup:347.1-350.35
  ...
  ;; 8-reduction.watsup:363.1-366.61
  ...
  ;; 8-reduction.watsup:594.1-596.46
  ...
  ;; 8-reduction.watsup:598.1-599.64
  ...
  ;; 8-reduction.watsup:684.1-686.34
  ...
  ;; 8-reduction.watsup:688.1-690.45
  ...
  ;; 8-reduction.watsup:692.1-694.47
  ...
  ;; 8-reduction.watsup:702.1-704.40
  ...
  ;; 8-reduction.watsup:706.1-707.61
  ...
  ;; 8-reduction.watsup:765.1-766.59
...
relation Eval: `%~>*%;%*`(config, state, val*)
  ;; 8-reduction.watsup:24.1-25.22
  rule done {val* : val*, z : state}:
    `%~>*%;%*`(`%;%*`(z, (val <: admininstr)*{val}), z, val*{val})

  ;; 8-reduction.watsup:27.1-30.43
...
relation Eval_expr: `%;%~>*%;%*`(state, expr, state, val*)
  ;; 8-reduction.watsup:32.1-34.35
  rule _ {instr* : instr*, val* : val*, z : state, z' : state}:
    `%;%~>*%;%*`(z, instr*{instr}, z', val*{val})
    -- Eval: `%~>*%;%*`(`%;%*`(z, (instr <: admininstr)*{instr}), z, val*{val})

;; 8-reduction.watsup:22.1-22.81
relation Eval_expr_const: `%;%~>*%;%*`(state, expr, state, val*)
  ;; 8-reduction.watsup:36.1-38.37
  rule _ {instr^n : instr^n, n : n, val^n : val^n, z : state, z' : state}:
    `%;%~>*%;%*`(z, instr^n{instr}, z', val^n{val})
    -- Eval: `%~>*%;%*`(`%;%*`(z, (instr <: admininstr)^n{instr}), z, val^n{val})
...
def instantiate : (store, module, externval*) -> config
  ...
  def {data* : data*, elem* : elem*, elemmode?* : elemmode?*, export* : export*, expr_e** : expr**, expr_g* : expr*, expr_t* : expr*, externval* : externval*, f : frame, func^n_func : func^n_func, global* : global*, globaltype* : globaltype*, i^n_e : nat^n_e, i_func^n_func : nat^n_func, import* : import*, instr_d* : instr*, instr_e* : instr*, j^n_d : nat^n_d, mem* : mem*, mm : moduleinst, mm_init : moduleinst, module : module, n_d : n, n_e : n, n_func : n, rectype* : rectype*, ref_e** : ref**, ref_t* : ref*, reftype* : reftype*, s : store, s' : store, start? : start?, table* : table*, tabletype* : tabletype*, val_g* : val*, x? : idx?, z : state} instantiate(s, module, externval*{externval}) = `%;%*`(`%;%`(s', f), (instr_e <: admininstr)*{instr_e} :: (instr_d <: admininstr)*{instr_d} :: CALL_admininstr(x)?{x})
    ...
    -- (Eval_expr_const: `%;%~>*%;%*`(z, expr_g, z, [val_g]))*{expr_g val_g}
    -- (Eval_expr_const: `%;%~>*%;%*`(z, expr_t, z, [(ref_t <: val)]))*{expr_t ref_t}
    -- (Eval_expr_const: `%;%~>*%;%*`(z, expr_e, z, [(ref_e <: val)]))*{expr_e ref_e}*{expr_e ref_e}
...
;; 9-module.watsup:192.1-192.44
def invoke : (store, funcaddr, val*) -> config
  ;; 9-module.watsup:193.1-206.53
