...
call.wast: [37/70] (52.86%)
local_get.wast: [17/19] (89.47%)
fac.wast: [0/6] (0.00%)
func.wast: [84/96] (87.50%)
...
start.wast: [Uncaught exception in 1th assertion: Direct invocation failed due to Invalid assignment: (_, func) := [65, 0, 0, 0, 0, 0, 0, 0]]
...
nop.wast: [69/83] (83.13%)
Total [5038/15431] (32.65%; Normalized 47.76%)
== Complete.
```
