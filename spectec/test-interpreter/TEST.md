...
```sh
$ ../src/exe-watsup/main.exe ../../../../specification/wasm-3.0/*.watsup -v -l --interpreter ../test-interpreter/sample.wat addTwo 30 12 2>&1
...
42
== Complete.
$ ../src/exe-watsup/main.exe ../../../../specification/wasm-3.0/*.watsup -v -l --interpreter ../test-interpreter/sample.wasm addTwo 40 2 2>&1
watsup 0.5 generator
== Parsing...
== Elaboration...
== IL Validation...
...
42
== Complete.
$ ../src/exe-watsup/main.exe ../../../../specification/wasm-3.0/*.watsup -v -l --interpreter ../test-interpreter/sample.wast 2>&1
watsup 0.5 generator
== Parsing...
== Elaboration...
== IL Validation...
...
===== ../test-interpreter/spec-test-3/address64.wast =====
- 246/246 (100.00%)
...
===== ../test-interpreter/spec-test-3/endianness64.wast =====
- 70/70 (100.00%)
...
===== ../test-interpreter/spec-test-3/float_memory64.wast =====
- 96/96 (100.00%)
...
===== ../test-interpreter/spec-test-3/load64.wast =====
- 85/85 (100.00%)
...
===== ../test-interpreter/spec-test-3/memory_grow64.wast =====
- 53/53 (100.00%)
...
===== ../test-interpreter/spec-test-3/memory_redundancy64.wast =====
- 9/9 (100.00%)
...
===== ../test-interpreter/spec-test-3/memory_trap64.wast =====
- 174/174 (100.00%)
...
===== ../test-interpreter/spec-test-3/table_copy_mixed.wast =====
- 5/5 (100.00%)
