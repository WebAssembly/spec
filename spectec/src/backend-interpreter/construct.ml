...
let al_of_vop f1 f2 = function
  | V128 vop -> (
    match vop with
    | V128.I8x16 op -> [ TupV [ singleton "I8"; numV 16L ]; f1 op ]
    | V128.I16x8 op -> [ TupV [ singleton "I16"; numV 8L ]; f1 op ]
    | V128.I32x4 op -> [ TupV [ singleton "I32"; numV 4L ]; f1 op ]
    | V128.I64x2 op -> [ TupV [ singleton "I64"; numV 2L ]; f1 op ]
    | V128.F32x4 op -> [ TupV [ singleton "F32"; numV 4L ]; f2 op ]
    | V128.F64x2 op -> [ TupV [ singleton "F64"; numV 2L ]; f2 op ]
  )
...
let al_of_vtestop = function
  | V128 vop -> (
    match vop with
    | V128.I8x16 _ -> [ TupV [ singleton "I8"; numV 16L ] ]
    | V128.I16x8 _ -> [ TupV [ singleton "I16"; numV 8L ] ]
    | V128.I32x4 _ -> [ TupV [ singleton "I32"; numV 4L ] ]
    | V128.I64x2 _ -> [ TupV [ singleton "I64"; numV 2L ] ]
...
let al_of_int_vbinop : V128Op.ibinop -> value option = function
  | V128Op.Add -> Some (CaseV ("_VI", [ singleton "ADD" ]))
  | V128Op.Sub -> Some (CaseV ("_VI", [ singleton "SUB" ]))
  | V128Op.Mul -> Some (CaseV ("_VI", [ singleton "MUL" ]))
  | V128Op.MinS -> Some (CaseV ("_VI", [ singleton "MINS" ]))
  | V128Op.MinU -> Some (CaseV ("_VI", [ singleton "MINU" ]))
  | V128Op.MaxS -> Some (CaseV ("_VI", [ singleton "MAXS" ]))
  | V128Op.MaxU -> Some (CaseV ("_VI", [ singleton "MAXU" ]))
  | V128Op.AvgrU -> Some (CaseV ("_VI", [ singleton "AVGRU" ]))
  | V128Op.AddSatS -> Some (CaseV ("_VI", [ singleton "ADDSATS" ]))
  | V128Op.AddSatU -> Some (CaseV ("_VI", [ singleton "ADDSATU" ]))
  | V128Op.SubSatS -> Some (CaseV ("_VI", [ singleton "SUBSATS" ]))
  | V128Op.SubSatU -> Some (CaseV ("_VI", [ singleton "SUBSATU" ]))
  | V128Op.Q15MulRSatS -> Some (CaseV ("_VI", [ singleton "Q15MULRSATS" ]))
  | _ -> None
...
let al_of_vbinop = function
  | V128 vop -> (
    match vop with
    | V128.I8x16 op -> Option.map (fun v -> [ TupV [ singleton "I8"; numV 16L ]; v ]) (al_of_int_vbinop op)
    | V128.I16x8 op -> Option.map (fun v -> [ TupV [ singleton "I16"; numV 8L ]; v ]) (al_of_int_vbinop op)
    | V128.I32x4 op -> Option.map (fun v -> [ TupV [ singleton "I32"; numV 4L ]; v ]) (al_of_int_vbinop op)
    | V128.I64x2 op -> Option.map (fun v -> [ TupV [ singleton "I64"; numV 2L ]; v ]) (al_of_int_vbinop op)
    | V128.F32x4 op -> Some ([ TupV [ singleton "F32"; numV 4L ]; al_of_float_vbinop op ])
    | V128.F64x2 op -> Some ([ TupV [ singleton "F64"; numV 2L ]; al_of_float_vbinop op ])
  )

let al_of_special_vbinop = function
  | V128 (V128.I8x16 (V128Op.Swizzle)) -> CaseV ("VSWIZZLE", [ TupV [ singleton "I8"; numV 16L ]; ])
  | V128 (V128.I8x16 (V128Op.Shuffle l)) -> CaseV ("VSHUFFLE", [ TupV [ singleton "I8"; numV 16L ]; al_of_list al_of_int l ])
  | V128 (V128.I8x16 (V128Op.NarrowS)) -> CaseV ("VNARROW", [ TupV [ singleton "I8"; numV 16L ]; TupV [ singleton "I16"; numV 8L ]; al_of_extension Pack.SX ])
  | V128 (V128.I16x8 (V128Op.NarrowS)) -> CaseV ("VNARROW", [ TupV [ singleton "I16"; numV 8L ]; TupV [ singleton "I32"; numV 4L ]; al_of_extension Pack.SX ])
  | V128 (V128.I8x16 (V128Op.NarrowU)) -> CaseV ("VNARROW", [ TupV [ singleton "I8"; numV 16L ]; TupV [ singleton "I16"; numV 8L ]; al_of_extension Pack.ZX ])
  | V128 (V128.I16x8 (V128Op.NarrowU)) -> CaseV ("VNARROW", [ TupV [ singleton "I16"; numV 8L]; TupV [ singleton "I32"; numV 4L ]; al_of_extension Pack.ZX ])
  | V128 (V128.I16x8 (V128Op.ExtMulHighS)) -> CaseV ("VEXTMUL", [ TupV [ singleton "I16"; numV 8L ]; singleton "HIGH"; TupV [ singleton "I8"; numV 16L ]; al_of_extension Pack.SX ])
  | V128 (V128.I16x8 (V128Op.ExtMulHighU)) -> CaseV ("VEXTMUL", [ TupV [ singleton "I16"; numV 8L ]; singleton "HIGH"; TupV [ singleton "I8"; numV 16L ]; al_of_extension Pack.ZX ])
  | V128 (V128.I16x8 (V128Op.ExtMulLowS)) -> CaseV ("VEXTMUL", [ TupV [ singleton "I16"; numV 8L ]; singleton "LOW"; TupV [ singleton "I8"; numV 16L ]; al_of_extension Pack.SX ])
  | V128 (V128.I16x8 (V128Op.ExtMulLowU)) -> CaseV ("VEXTMUL", [ TupV [ singleton "I16"; numV 8L ]; singleton "LOW"; TupV [ singleton "I8"; numV 16L ]; al_of_extension Pack.ZX ] )
  | V128 (V128.I32x4 (V128Op.ExtMulHighS)) -> CaseV ("VEXTMUL", [ TupV [ singleton "I32"; numV 4L ]; singleton "HIGH"; TupV [ singleton "I16"; numV 8L ]; al_of_extension Pack.SX ])
  | V128 (V128.I32x4 (V128Op.ExtMulHighU)) -> CaseV ("VEXTMUL", [ TupV [ singleton "I32"; numV 4L ]; singleton "HIGH"; TupV [ singleton "I16"; numV 8L ]; al_of_extension Pack.ZX ])
  | V128 (V128.I32x4 (V128Op.ExtMulLowS)) -> CaseV ("VEXTMUL", [ TupV [ singleton "I32"; numV 4L ]; singleton "LOW"; TupV [ singleton "I16"; numV 8L ]; al_of_extension Pack.SX ])
  | V128 (V128.I32x4 (V128Op.ExtMulLowU)) -> CaseV ("VEXTMUL", [ TupV [ singleton "I32"; numV 4L ]; singleton "LOW"; TupV [ singleton "I16"; numV 8L ]; al_of_extension Pack.ZX ] )
  | V128 (V128.I64x2 (V128Op.ExtMulHighS)) -> CaseV ("VEXTMUL", [ TupV [ singleton "I64"; numV 2L ]; singleton "HIGH"; TupV [ singleton "I32"; numV 4L ]; al_of_extension Pack.SX ])
  | V128 (V128.I64x2 (V128Op.ExtMulHighU)) -> CaseV ("VEXTMUL", [ TupV [ singleton "I64"; numV 2L ]; singleton "HIGH"; TupV [ singleton "I32"; numV 4L ]; al_of_extension Pack.ZX ])
  | V128 (V128.I64x2 (V128Op.ExtMulLowS)) -> CaseV ("VEXTMUL", [ TupV [ singleton "I64"; numV 2L ]; singleton "LOW"; TupV [ singleton "I32"; numV 4L ]; al_of_extension Pack.SX ])
  | V128 (V128.I64x2 (V128Op.ExtMulLowU)) -> CaseV ("VEXTMUL", [ TupV [ singleton "I64"; numV 2L ]; singleton "LOW"; TupV [ singleton "I32"; numV 4L ]; al_of_extension Pack.ZX ] )
  | V128 (V128.I32x4 (V128Op.DotS)) -> CaseV ("VDOT", [ TupV [ singleton "I32"; numV 4L]; TupV [ singleton "I16"; numV 8L ]; al_of_extension Pack.SX ])
  | _ -> failwith "invalid vibinop"

let al_of_int_vcvtop = function
  | V128Op.ExtendLowS -> Some (singleton "EXTEND", Some (singleton "LOW"), None, Some (singleton "S"), None)
  | V128Op.ExtendLowU -> Some (singleton "EXTEND", Some (singleton "LOW"), None, Some (singleton "U"), None)
  | V128Op.ExtendHighS -> Some (singleton "EXTEND", Some (singleton "HIGH"), None, Some (singleton "S"), None)
  | V128Op.ExtendHighU -> Some (singleton "EXTEND", Some (singleton "HIGH"), None, Some (singleton "U"), None)
  | V128Op.TruncSatSF32x4 -> Some (singleton "TRUNC_SAT", None, Some (TupV [ singleton "F32"; numV 4L ]), Some (singleton "S"), None)
  | V128Op.TruncSatUF32x4 -> Some (singleton "TRUNC_SAT", None, Some (TupV [ singleton "F32"; numV 4L ]), Some (singleton "U"), None)
  | V128Op.TruncSatSZeroF64x2 -> Some (singleton "TRUNC_SAT", None, Some (TupV [ singleton "F64"; numV 2L ]), Some (singleton "S"), Some (tupV []))
  | V128Op.TruncSatUZeroF64x2 -> Some (singleton "TRUNC_SAT", None, Some (TupV [ singleton "F64"; numV 2L ]), Some (singleton "U"), Some (tupV []))
  | _ -> None

let al_of_float32_vcvtop = function
  | V128Op.DemoteZeroF64x2 -> Some (singleton "DEMOTE", None, Some (TupV [ singleton "F64"; numV 2L ]), None, Some (tupV []))
  | V128Op.ConvertSI32x4 -> Some (singleton "CONVERT", None, Some (TupV [ singleton "I32"; numV 4L ]), Some (singleton "S"), None)
  | V128Op.ConvertUI32x4 -> Some (singleton "CONVERT", None, Some (TupV [ singleton "I32"; numV 4L ]), Some (singleton "U"), None)
  | _ -> None

let al_of_float64_vcvtop = function
  | V128Op.PromoteLowF32x4 -> Some (singleton "PROMOTE", Some (singleton "LOW"), Some (TupV [ singleton "F32"; numV 4L ]), None, None)
  | V128Op.ConvertSI32x4 -> Some (singleton "CONVERT", Some (singleton "LOW"), Some (TupV [ singleton "I32"; numV 4L ]), Some (singleton "S"), None)
  | V128Op.ConvertUI32x4 -> Some (singleton "CONVERT", Some (singleton "LOW"), Some (TupV [ singleton "I32"; numV 4L ]), Some (singleton "U"), None)
  | _ -> None
  ...
  | V128 vop -> (
    ...
    | V128.I8x16 op -> (
      Option.map (fun (op', half, to_, ext, zero) ->
        ...
        [ TupV [ singleton "I8"; numV 16L ]; op'; optV half; sh; optV ext; CaseV ("ZERO", [OptV zero]) ]
      ) (al_of_int_vcvtop op)
    )
    | V128.I16x8 op -> (
      Option.map (fun (op', half, to_, ext, zero) ->
        ...
        [ TupV [ singleton "I16"; numV 8L ]; op'; optV half; sh; optV ext; CaseV ("ZERO", [OptV zero]) ]
      ) (al_of_int_vcvtop op)
    )
    | V128.I32x4 op -> (
      Option.map (fun (op', half, to_, ext, zero) ->
        ...
        [ TupV [ singleton "I32"; numV 4L ]; op'; optV half; sh; optV ext; CaseV ("ZERO", [OptV zero]) ]
      ) (al_of_int_vcvtop op)
    )
    | V128.I64x2 op -> (
      Option.map (fun (op', half, to_, ext, zero) ->
        ...
        [ TupV [ singleton "I64"; numV 2L ]; op'; optV half; sh; optV ext; CaseV ("ZERO", [OptV zero]) ]
      ) (al_of_int_vcvtop op)
    )
    | V128.F32x4 op -> (
      Option.map (fun (op', half, to_, ext, zero) ->
        ...
        [ TupV [ singleton "F32"; numV 4L ]; op'; optV half; sh; optV ext; CaseV ("ZERO", [OptV zero]) ]
    ...
    | V128.F64x2 op -> (
      Option.map (fun (op', half, to_, ext, zero) ->
        ...
        [ TupV [ singleton "F64"; numV 2L ]; op'; optV half; sh; optV ext; CaseV ("ZERO", [OptV zero]) ]
...
let al_of_special_vcvtop = function
  | V128 (V128.I16x8 (V128Op.ExtAddPairwiseS)) -> CaseV ("VEXTADD_PAIRWISE", [ TupV [ singleton "I16"; numV 8L]; TupV [ singleton "I8"; numV 16L ]; al_of_extension Pack.SX ])
  | V128 (V128.I16x8 (V128Op.ExtAddPairwiseU)) -> CaseV ("VEXTADD_PAIRWISE", [ TupV [ singleton "I16"; numV 8L]; TupV [ singleton "I8"; numV 16L ]; al_of_extension Pack.ZX ])
  | V128 (V128.I32x4 (V128Op.ExtAddPairwiseS)) -> CaseV ("VEXTADD_PAIRWISE", [ TupV [ singleton "I32"; numV 4L]; TupV [ singleton "I16"; numV 8L ]; al_of_extension Pack.SX ])
  | V128 (V128.I32x4 (V128Op.ExtAddPairwiseU)) -> CaseV ("VEXTADD_PAIRWISE", [ TupV [ singleton "I32"; numV 4L]; TupV [ singleton "I16"; numV 8L ]; al_of_extension Pack.ZX ])
  | _ -> failwith "invalid vibinop"
...
let al_of_vsplatop : vec_splatop -> value list = function
  | V128 vop -> (
    ...
    | V128.I32x4 _ -> [ TupV [ singleton "I32"; numV 4L ] ]
    | V128.I64x2 _ -> [ TupV [ singleton "I64"; numV 2L ] ]
    | V128.F32x4 _ -> [ TupV [ singleton "F32"; numV 4L ] ]
    | V128.F64x2 _ -> [ TupV [ singleton "F64"; numV 2L ] ]
  )
...
let al_of_vextractop : vec_extractop -> value list = function
  | V128 vop -> (
    ...
    | V128.I8x16 vop' -> (
      match vop' with
      | Extract (n, ext) ->
        [ TupV [ singleton "I8"; numV 16L ]; optV (Some (al_of_extension ext)); al_of_int n; ]
    )
    | V128.I16x8 vop' -> (
      match vop' with
      | Extract (n, ext) ->
        [ TupV [ singleton "I16"; numV 8L ]; optV (Some (al_of_extension ext)); al_of_int n; ]
    )
    | V128.I32x4 vop' -> (
      match vop' with
      | Extract (n, _) -> [ TupV [ singleton "I32"; numV 4L ]; optV None; al_of_int n ]
    )
    | V128.I64x2 vop' -> (
      match vop' with
      | Extract (n, _) -> [ TupV [ singleton "I64"; numV 2L ]; optV None; al_of_int n ]
    )
    | V128.F32x4 vop' -> (
      match vop' with
      | Extract (n, _) -> [ TupV [ singleton "F32"; numV 4L ]; optV None; al_of_int n ]
    )
    | V128.F64x2 vop' -> (
      match vop' with
      | Extract (n, _) -> [ TupV [ singleton "F64"; numV 2L ]; optV None; al_of_int n ]
    )
  )
...
let al_of_vreplaceop : vec_replaceop -> value list = function
  | V128 vop -> (
    match vop with
    | V128.I8x16 (Replace n) -> [ TupV [ singleton "I8"; numV 16L ]; al_of_int n ]
    | V128.I16x8 (Replace n) -> [ TupV [ singleton "I16"; numV 8L ]; al_of_int n ]
    | V128.I32x4 (Replace n) -> [ TupV [ singleton "I32"; numV 4L ]; al_of_int n ]
    | V128.I64x2 (Replace n) -> [ TupV [ singleton "I64"; numV 2L ]; al_of_int n ]
    | V128.F32x4 (Replace n) -> [ TupV [ singleton "F32"; numV 4L ]; al_of_int n ]
    | V128.F64x2 (Replace n) -> [ TupV [ singleton "F64"; numV 2L ]; al_of_int n ]
  )
