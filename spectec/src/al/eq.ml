...
let rec eq_expr e1 e2 =
  ...
  | CallE (i1, el1), CallE (i2, el2) -> i1 = i2 && eq_exprs el1 el2
  | InvCallE (i1, nl1, el1), InvCallE (i2, nl2, el2) ->
    i1 = i2 && List.for_all2 (=) nl1 nl2 && eq_exprs el1 el2
...
and eq_instr i1 i2 =
  ...
  | PerformI (id1, el1), PerformI (id2, el2) -> id1 = id2 && eq_exprs el1 el2
