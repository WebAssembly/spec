...
let rec walk_instr f instr =
  ...
  | AppendI (e1, p, e2) -> f_instr (AppendI (walk_expr f e1, walk_path f p, walk_expr f e2))
  | AppendListI (e1, p, e2) -> f_instr (AppendListI (walk_expr f e1, walk_path f p, walk_expr f e2))
