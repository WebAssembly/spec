  ...
  Algo (
    ...
    [
      LetI (
        ConstructE (
          "MODULE",
          [ ignore_name; ignore_name; ignore_name; ignore_name; elem; data ]
        ),
        module_
      );
  ...
  Algo (
    ...
    [
      LetI (
        ConstructE (
          "MODULE",
          [ func_iter; global_iter; table_iter; memory_iter; elem_iter; data_iter; ]
        ),
        module_
      );
